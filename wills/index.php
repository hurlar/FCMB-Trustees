...
mysqli_select_db($conn, $database_conn);
$query_rtdurl = "SELECT * FROM content WHERE pg_cat = '$pagecaturl' AND pg_alias != 'wills' AND rate_ord > '0' ORDER BY rate_ord ASC";
        ...
        <div class="main-page-wrapper">
            ...
            <header class="header-two">
                ...
                <?php //include ('inc/inc_nav.php');?>
                                <div class="theme-menu-wrapper">                    <div class="container">                        <div class="bg-wrapper clearfix" style="height:150px;">                            <div class="logo float-left"><a href="../"><img src="../images/logo.svg" alt="FCMB Trustees Logo" style="height:200px; padding-bottom:10px;" ></a></div>                            <!-- ============== Menu Warpper ================ -->                            <div class="menu-wrapper float-left">                                <nav id="mega-menu-holder" class="clearfix">                                   <ul class="clearfix">                                        <li class="act.ive"><a href="../">Home</a>                                        </li>                                        <li><a href="#">About Us</a>                                            <ul class="dropdown">                                                <li><a href="../page.php?a=company-profile">Company Profile</a></li>                                                <li><a href="../page.php?a=what-we-do">What We Do </a></li>                                                <li><a href="../page.php?a=management-team">Management Team </a></li>                                                <li><a href="../page.php?a=board-of-directors">Board of Directors </a></li>                                           </ul>                                        </li>                                        <li><a href="#">Our Services</a>                                            <ul class="dropdown">                                                <li><a href="../page.php?a=corporate-trust-services">Corporate Trust Services </a>                                                    <ul>                                                        <li><a href="../page.php?a=debenture-security-trustees">Debenture/ Security Trustees </a></li>                                                        <li><a href="../page.php?a=bonds-debt-issuance">Bonds/ Debt Issuance </a></li>                                                        <li><a href="../page.php?a=mutual-funds">Mutual Funds </a></li>                         </ul>                                   </li>                                                <li><a href="../page.php?a=private-wealth-services">Private Trust & Wealth Management Services </a>                                                    <ul>                                                        <li><a href="../wills">Wills and Probate Services</a></li>                                                        <li><a href="../page.php?a=private-living-trust">Private/ Living Trust </a></li>                                                        <li><a href="../page.php?a=education-trust">Education Trust </a></li>                                                        <li><a href="../page.php?a=reserve-trust">Reserve Trust </a></li>                                                        <li><a href="../page.php?a=investment-management-trust">Investment Management Trust </a></li>                                                        <li><a href="../page.php?a=codicil">Codicil </a></li>                                                    </ul>                                                </li>                       <li><a href="../page.php?a=other-services">Other Services </a>                                                    <ul>                                                        <li><a href="../page.php?a=endowment-foundation-management">Endowment/ Foundation Management</a></li>                                                        <li><a href="../page.php?a=escrow-agent">Escrow Agent</a></li>                                                        <li><a href="../page.php?a=cooperative-schemes">Cooperative Schemes </a></li>                                                    </ul>                                                </li>                                           </ul>                                        </li><li><a href="#">FAQs</a>                                            <ul class="dropdown">                                                <li><a href="../page.php?a=trusts-faqs">TRUSTS FAQs </a></li>                                                <li><a href="../page.php?a=wills-faqs">WILLS FAQs</a></li>                                           </ul>                                        </li>                                        <li><a href="../contact.php">contact us</a></li>                                   </ul>                                </nav> <!-- /#mega-menu-holder -->                            </div> <!-- /.menu-wrapper -->                            <div class="right-widget float-right">                                <ul>                                    <li class="search-option">                                        <div class="dropdown">                                            <button type="button" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-search" aria-hidden="true"></i></button>                                            <form action="process-search.php" class="dropdown-menu" method="POST">                                                <input type="text" name="search" Placeholder="Enter Your Search" required>                                                <button><i class="fa fa-search"></i></button>                                            </form>                                        </div>                                    </li>                                </ul>                            </div> <!-- /.right-widget -->                        </div> <!-- /.bg-wrapper -->                    </div> <!-- /.container -->                </div> <!-- /.theme-menu-wrapper -->
					...
					<div class="row">
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-8 col-12 theme-sidebar-one">
							<div class="sidebar-box service-categories">
								<ul>
								<li><a href="../wills">Wills and Probate Services</a></li>
								<?php do { ?>
									<li><a href="../page.php?a=<?php echo $row_rtdurl['pg_alias']?>"><?php echo $row_rtdurl['pg_name']?></a></li>
