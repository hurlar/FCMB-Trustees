                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <fieldset class="form-group">
                                ...
                                <p><?php echo $row_pi['reg_status'] ;?></p>
                                <input type="hidden" name="maidenname" value="<?php echo $row_pi['reg_status'] ;?>" />
                            </fieldset>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <fieldset class="form-group">
                                ...
                                <p><?php echo $row_identification['type'];?></p>
                                <input type="hidden" name="identificationtype" value="<?php echo $row_identification['type'];?>" >
                            </fieldset>
                        </div>
                    </div>
                     ...
                     <div class="row">
                        <div class="col-lg-3">
                            <fieldset class="form-group">
                                ...
                                <p><?php echo $row_identification['idnumber'];?></p>
                                 <input type="hidden" name="idnumber" value="<?php echo $row_identification['type'];?>" >
                            </fieldset>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <fieldset class="form-group">
                                ...
                                <p><?php echo $row_identification['issuedate'];?></p>
                        ...
                        <div class="col-lg-3">
                            <fieldset class="form-group">
                                ...
                                <p><?php echo $row_identification['expirydate'];?></p>
                        ...
                        <div class="col-lg-3">
                            <fieldset class="form-group">
                                ...
                                <p><?php echo $row_identification['issueplace'];?></p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <fieldset class="form-group">
                                ...
                                <p><?php echo $row_sourceoffund['earning_type'];?></p>
                                <input type="hidden" name="earningtype" value="<?php echo $row_sourceoffund ['earning_type'];?>" >
                            </fieldset>
                        </div>
                    </div> 
 
                    <?php if($row_sourceoffund ['earning_type'] == 'Others'){?>
                     <div class="row">
                        
                        <div class="col-lg-12">
                            <fieldset class="form-group">
                                <h5 class="without-border">Please Specify</h5>
                                <p><?php echo $row_sourceoffund ['note'];?></p>
                                <input type="hidden" name="otherspecify" value="<?php echo $row_sourceoffund ['note'];?>" >
                            </fieldset>
                        </div>
                    </div>
                    <?php } ?>
                    <div class="row">
                        <div class="col-lg-12">
                            <fieldset class="form-group">
                                ...
                                <p><?php echo $row_sourceoffund ['annual_income'];?></p>
                                <input type="hidden" name="annualincome" value="<?php echo $row_sourceoffund ['annual_income'];?>" >
                            </fieldset>
                        </div>
                    </div> <hr>
    <?php } while ($row_sourceoffund = mysqli_fetch_assoc($sourceoffund));?>
