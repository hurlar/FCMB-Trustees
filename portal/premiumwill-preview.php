...
$update1 = "UPDATE `willtype` SET `name` = 'Premium Will',`amount` = '41875' WHERE `uid` = '$userid' "; 
...
$querywill = "SELECT `id`,`uid`, `willtype`, `datecreated` FROM premiumwill_tb WHERE uid = '$userid' "; 
...
$querypayment = "SELECT `uid` FROM payment_tb WHERE uid = '$userid' AND `willtype` = '$willname' "; 
...
/*$query_submit = "SELECT `id`,`uid`, `datecreated` FROM premiumwill_tb WHERE `uid` = '$userid' "; 
...
<form action="processor/process-premiumpreview.php" method="POST">     
    ...
    <?php if($paymentcount < '1' && $willcount != NULL){?>             
...
<div class="alert alert-success alert-fill alert-close alert-dismissible fade show" role="alert">
	...
	<?php echo  ' You have successfully submitted your Will.<br> Please proceed to make your payment by clicking on the "Make Payment" button. ' ; ?>
</div>
<?php } ?>
...
<input type="hidden" name="willtype" value="Premium Will" />
