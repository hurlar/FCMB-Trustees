...
$queryeditnextofkin = "SELECT * FROM nextofkin WHERE `uid` = '$userid' ";
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-lg-push-3 col-md-12">
                            ...
                            <section class="card">
                            <form action="processor/process-simplewillaccesslevel.php" method="post">
                                    ...
                                    <table class="table table-bordered table-responsive-sm">
                                        ...
                                        <?php while($row = mysqli_fetch_array($result)){ ?>
                                            <tr>
                                                ...
                                                <td><a href="processor/process-simplewill-spousedelete.php?a=<?php echo $row["id"]; ?>"><input type="button" na/me="view" value="Delete" class="btn btn-fcmb btn-xs view_data"  onclick="return confirm('Are you sure you want to delete ?');" /></a></td>
                                            </tr> 
                                        <?php  } ?>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-bordered table-responsive-sm">
                                        ...
                                        <tbody>    
                                            <tr>
                                                ...
                                                <td><a href="processor/process-deletenextofkin.php?a=<?php echo $rownextofkin["id"]; ?>"><input type="button" na/me="view" value="Delete" class="btn btn-fcmb btn-xs view_data" onclick="return confirm('Are you sure you want to delete ?');" /></a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form method="post" action="processor/process-simplewill-addspouse.php" method="POST">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="countrym" class="form-control maxlength-simple" required id="exampleInput" value="<?php echo $_SESSION['countrym'];?>">
                                            </fieldset>
                                        </div>
                                    </div>
...
<div class="modal fade" id="exampleModalCenter<?php echo $rowedt['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Edit Details for <?php echo $rowedt['title'].' '.$rowedt['fullname']; ?><br><span style="font-size:13px;">N.B:</span> <span style="color:red;">*</span> <span style="font-size:13px;">All fields with asterisk are compulsory</span></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
            <form method="post" action="processor/process-simplewill-editspouse.php" method="POST">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <fieldset class="form-group">
                                                <label class="form-label" for="exampleInput">Title<span style="color:red;">*</span></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <fieldset class="form-group">
                                                <label class="form-label" for="exampleInput">Marriage Certificate No.</label>
                                                <input type="text" name="scert" class="form-control maxlength-simple" id="exampleInput" value="<?php echo $rowedt['marriagecert'];?>" >
                                            </fieldset>
                                        </div>
                                    </div>
...
<div class="modal fade" id="AddNextOfKin" tabindex="-1" role="dialog" aria-labelledby="exampleModalChildTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add Next Of Kin<br><span style="font-size:13px;">N.B:</span> <span style="color:red;">*</span> <span style="font-size:13px;">All fields with asterisk are compulsory</span></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
                <form method="post" action="processor/process-nextofkin.php" method="POST">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                            <label class="form-label" for="exampleInput">Full Name<span style="color:red;">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                            <label class="form-label" for="exampleInput">Telephone<span style="color:red;">*</span> </label>
                                    ...
                                    <div class="row">    
                                        <div class="col-lg-12">
                                            ...
                                            <input type="email" name="nextofkinemail" class="form-control maxlength-simple" id="exampleInput"  value="<?php echo $_SESSION['nextofkinemail']; ?>"/>
                                            </fieldset>
                                        </div>
                                    </div>
...
<div class="modal fade" id="editnextofkin<?php echo $roweditnextofkin['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Edit Details for <?php echo $roweditnextofkin['fullname'];?><br><span style="font-size:13px;">N.B:</span> <span style="color:red;">*</span> <span style="font-size:13px;">All fields with asterisk are compulsory</span> </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
            <form method="post" action="processor/process-editnextofkin.php" method="POST">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                            <label class="form-label" for="exampleInput">Full Name<span style="color:red;">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                            <label class="form-label" for="exampleInput">E-mail Address</label>
                                            <input type="email" name="edtnextofkinemail" class="form-control maxlength-simple" id="exampleInput" value="<?php echo $roweditnextofkin['email']; ?>"/>
                                            </fieldset>
                                        </div>
                                    </div>
