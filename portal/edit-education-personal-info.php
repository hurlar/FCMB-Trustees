...
<?php } ?>
                ...
                <form action="processor/process-edit-education-personal-info.php" method="post">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="mothermaidenname" value="<?php echo $row_pi['maidenname'];?>" class="form-control maxlength-simple" id="exampleInput" required />
                            </fieldset>
                        </div>
                    </div>
