...
<?php } ?>
                ...
                <form action="processor/process-edit-investment-personal-info.php" method="post">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="fname" value="<?php echo $row_pi['fname'];?>" class="form-control maxlength-simple" id="exampleInput" required />
                            </fieldset>
                        </div>
                        <div class="col-lg-4">
                            <fieldset class="form-group">
                        ...
                        <div class="col-lg-4">
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="lname" value="<?php echo $row_pi['lname'];?>" class="form-control maxlength-always-show" id="exampleInputPassword1" required />
                            </fieldset>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <fieldset class="form-group">
                                        ...
                                        <input type="text" name="dob" id="popupDatepicker" class="form-control" required value="<?php echo $row_pi['dob'];?>" >
                            </fieldset>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <fieldset class="form-group">
                                ...
                                <option value="Male" <?php if($row_pi['gender'] == 'Male'){ echo ' selected="selected"'; } ?> > Male </option>
                                <option value="Female" <?php if($row_pi['gender'] == 'Female'){ echo ' selected="selected"'; } ?> > Female </option>
                                </select>
                            </fieldset>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="mothermaidenname" value="<?php echo $row_pi['reg_status'];?>" class="form-control maxlength-simple" id="exampleInput" required />
                            </fieldset>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="phoneno" value="<?php echo $row_pi['phone'];?>" class="form-control maxlength-simple" id="exampleInput" required>
                            </fieldset>
                        </div>
                        <div class="col-lg-6">
                            <fieldset class="form-group">
...
<script src="js/app.js"></script>
    ...
    <!--Employer's Details MODAL STARTS HERE -->
    <!-- Modal -->
<div class="modal fade" id="employmentstatus" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add Employer's Details</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
                <form method="post" action="processor/process-addemployer.php" method="POST">
                                    <div class="row">
                                        
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                            <label class="form-label" for="exampleInput">Employer</label>
                                            <input type="text" name="employer" class="form-control maxlength-simple" id="exampleInput" required>
                                            </fieldset>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <input type="text" name="employeraddr" class="form-control maxlength-simple" id="exampleInput" required>
                                            </fieldset>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <input type="text" name="employerphone" class="form-control maxlength-simple" id="exampleInput" required>
                                            </fieldset>
                                        </div>
                                    ...
                                    <input type="hidden" name="employerid" value="<?php echo $userid; ?>"  />
                                    <input type="hidden" name="employerstatus" value="Employed"  />
    ...
    <!--Employer's Details MODAL STATUS ENDS HERE-->



    <!--Edit Employer's Details MODAL STARTS HERE -->
<div class="modal fade" id="editemployer<?php echo $row_editemp['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Edit Employer's Details</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
                ...
                <form method="post" action="processor/process-addemployer.php" method="POST">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                            <label class="form-label" for="exampleInput">Employer</label>
                                            <input type="text" name="employer" value="<?php echo $row_editemp['employer'];?>" class="form-control maxlength-simple" id="exampleInput" required>
                                            </fieldset>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                            <label class="form-label" for="exampleInput">Employer's Address</label>
                                            <input type="text" name="employeraddr" value="<?php echo $row_editemp['address'];?>" class="form-control maxlength-simple" id="exampleInput" required>
                                            </fieldset>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                            <label class="form-label" for="exampleInput">Office Phone</label>
                                            <input type="text" name="employerphone" value="<?php echo $row_editemp['phone'];?>" class="form-control maxlength-simple" id="exampleInput" required>
                                            </fieldset>
                                        </div>
    ...
    <!--Edit Employer's Details MODAL STATUS ENDS HERE-->
