            ...
            <div class="row">
				...
				<div class="add-customers-screen tbl">
					<div class="add-customers-screen-in">
						<h2>A general error occurred</h2>
						<!--<div class="add-customers-screen-user">
							<i class="font-icon font-icon-user"></i>
						</div>-->
						<img src="images/logo.svg" alt="FCMB Trustees Logo" style="height:300px; width:300px;"/><br>
						<a href="dashboard.php" class="btn btn-inline btn-fcmb">Back to dashboard</a>
					</div>
				</div>
			</div><!--.box-typical-->
