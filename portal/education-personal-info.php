    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                ...
                <form action="processor/process-education-personal-info.php" method="post" enctype="multipart/form-data">
                <section class="card">
...
<h5>Source of Fund</h5>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="radio">
                                <input type="radio" name="sourceoffund" id="radio-9" value="Salary" <?php if($row_pi['earning_type'] == 'Salary'){ echo ' checked="checked"'; } ?> Required>
                                <label for="radio-9">Salary </label>
                                <input type="radio" name="sourceoffund" id="radio-10" value="Business" <?php if($row_pi['earning_type'] == 'Business'){ echo ' checked="checked"'; } ?> Required>
                                <label for="radio-10">Business</label>
                                <input type="radio" name="sourceoffund" id="radio-11" value="Gratuity" <?php if($row_pi['earning_type'] == 'Gratuity'){ echo ' checked="checked"'; } ?> Required>
                                <label for="radio-11">Gratuity</label>
                                <input type="radio" name="sourceoffund" id="radio-12" value="Properties" <?php if($row_pi['earning_type'] == 'Properties'){ echo ' checked="checked"'; } ?> Required>
                                <label for="radio-12">Properties</label>
                                <input type="radio" name="sourceoffund" id="radio-13" value="Others" <?php if($row_pi['earning_type'] == 'Others'){ echo ' checked="checked"'; } ?> Required>
                                <label for="radio-13">Others</label>  <br>
                            </div>
...
<div class="row">
                        ...
                        <div class="col-lg-6">
                            <fieldset class="form-group">
                                <label class="form-label" for="exampleInput">Others (Please Specify)</label>
                                <input type="text" name="earningothers" value="<?php echo $row_pi['earning_note'];?>" class="form-control maxlength-simple" id="exampleInput" />
                            </fieldset>
                        </div>

                        <div class="col-lg-6">
                            <fieldset class="form-group">
                                <label class="form-label" for="exampleInputPassword1">Annual Income/ Turnover</label>
                                <input type="text" name="annualturnover" value="<?php echo $row_pi['annual_income'];?>" class="form-control" id="exampleInputPassword1" />
                            </fieldset>
                        </div>
...
<h5>Upload Passport</h5>
                ...
                <input type="file" name="passport" required />
                        ...
                        <div class="col-sm-12">
                            <fieldset class="form-group">
<label class="form-label" for="exampleInputEmail1"><em>(Max. File size is 500kb and must be in either jpeg, jpg, png or gif)</em></label>
                            </fieldset>
                        </div>
