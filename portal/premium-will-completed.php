...
$querygd = "SELECT `uid`,`name`,`title`,`guardianname`,`rtionship`,`email`,`phone`,`addr`,`city`,`state`,`stipend`,`age` FROM children_details WHERE uid = '$userid' AND age < '18' ";
...
$querypmt = "SELECT `uid` FROM payment_tb WHERE uid = '$userid' "; 
...
<?php if ($totalpmt == NULL) { ?>
                                        <section class="box-typical sidemenu">
                        <div class="profile-card">
                            <div class="profile-card-name"> &#x20A6; 35, 000</div> <br/>
<button type="button" class="btn btn-fcmb" data-toggle="modal" data-target=".bd-example-modal-lg">Make Payment</button>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    ...
    <div class="row" style="padding:20px;">
      <div class="col-md-6">
          <h4 style="margin-top:10px; color:#5C0F8B; font-size:20px;">Make payment via paystack </h4>
          <p style="text-align:left;">Please note that a standard transfer charge of &#x20A6; 625.00 will apply if you choose to make your payment via Paystack.</p><br>
          <form >
      ...
      <div class="col-md-6">
          <h4 style="margin-top:10px; color:#5C0F8B; font-size:20px;"> Make payment via FCMB Internet Banking  </h4>
          <p style="text-align:left;">Please make payment transfer into the account details below via FCMB Internet Banking: <br>
Account Name: FCMB Trustees Limited CALL<br>

Account Number: 0678691020<br>

Bank Name: FCMB</p> 
          <a href="http://fcmb.com" target="_blank"><button type="button" class="btn btn-fcmb" data-toggle="modal" data-target=".bd-example-modal-lg" style="padding-top:10px; padding-bottom:10px;">Make Payment</button></a> <br><br>
      </div>
    </div>
...
<?php } ?>
        ...
        <?php do { ?>
            <section class="card">
                <div class="card-block">
                    <h5 class="with-border">Guardian Details for <?php echo $row_gd['name'];?></h5>
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-bordered table-responsive-sm">
                                        <thead>
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                <td> <?php echo $row_gd['title'].' '.$row_gd['guardianname'];?></td>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-bordered table-responsive-sm">
                                        ...
                                        <?php do { ?>
                                            <tr>
                                                <td> <?php echo $row_wit['fullname'];?></td>
                                                <td><?php echo $row_wit['rtionship'];?></td>
                                                <td><?php echo $row_wit['addr'];?></td>
                                                <td><?php echo $row_wit['phone'];?></td>
                                                <td><?php echo $row_wit['email'];?></td>
                                            </tr>
