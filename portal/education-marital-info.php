        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-lg-push-3 col-md-12">
                            ...
                            <section class="card">
                            <form action="processor/process-educationaccesslevel.php" method="post">
...
<?php if($url == 'identification'){  ?>
<div class="alert alert-warning alert-fill alert-close alert-dismissible fade show" role="alert">
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
    <?php echo  ' Please add a means of identification.' ; ?>
</div>
<?php } ?>

<?php if($url == 'sourceoffund'){  ?>
<div class="alert alert-warning alert-fill alert-close alert-dismissible fade show" role="alert">
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
    <?php echo  ' Please add your source of fund.' ; ?>
</div>
<?php } ?>
                                    ...
                                    <table class="table table-bordered table-responsive-sm">
                                        ...
                                        <?php while($row = mysqli_fetch_array($result)){ ?>
                                            <tr>
                                                ...
                                                <td><a href="processor/process-education-spousedelete.php?a=<?php echo $row["id"]; ?>"><input type="button" na/me="view" value="Delete" class="btn btn-fcmb btn-xs view_data"  onclick="return confirm('Are you sure you want to delete ?');" /></a></td>
                                            </tr> 
                                        <?php  } ?>
                                        </tbody>
                                    </table>
...
<?php } ?>
                    ...
                    <h5 class="with-bo/rder">FEATURES OF THE PRODUCT</h5>

                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <p>One-off establishment fee of N25,000 for the Trust and an Initial minimum contribution of N250,000 and additional monthly contribution to be determined by Settlor. </p>
                                    <p>Maturity is tied to the fulfillment of the object of the Trust as or else directed by the Settlor.</p>
                                    <p>It is more than a savings plan.</p>
                                    <p>The contributions fund and create a Trust for the benefit of the beneficiary and withdrawal from the Trust Fund is limited only to educational expenses for the beneficiary upon presentation of the child’s school bills.</p>
                                    <p>Withdrawals shall not be made in the first one year of the Trust</p>
                                    <p>The settlor can create a standing order instruction for automatic deductions/contributions to fund the Trust.</p>
                                    <p>Third parties are prohibited from having access to the Trust Fund, although they  are permitted to make contributions.</p>
                                    <p>Life Insurance policy of N1,000,000.00 (N1million) maximum cover per child.</p>
                           <!-- <input type="checkbox" name="features" style="width:50px; height:50px;" />-->
                        </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add Spouse Information</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
                <form method="post" action="processor/process-education-addspouse.php" method="POST">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="sdob" class="form-control" value="<?php echo $_SESSION['sdob'];?>" id="datepicker2" required >
                                        </fieldset>
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                            <fieldset class="form-group">
...
<div class="modal fade" id="exampleModalCenter<?php echo $rowedt['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form method="post" action="processor/process-education-editspouse.php" method="POST">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <fieldset class="form-group">
                                                <label class="form-label" for="exampleInput">Title</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <fieldset class="form-group">       <label>Date of Birth (MM/DD/YYYY)</label> 
                                            <input type="text" name="sdob" class="form-control" value="<?php echo $rowedt['dob'];?>" id="datepicker" required >
                                        </fieldset>
                                        </div> 
