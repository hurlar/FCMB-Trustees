...
<?php } ?>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <fieldset class="form-group">
                                        ...
                                        <input type="text" name="dob" id="popupDatepicker" class="form-control" required autocomplete="off" 
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <fieldset class="form-group">
                                <label class="form-label" for="exampleInput">Employment Status<span style="color:red;">*</span></label>
                            </fieldset>
                        </div>
                        ...
                        <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <input type="text" name="employerphone" class="form-control maxlength-custom-message" id="exampleInputEmail1" value="<?php echo $row_pi['employerphone'];?>" >
                                                    </fieldset>
                                                </div>
                                                </div>
                                            <div class="row">
