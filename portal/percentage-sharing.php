...
$queryprt = "SELECT `id`,`uid`,`asset_type`, `property_location`, `property_type`, `shares_company`, `insurance_company`,`bankname`,`accounttype`,`pension_name`,`investment_type`,`investment_account` FROM assets_tb WHERE uid = '$userid' AND `asset_type` != 'Personal Chattels' ";
...
<?php } ?>
            ...
            <form action="processor/process-validate-percentage-sharing.php" method="post">
            ...
            <?php while ($row_prt = mysqli_fetch_assoc($prt)) { 
              ...
              $pensionname = $row_prt['pension_name'];
              $investmenttype = $row_prt['investment_type'];
              $investmentaccount = $row_prt['investment_account'];
...
<?php
$queryben = "SELECT `id`,`fullname`,`uid` FROM beneficiary_dump WHERE uid = '$userid' ";
...
?>
                     ...
                     <?php if ($row_prt['asset_type'] == 'property') {
                       echo $propertytype;
                     }elseif ($row_prt['asset_type'] == 'shares'){
                        echo $sharescompany;
                     }elseif ($row_prt['asset_type'] == 'insurance'){
                         echo $insurancecompany;
                     }elseif ($row_prt['asset_type'] == 'bankaccount'){
                         echo $bankname;
                     }elseif ($row_prt['asset_type'] == 'Pension'){
                         echo $pensionname;
                     }elseif ($row_prt['asset_type'] == 'Other Investments'){
                         echo $investmenttype.'('.$investmentaccount.')';
                     } ?>
                     </h5>
                     <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-bordered table-responsive-sm">
                                        ...
                                        <?php do { 
                                            ...
                                            $querypercentage = "SELECT `propertyid`, `beneficiaryid`, `percentage` FROM overall_asset WHERE beneficiaryid = '$beneficiaryid' AND propertyid = '$propertyid' ";
...
<?php  
$queryprt2 = "SELECT `id`,`uid`,`asset_type` FROM assets_tb WHERE uid = '$userid' ";
...
$querybenadd1 = "SELECT `id`,`fullname`,`uid` FROM beneficiary_dump WHERE uid = '$userid' ";
...
while ($row_benadd1 = mysqli_fetch_assoc($benadd1)) {
    ...
    $querypercentage2 = "SELECT `propertyid`, `beneficiaryid`, `percentage` FROM overall_asset WHERE beneficiaryid = '$beneficiaryid2' AND propertyid = '$propertyid2' ";
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form method="post" action="processor/process-addpercentage.php" method="POST">
                                    <div class="row">
                                        <div class="col-lg-6">
                    ...
                    <input type="hidden" name="propertytype" value="<?php echo $row_prt2['asset_type'] ; ?>"  /> 
                                    <input type="hidden" name="uid" value="<?php echo $userid; ?>"  /> 
