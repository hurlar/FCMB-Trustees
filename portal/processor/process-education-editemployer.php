...
$url1 = '../education-personal-info.php?a=successful';
$url2 = '../education-personal-info.php?a=error';
...
if ($totalacl == TRUE) {
	...
	header("Location: ../education-personal-info.php?a=update");
	exit();
}else{
	...
	header("Location: ../education-personal-info.php?a=insert");
}
