...
$sql="INSERT INTO beneficiary_dump (`uid`, `title`, `fullname`,`rtionship`,`email`,`phone`,`addr`,`city`,`state`,`datecreated`,`dob`) VALUES ('$buid', '$btitle', '$bfname','$brelationship', '$bemail', '$bphoneno','$baddr', '$bcity', '$bstate', NOW(), '$bdob')";
