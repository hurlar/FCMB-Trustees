...
$url1 = '../simplewill-add-witness.php?a=update';
...
$sql="UPDATE simplewill_executors_tb SET `title` = '$gtitle', `fullname` = '$gname', `rtionship` = '$grelationship', `email` = '$gemail', `phone` = '$gphoneno', `addr` = '$gaddr', `city` = '$gcity', `state` = '$gstate' WHERE id = '$executorid' ";
