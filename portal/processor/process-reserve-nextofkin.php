...
$sql="INSERT INTO reserve_nextofkin (`uid`, `fullname`, `address`,        `telephone`, `email`, `dateposted`) VALUES ('$cuid', '$nextofkinfullname', '$nextofkinaddress', '$nextofkinphone', '$nextofkinemail', NOW())";
