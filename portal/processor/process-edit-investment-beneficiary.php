...
$url1 = '../investment-marital-info.php?a=update';
$url2 = '../investment-marital-info.php?a=error';


mysqli_select_db($conn, $database_conn);
$sql2 = "UPDATE investment_beneficiary SET `title` = '$editbeneficiarytitle', `fullname` = '$editbeneficiaryname', rtionship = '$editbeneficiaryrelationship', dob = '$editbeneficiarydob' WHERE `id` = '$editbeneficiaryid' ";  
