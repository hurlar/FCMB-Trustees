...
//$userid = $_SESSION['userid'];
  ...
  if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if(!ctype_alpha(str_replace($search,$replace,$fname))){
        header("Location: ../investment-personal-info.php?a=lettersonly");
        exit();
    }elseif(!ctype_alpha(str_replace($search,$replace,$lname))){
        header("Location: ../investment-personal-info.php?a=lettersonly");
        exit();
    }elseif(!ctype_digit($phoneno)){
        header("Location: ../investment-personal-info.php?a=numbersonly");
        exit();
    ...
    if(($size < 1250000)){
      ...
      if ($total_select = 1) {
            ...
            header("Location:../investment-marital-info.php");
      }else{
      ...
      header("Location:../investment-personal-info.php?a=error");
    }
    }else{
      header("Location:../investment-personal-info.php?a=denied");
    }

  }else{
    header("Location:../investment-personal-info.php?a=invalid");
  }
