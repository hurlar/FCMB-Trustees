...
$sql="UPDATE financial_guardian SET `title` = '$gtitle', `fullname` = '$gname', `rtionship` = '$grelationship', `email` = '$gemail', `phone` = '$gphoneno', `addr` = '$gaddr', `city` = '$gcity', `state` = '$gstate' WHERE id = '$guardianid' ";
