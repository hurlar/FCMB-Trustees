...
$sql="UPDATE nextofkin SET `fullname` = '$edtnextofkinfullname', `address` =  '$edtnextofkinaddress', `telephone` = '$edtnextofkinphone', `email` = '$edtnextofkinemail' WHERE `id` = '$nextofkinid' ";  
