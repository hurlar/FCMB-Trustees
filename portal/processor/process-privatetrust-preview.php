...
$url1 = '../privatetrust-preview.php?a=successfull';

$url2 = '../privatetrust-preview.php?a=error';
...
$message = str_replace( $search, $replace,  $message1 );
  ...
  if(!$mail->Send()) {
      ...
      header("Location: processor-admin-privatetrust-confirmation.php");
  }
