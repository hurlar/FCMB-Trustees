...
$url1 = '../premiumwill-preview.php?a=successfull';

$url2 = '../premiumwill-preview.php?a=error';
...
$message = str_replace( $search, $replace,  $message1 );
  ...
  if(!$mail->Send()) {
      ...
      header("Location: processor-admin-premiumwill-confirmation.php");
  }
