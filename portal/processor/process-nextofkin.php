...
$sql="INSERT INTO nextofkin (`uid`, `fullname`, `address`,        `telephone`, `email`, `dateposted`) VALUES ('$cuid', '$nextofkinfullname', '$nextofkinaddress', '$nextofkinphone', '$nextofkinemail', NOW())";
