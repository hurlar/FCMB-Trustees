    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                ...
                <form action="processor/process-estate-form.php" method="post">
                    <h5 class="with-border">Personal Data </h5>
                    <div class="row">
                        <div class="col-lg-12">
                            <fieldset class="form-group">
                                <label class="form-label" for="exampleInput">Full Name</label>
                                <input type="text" name="fullname1" value="<?php echo $salutation.' '.ucfirst($fname).' '.ucfirst($mname).' '.ucfirst($lname);?>" class="form-control maxlength-simple" id="exampleInput" disabled >
                    ...
                    <?php if ($row_pi['lga'] != NULL) { ?>
                        <div class="col-lg-4">
                            <fieldset class="form-group">
                                <label class="form-label" for="exampleInput">LGA</label>
                                <input type="text" name="lga1"  value="<?php echo $row_pi['lga'];?>" disabled class="form-control maxlength-simple" id="exampleInput" >
                                <input type="hidden" name="lga"  value="<?php echo $row_pi['lga'];?>" />
                            </fieldset>
                        </div>
                    <?php } ?>
                    </div> <br>
                                        <h5 class="with-border">Employment Status</h5>
                    <?php if ($row_pi['employment_status'] == 'Employed') { ?>
                    <div class="row">
                        <div class="col-lg-6">
                            <fieldset class="form-group">
                                <label class="form-label" for="exampleInput">Employment Status</label>
                                <input type="text" name="employer1" disabled value="<?php echo $row_pi['employment_status'];?>" class="form-control maxlength-simple"  />
                                <input type="hidden" name="employer" value="<?php echo $row_pi['employment_status'];?>" />
                            </fieldset>
                        </div>
                    </div>
                    <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="employer1" disabled value="<?php echo $row_pi['employer'];?>" class="form-control maxlength-simple"  />
                                <input type="hidden" name="employer" value="<?php echo $row_pi['employer'];?>" />
                            </fieldset>
                        </div>
                        <div class="col-lg-6">
                            <fieldset class="form-group">
                                <label class="form-label" for="exampleInput">Employer's Phone</label>
                                <input type="text" name="employer1" disabled value="<?php echo $row_pi['employerphone'];?>" class="form-control maxlength-simple"  />
                                <input type="hidden" name="employer" value="<?php echo $row_pi['employerphone'];?>" />
                            </fieldset>
                        </div>
                    </div>
                    <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="employer1" disabled value="<?php echo $row_pi['employeraddr'];?>" class="form-control maxlength-simple"  />
                                <input type="hidden" name="employer" value="<?php echo $row_pi['employeraddr'];?>" />
                            </fieldset>
                        </div>
                    </div>
                    <?php } ?><br>
                ...
                <?php if ($totaldv != NULL) { ?>
                     <h5 class="with-border">Divorce</h5>
                        ...
                        <div class="col-lg-6">
                            <fieldset class="form-group">
                                <label class="form-label" for="exampleInput">Have you had any marriage which ended in divorce?</label>
                        <input type="text" name="divorce1" value="<?php echo $row_dv['divorce'] ;?>" disabled class="form-control maxlength-simple" id="exampleInput" >
                        ...
                        <div class="col-lg-6">
                            <fieldset class="form-group">
                                <label class="form-label" for="exampleInput">If Yes, When was the divorce</label>
                                <input type="text" name="divorceyear1" value="<?php echo $row_dv['divorceyear'] ;?>" disabled class="form-control maxlength-simple" id="exampleInput">
                    ...
                    <div class="row">
                        ...
                        <h5>Pension</h5>
                            <table class="table table-bordered table-responsive-sm">
                                        <thead>
                                          <tr>
                                            <th>Name of Pension Provider</th>       <th>Name of Pension Holder</th>
                                          </tr>
                                        </thead>
                                        <tbody> 
                                        <?php do { ?>
                ...
                <?php if ($row_pns['pension_plan'] == 'Yes') { ?>
                    ...
                    <div class="col-lg-6">
                            <fieldset class="form-group">
                                <label class="form-label" for="exampleInput">RSA Number</label>
                                <input type="text" name="rsano1" value="<?php echo $row_pns['rsano'] ;?>" disabled class="form-control maxlength-simple" id="exampleInput">
                                <input type="hidden" name="rsano" value="<?php echo $row_pns['rsano'] ;?>" >
                            </fieldset>
                        </div>      
                    <div class="col-lg-6">
                            <fieldset class="form-group">
                                <label class="form-label" for="exampleInput">Pension Fund Administrator</label>
                                <input type="text" name="pensionadmin" value="<?php echo $row_pns['pension_admin'] ;?>" disabled class="form-control maxlength-simple" id="exampleInput">
                                <input type="hidden" name="pensionadmin" value="<?php echo $row_dv['pension_admin'] ;?>" >
                            </fieldset>
                        </div>
                    </div>          
                            <br>
                <?php } ?>
                    ...
                    <?php if ($totalinfo != NULL) { ?>
                    <h5 class="with-border">Special Wishes</h5>
                    <?php if ($row_info['addinfo'] != NULL) { ?>
                    <div class="row">
                        <div class="col-lg-12">
                            <fieldset class="form-group">
                                <textarea rows="5" name="addinfo1" class="form-control maxlength-simple" disabled><?php echo $row_info['addinfo'];?></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-11">
                            <fieldset class="form-group">
                                <label class="form-label" for="exampleInput">  I hereby declare and undertake that all the statements made above are true and correct and that I have not 
