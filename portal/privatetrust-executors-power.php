...
$queryexec = "SELECT * FROM executor_power WHERE uid = '$userid' AND willtype = 'Estate Planning Questionnaire Form' "; 
...
<form action="processor/process-addexecutorpowerprivatetrust.php" method="POST">            
            <div class="row">
