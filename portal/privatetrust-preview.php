...
$update1 = "UPDATE `willtype` SET `name` = 'Estate Planning Questionnaire Form',`amount` = ' ' WHERE `uid` = '$userid' "; 
$update_run1 = mysqli_query($conn, $update1) or die(mysqli_error($conn));

$querywill = "SELECT `id`,`uid`, `willtype`, `datecreated` FROM privatetrust_tb WHERE uid = '$userid' "; 
...
$queryexecpower = "SELECT * FROM executor_power WHERE uid = '$userid' AND willtype = 'Estate Planning Questionnaire Form' "; 
...
<form action="processor/process-privatetrust-preview.php" method="POST">            
            <div class="row">
...
<div class="alert alert-success alert-fill alert-close alert-dismissible fade show" role="alert">
	...
	<?php echo  ' You have successfully created your Trust.<br> A representative will contact you shortly. ' ; ?>
</div>
<?php } ?>
...
<input type="hidden" name="willtype" value="Estate Planning Questionnaire Form" />
