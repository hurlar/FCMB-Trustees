...
$investmentbeneficiarystatus = "SELECT `uid`, `status` FROM investment_beneficiary_status WHERE `uid` = '$userid' ";
...
$querybeneficiary = "SELECT * FROM investment_beneficiary WHERE `uid` = '$userid' ";
...
$queryeditbeneficiary = "SELECT * FROM investment_beneficiary WHERE `uid` = '$userid' ";
...
$queryeditnextofkin = "SELECT * FROM investment_nextofkin WHERE `uid` = '$userid' ";
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-lg-push-3 col-md-12">
                            ...
                            <form action="processor/process-investmentaccesslevel.php" method="post">
                                <section class="card">
                                    ...
                                    <table class="table table-bordered table-responsive-sm">
                                        ...
                                        <?php while($row = mysqli_fetch_array($result)){ ?>
                                            <tr>
                                                ...
                                                <td><a href="processor/process-investment-spousedelete.php?a=<?php echo $row["id"]; ?>"><input type="button" na/me="view" value="Delete" class="btn btn-fcmb btn-xs view_data"  onclick="return confirm('Are you sure you want to delete ?');" /></a></td>
                                            </tr> 
                                        <?php  } ?>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-bordered table-responsive-sm">
                                        ...
                                        <?php while($rowbeneficiary = mysqli_fetch_array($resultbeneficiary)){ ?>
                                            <tr>
                                                ...
                                                <td><a href="processor/process-investment-beneficiarydelete.php?a=<?php echo $rowbeneficiary["id"]; ?>"><input type="button" na/me="view" value="Delete" class="btn btn-fcmb btn-xs view_data"  onclick="return confirm('Are you sure you want to delete ?');" /></a></td>
                                            </tr> 
                                        <?php  } ?>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-bordered table-responsive-sm">
                                        ...
                                        <tbody>    
                                            <tr>
                                                ...
                                                <td><a href="processor/process-delete-investment-nextofkin.php?a=<?php echo $rownextofkin["id"]; ?>"><input type="button" na/me="view" value="Delete" class="btn btn-fcmb btn-xs view_data" onclick="return confirm('Are you sure you want to delete ?');" /></a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form method="post" action="processor/process-investment-addspouse.php" method="POST">
                                    <div class="row">
...
<div class="modal fade" id="exampleModalCenter<?php echo $rowedt['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form method="post" action="processor/process-investment-editspouse.php" method="POST">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <fieldset class="form-group">
                                                <label class="form-label" for="exampleInput">Title</label>
...
<div class="modal fade" id="addbeneficiary" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form method="post" action="processor/process-investment-beneficiary.php" method="POST">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <fieldset class="form-group">
                                                <label class="form-label" for="exampleInput">Title</label>
...
<div class="modal fade" id="editbeneficiary<?php echo $roweditbeneficiary['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form method="post" action="processor/process-edit-investment-beneficiary.php" method="POST">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <fieldset class="form-group">
                                                <label class="form-label" for="exampleInput">Title</label>
...
<div class="modal fade" id="AddNextOfKin" tabindex="-1" role="dialog" aria-labelledby="exampleModalChildTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form method="post" action="processor/process-investment-nextofkin.php" method="POST">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                            <label class="form-label" for="exampleInput">Full Name</label>
...
<div class="modal fade" id="editnextofkin<?php echo $roweditnextofkin['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form method="post" action="processor/process-edit-investment-nextofkin.php" method="POST">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset class="form-group">
                                            <label class="form-label" for="exampleInput">Full Name</label>
...
<div class="modal fade" id="exampleModaldivorce" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form method="post" action="processor/process-add-investment-divorce.php" method="POST">
                            <div class="row">
                        <div class="col-md-8 col-sm-12">
                            <p>
