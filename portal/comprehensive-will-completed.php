...
$querygd = "SELECT `uid`,`title`,`name`,`guardianname`,`rtionship`,`email`,`phone`,`addr`,`city`,`state`,`stipend`,`age` FROM children_details WHERE uid = '$userid' AND age < '18' ";
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                ...
                <h3 class="with-border">Comprehensive Will </h3>
                            <section class="card">
...
<?php if($url == 'successfull'){  ?>   
                   <div class="alert alert-success" role="alert">
                    <p>
                        Thank you for completing and submitting this form. A representative will contact you, shortly, to discuss the creation of your Comprehensive Will, based on the information that you have provided here.
                    </p>
                </div>
<?php } ?>   
                        ...
                        <div class="col-lg-12">
                            <table class="table table-bordered table-responsive-sm">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                <td> <?php echo $row_gd['guardianname'];?></td>
