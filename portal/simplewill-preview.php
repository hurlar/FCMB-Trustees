...
$msg = $row_pi['msg'];
$city = $row_pi['city'];
$rstate = $row_pi['rstate'];
$maidenname = $row_pi['maidenname'];
$employment_status = $row_pi['employment_status'];
$datecreated = $row_pi['datecreated'];
$employer = $row_pi['employer'];
$employerphone = $row_pi['employerphone'];
$employeraddr = $row_pi['employeraddr'];
$passport = $row_pi['passport'];
$identification_type = $row_pi['identification_type'];
$identification_number = $row_pi['identification_number'];
$issuedate = $row_pi['issuedate'];
$expirydate = $row_pi['expirydate'];
$issuedplace = $row_pi['issuedplace'];
$earning_type = $row_pi['earning_type'];
$earning_note = $row_pi['earning_note'];
$annual_income = $row_pi['annual_income'];
$nameofcompany = $row_pi['nameofcompany'];
$company_telephone = $row_pi['company_telephone'];
$company_email = $row_pi['company_email'];
...
<form action="processor/process-simplewill-preview.php" method="POST">            
            <div class="row">
                <div class="col-lg-3 col-lg-pull-6 col-md-6 col-sm-6">
                    <?php include ('inc/inc_avatar.php');?>
                
                <?php if($totalsubmit = 1 AND $totalpay < 1){ ?>  
