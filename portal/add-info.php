		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="card-block">
					<h5 class="with-bo/rder">Additional Information</h5> 
				...
				<form action="processor/process-add-info.php" method="post">
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header" style="background-color:#5C3092;">
								...
								<h4 class="modal-title" id="myModalLabel"> <span style="color:#fff;">Additional Information</span></h4>
							</div>
							<div class="modal-body">
								<form method="post" id="spouse_form">
									<div class="col-sm-12">
							<fieldset class="form-group">
								<label class="form-label" for="exampleInputEmail1">Additional Information</label>
								<textarea rows="2" name="addinfo" class="form-control maxlength-simple"  ></textarea>
							</fieldset>
						</div>
