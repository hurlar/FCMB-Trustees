...
$selectinvestment = "SELECT * FROM `reserve_request_savings` WHERE `uid` = '$userid' ";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3 col-lg-pull-6 col-md-6 col-sm-6">
                    ...
                    <section class="box-typical sidemenu" >
                        <div class="profile-card">
                            <div class="profile-card-name"> Request for Investment Savings in the Reserve Trust </div>
                ...
                <div class="col-lg-9 col-lg-push-3 col-md-12">
                    <form action="processor/process-reserve-request-saving.php" method="post">
                    <section class="card">
...
<?php } ?>
                    ...
                    <h5 class="with-bo/rder">Request for Investment Savings in the RESERVE TRUST</h5>
