...
//
// Table class for addinfo_tb
//
class caddinfo_tb extends cTable {
	var $id;
	var $uid;
	var $addinfo;
	var $spinstruct;
	...
	function __construct() {
		...
		$this->TableVar = 'addinfo_tb';
		$this->TableName = 'addinfo_tb';
		...
		// id
		$this->id = new cField('addinfo_tb', 'addinfo_tb', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// uid
		$this->uid = new cField('addinfo_tb', 'addinfo_tb', 'x_uid', 'uid', '`uid`', '`uid`', 3, -1, FALSE, '`uid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->uid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['uid'] = &$this->uid;

		// addinfo
		$this->addinfo = new cField('addinfo_tb', 'addinfo_tb', 'x_addinfo', 'addinfo', '`addinfo`', '`addinfo`', 201, -1, FALSE, '`addinfo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['addinfo'] = &$this->addinfo;

		// spinstruct
		$this->spinstruct = new cField('addinfo_tb', 'addinfo_tb', 'x_spinstruct', 'spinstruct', '`spinstruct`', '`spinstruct`', 201, -1, FALSE, '`spinstruct`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spinstruct'] = &$this->spinstruct;

		// datecreated
		$this->datecreated = new cField('addinfo_tb', 'addinfo_tb', 'x_datecreated', 'datecreated', '`datecreated`', 'DATE_FORMAT(`datecreated`, \'%d/%m/%y\')', 135, -1, FALSE, '`datecreated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("addinfo_tbview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("addinfo_tbview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "addinfo_tbadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("addinfo_tbedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("addinfo_tbadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("addinfo_tbdelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->spinstruct->Exportable) $Doc->ExportCaption($this->spinstruct);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->spinstruct->Exportable) $Doc->ExportField($this->spinstruct);
