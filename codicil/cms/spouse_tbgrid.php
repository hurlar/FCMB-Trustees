...
<?php if ($spouse_tb->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<td><div><div id="elh_spouse_tb_id" class="spouse_tb_id">
...
<span id="el<?php echo $spouse_tb_grid->RowCnt ?>_spouse_tb_id" class="control-group spouse_tb_id">
...
<input type="hidden" data-field="x_id" name="x<?php echo $spouse_tb_grid->RowIndex ?>_id" id="x<?php echo $spouse_tb_grid->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($spouse_tb->id->FormValue) ?>">
<input type="hidden" data-field="x_id" name="o<?php echo $spouse_tb_grid->RowIndex ?>_id" id="o<?php echo $spouse_tb_grid->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($spouse_tb->id->OldValue) ?>">
<?php } ?>
...
<?php } else { ?>
<span id="el$rowindex$_spouse_tb_id" class="control-group spouse_tb_id">
<span<?php echo $spouse_tb->id->ViewAttributes() ?>>
