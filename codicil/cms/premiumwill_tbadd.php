...
$premiumwill_tb_add = NULL; // Initialize page object first

class cpremiumwill_tb_add extends cpremiumwill_tb {
	...
	// Page object name
	var $PageObjName = 'premiumwill_tb_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("premiumwill_tblist.php"); // No matching record, return to list
				}
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			// fullname
			if (!ew_Empty($this->uid->CurrentValue)) {
				$this->fullname->HrefValue = "http://tisvdigital.com/trustees/portal/adminpremiumwill-preview.php?a=" . ((!empty($this->uid->EditValue)) ? $this->uid->EditValue : $this->uid->CurrentValue); // Add prefix/suffix
				$this->fullname->LinkAttrs["target"] = "_blank"; // Add target
				if ($this->Export <> "") $this->fullname->HrefValue = ew_ConvertFullUrl($this->fullname->HrefValue);
			} else {
				$this->fullname->HrefValue = "";
...
// Create page object
if (!isset($premiumwill_tb_add)) $premiumwill_tb_add = new cpremiumwill_tb_add();

// Page init
$premiumwill_tb_add->Page_Init();

// Page main
$premiumwill_tb_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$premiumwill_tb_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var premiumwill_tb_add = new ew_Page("premiumwill_tb_add");
premiumwill_tb_add.PageID = "add"; // Page ID
var EW_PAGE_ID = premiumwill_tb_add.PageID; // For backward compatibility

// Form object
var fpremiumwill_tbadd = new ew_Form("fpremiumwill_tbadd");

// Validate form
fpremiumwill_tbadd.Validate = function() {
...
fpremiumwill_tbadd.Form_CustomValidate = 
...
fpremiumwill_tbadd.ValidateRequired = true;
<?php } else { ?>
fpremiumwill_tbadd.ValidateRequired = false; 
<?php } ?>
...
<?php $premiumwill_tb_add->ShowPageHeader(); ?>
<?php
$premiumwill_tb_add->ShowMessage();
?>
<form name="fpremiumwill_tbadd" id="fpremiumwill_tbadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="premiumwill_tb">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_premiumwill_tbadd" class="table table-bordered table-striped">
...
<?php
	if (in_array("personal_info", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $personal_info->DetailAdd) {
?>
<?php include_once "personal_infogrid.php" ?>
<?php } ?>
<?php
	if (in_array("spouse_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $spouse_tb->DetailAdd) {
?>
<?php include_once "spouse_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("divorce_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $divorce_tb->DetailAdd) {
?>
<?php include_once "divorce_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("children_details", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $children_details->DetailAdd) {
?>
<?php include_once "children_detailsgrid.php" ?>
<?php } ?>
<?php
	if (in_array("beneficiary_dump", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $beneficiary_dump->DetailAdd) {
?>
<?php include_once "beneficiary_dumpgrid.php" ?>
<?php } ?>
<?php
	if (in_array("alt_beneficiary", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $alt_beneficiary->DetailAdd) {
?>
<?php include_once "alt_beneficiarygrid.php" ?>
<?php } ?>
<?php
	if (in_array("assets_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $assets_tb->DetailAdd) {
?>
<?php include_once "assets_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("overall_asset", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $overall_asset->DetailAdd) {
?>
<?php include_once "overall_assetgrid.php" ?>
<?php } ?>
<?php
	if (in_array("executor_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $executor_tb->DetailAdd) {
?>
<?php include_once "executor_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("trustee_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $trustee_tb->DetailAdd) {
?>
<?php include_once "trustee_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("witness_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $witness_tb->DetailAdd) {
?>
<?php include_once "witness_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("addinfo_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $addinfo_tb->DetailAdd) {
?>
...
<script type="text/javascript">
fpremiumwill_tbadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$premiumwill_tb_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$premiumwill_tb_add->Page_Terminate();
?>
