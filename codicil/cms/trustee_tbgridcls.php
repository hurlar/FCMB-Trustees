...
$trustee_tb_grid = NULL; // Initialize page object first

class ctrustee_tb_grid extends ctrustee_tb {
	...
	// Page object name
	var $PageObjName = 'trustee_tb_grid';

	// Grid form hidden field names
	var $FormName = 'ftrustee_tbgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["trustee_tb"];
