...
$investmenttrust_tb = NULL;

//
// Table class for investmenttrust_tb
//
class cinvestmenttrust_tb extends cTable {
	var $id;
	var $uid;
	var $fullname;
	var $address;
	...
	function __construct() {
		...
		$this->TableVar = 'investmenttrust_tb';
		$this->TableName = 'investmenttrust_tb';
		...
		// id
		$this->id = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// uid
		$this->uid = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_uid', 'uid', '`uid`', '`uid`', 3, -1, FALSE, '`uid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->uid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['uid'] = &$this->uid;

		// fullname
		$this->fullname = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_fullname', 'fullname', '`fullname`', '`fullname`', 200, -1, FALSE, '`fullname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['fullname'] = &$this->fullname;

		// address
		$this->address = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_address', 'address', '`address`', '`address`', 201, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['address'] = &$this->address;

		// email
		$this->_email = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['email'] = &$this->_email;

		// maidenname
		$this->maidenname = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_maidenname', 'maidenname', '`maidenname`', '`maidenname`', 200, -1, FALSE, '`maidenname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['maidenname'] = &$this->maidenname;

		// phoneno
		$this->phoneno = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_phoneno', 'phoneno', '`phoneno`', '`phoneno`', 200, -1, FALSE, '`phoneno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['phoneno'] = &$this->phoneno;

		// aphoneno
		$this->aphoneno = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_aphoneno', 'aphoneno', '`aphoneno`', '`aphoneno`', 200, -1, FALSE, '`aphoneno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['aphoneno'] = &$this->aphoneno;

		// maritalstatus
		$this->maritalstatus = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_maritalstatus', 'maritalstatus', '`maritalstatus`', '`maritalstatus`', 200, -1, FALSE, '`maritalstatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['maritalstatus'] = &$this->maritalstatus;

		// gender
		$this->gender = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_gender', 'gender', '`gender`', '`gender`', 200, -1, FALSE, '`gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['gender'] = &$this->gender;

		// dob
		$this->dob = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_dob', 'dob', '`dob`', '`dob`', 200, -1, FALSE, '`dob`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['dob'] = &$this->dob;

		// state
		$this->state = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_state', 'state', '`state`', '`state`', 200, -1, FALSE, '`state`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['state'] = &$this->state;

		// nationality
		$this->nationality = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_nationality', 'nationality', '`nationality`', '`nationality`', 200, -1, FALSE, '`nationality`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nationality'] = &$this->nationality;

		// lga
		$this->lga = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_lga', 'lga', '`lga`', '`lga`', 200, -1, FALSE, '`lga`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['lga'] = &$this->lga;

		// employer
		$this->employer = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_employer', 'employer', '`employer`', '`employer`', 201, -1, FALSE, '`employer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['employer'] = &$this->employer;

		// employerphone
		$this->employerphone = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_employerphone', 'employerphone', '`employerphone`', '`employerphone`', 200, -1, FALSE, '`employerphone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['employerphone'] = &$this->employerphone;

		// employeraddr
		$this->employeraddr = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_employeraddr', 'employeraddr', '`employeraddr`', '`employeraddr`', 201, -1, FALSE, '`employeraddr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['employeraddr'] = &$this->employeraddr;

		// idnumber
		$this->idnumber = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_idnumber', 'idnumber', '`idnumber`', '`idnumber`', 200, -1, FALSE, '`idnumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['idnumber'] = &$this->idnumber;

		// issuedate
		$this->issuedate = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_issuedate', 'issuedate', '`issuedate`', '`issuedate`', 200, -1, FALSE, '`issuedate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['issuedate'] = &$this->issuedate;

		// expirydate
		$this->expirydate = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_expirydate', 'expirydate', '`expirydate`', '`expirydate`', 200, -1, FALSE, '`expirydate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['expirydate'] = &$this->expirydate;

		// datecreated
		$this->datecreated = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_datecreated', 'datecreated', '`datecreated`', 'DATE_FORMAT(`datecreated`, \'%d/%m/%y\')', 135, -1, FALSE, '`datecreated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['datecreated'] = &$this->datecreated;

		// willtype
		$this->willtype = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_willtype', 'willtype', '`willtype`', '`willtype`', 200, -1, FALSE, '`willtype`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['willtype'] = &$this->willtype;

		// identificationtype
		$this->identificationtype = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_identificationtype', 'identificationtype', '`identificationtype`', '`identificationtype`', 200, -1, FALSE, '`identificationtype`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['identificationtype'] = &$this->identificationtype;

		// issueplace
		$this->issueplace = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_issueplace', 'issueplace', '`issueplace`', '`issueplace`', 200, -1, FALSE, '`issueplace`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['issueplace'] = &$this->issueplace;

		// employmentstatus
		$this->employmentstatus = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_employmentstatus', 'employmentstatus', '`employmentstatus`', '`employmentstatus`', 200, -1, FALSE, '`employmentstatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['employmentstatus'] = &$this->employmentstatus;

		// spousename
		$this->spousename = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_spousename', 'spousename', '`spousename`', '`spousename`', 200, -1, FALSE, '`spousename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spousename'] = &$this->spousename;

		// spouseemail
		$this->spouseemail = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_spouseemail', 'spouseemail', '`spouseemail`', '`spouseemail`', 200, -1, FALSE, '`spouseemail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spouseemail'] = &$this->spouseemail;

		// spousephone
		$this->spousephone = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_spousephone', 'spousephone', '`spousephone`', '`spousephone`', 200, -1, FALSE, '`spousephone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spousephone'] = &$this->spousephone;

		// spousedob
		$this->spousedob = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_spousedob', 'spousedob', '`spousedob`', '`spousedob`', 200, -1, FALSE, '`spousedob`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spousedob'] = &$this->spousedob;

		// spouseaddr
		$this->spouseaddr = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_spouseaddr', 'spouseaddr', '`spouseaddr`', '`spouseaddr`', 201, -1, FALSE, '`spouseaddr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spouseaddr'] = &$this->spouseaddr;

		// spousecity
		$this->spousecity = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_spousecity', 'spousecity', '`spousecity`', '`spousecity`', 200, -1, FALSE, '`spousecity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spousecity'] = &$this->spousecity;

		// spousestate
		$this->spousestate = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_spousestate', 'spousestate', '`spousestate`', '`spousestate`', 200, -1, FALSE, '`spousestate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spousestate'] = &$this->spousestate;

		// marriagetype
		$this->marriagetype = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_marriagetype', 'marriagetype', '`marriagetype`', '`marriagetype`', 200, -1, FALSE, '`marriagetype`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['marriagetype'] = &$this->marriagetype;

		// marriageyear
		$this->marriageyear = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_marriageyear', 'marriageyear', '`marriageyear`', '`marriageyear`', 200, -1, FALSE, '`marriageyear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['marriageyear'] = &$this->marriageyear;

		// marriagecert
		$this->marriagecert = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_marriagecert', 'marriagecert', '`marriagecert`', '`marriagecert`', 200, -1, FALSE, '`marriagecert`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['marriagecert'] = &$this->marriagecert;

		// cityofmarriage
		$this->cityofmarriage = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_cityofmarriage', 'cityofmarriage', '`cityofmarriage`', '`cityofmarriage`', 200, -1, FALSE, '`cityofmarriage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cityofmarriage'] = &$this->cityofmarriage;

		// countryofmarriage
		$this->countryofmarriage = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_countryofmarriage', 'countryofmarriage', '`countryofmarriage`', '`countryofmarriage`', 200, -1, FALSE, '`countryofmarriage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['countryofmarriage'] = &$this->countryofmarriage;

		// divorce
		$this->divorce = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_divorce', 'divorce', '`divorce`', '`divorce`', 200, -1, FALSE, '`divorce`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['divorce'] = &$this->divorce;

		// divorceyear
		$this->divorceyear = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_divorceyear', 'divorceyear', '`divorceyear`', '`divorceyear`', 200, -1, FALSE, '`divorceyear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['divorceyear'] = &$this->divorceyear;

		// nextofkinfullname
		$this->nextofkinfullname = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_nextofkinfullname', 'nextofkinfullname', '`nextofkinfullname`', '`nextofkinfullname`', 200, -1, FALSE, '`nextofkinfullname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nextofkinfullname'] = &$this->nextofkinfullname;

		// nextofkintelephone
		$this->nextofkintelephone = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_nextofkintelephone', 'nextofkintelephone', '`nextofkintelephone`', '`nextofkintelephone`', 200, -1, FALSE, '`nextofkintelephone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nextofkintelephone'] = &$this->nextofkintelephone;

		// nextofkinemail
		$this->nextofkinemail = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_nextofkinemail', 'nextofkinemail', '`nextofkinemail`', '`nextofkinemail`', 200, -1, FALSE, '`nextofkinemail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nextofkinemail'] = &$this->nextofkinemail;

		// nextofkinaddress
		$this->nextofkinaddress = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_nextofkinaddress', 'nextofkinaddress', '`nextofkinaddress`', '`nextofkinaddress`', 201, -1, FALSE, '`nextofkinaddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nextofkinaddress'] = &$this->nextofkinaddress;

		// nameofcompany
		$this->nameofcompany = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_nameofcompany', 'nameofcompany', '`nameofcompany`', '`nameofcompany`', 200, -1, FALSE, '`nameofcompany`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nameofcompany'] = &$this->nameofcompany;

		// humanresourcescontacttelephone
		$this->humanresourcescontacttelephone = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_humanresourcescontacttelephone', 'humanresourcescontacttelephone', '`humanresourcescontacttelephone`', '`humanresourcescontacttelephone`', 200, -1, FALSE, '`humanresourcescontacttelephone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['humanresourcescontacttelephone'] = &$this->humanresourcescontacttelephone;

		// humanresourcescontactemailaddress
		$this->humanresourcescontactemailaddress = new cField('investmenttrust_tb', 'investmenttrust_tb', 'x_humanresourcescontactemailaddress', 'humanresourcescontactemailaddress', '`humanresourcescontactemailaddress`', '`humanresourcescontactemailaddress`', 200, -1, FALSE, '`humanresourcescontactemailaddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`investmenttrust_tb`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "investmenttrust_tblist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("investmenttrust_tbview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("investmenttrust_tbview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "investmenttrust_tbadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("investmenttrust_tbedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("investmenttrust_tbadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("investmenttrust_tbdelete.php", $this->UrlParm());
	}
