...
$premiumwill_tb_delete = NULL; // Initialize page object first

class cpremiumwill_tb_delete extends cpremiumwill_tb {
	...
	// Page object name
	var $PageObjName = 'premiumwill_tb_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("premiumwill_tblist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in premiumwill_tb class, premiumwill_tbinfo.php
...
// Create page object
if (!isset($premiumwill_tb_delete)) $premiumwill_tb_delete = new cpremiumwill_tb_delete();

// Page init
$premiumwill_tb_delete->Page_Init();

// Page main
$premiumwill_tb_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$premiumwill_tb_delete->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var premiumwill_tb_delete = new ew_Page("premiumwill_tb_delete");
premiumwill_tb_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = premiumwill_tb_delete.PageID; // For backward compatibility

// Form object
var fpremiumwill_tbdelete = new ew_Form("fpremiumwill_tbdelete");

// Form_CustomValidate event
fpremiumwill_tbdelete.Form_CustomValidate = 
...
fpremiumwill_tbdelete.ValidateRequired = true;
<?php } else { ?>
fpremiumwill_tbdelete.ValidateRequired = false; 
<?php } ?>
...
if ($premiumwill_tb_delete->Recordset = $premiumwill_tb_delete->LoadRecordset())
	$premiumwill_tb_deleteTotalRecs = $premiumwill_tb_delete->Recordset->RecordCount(); // Get record count
if ($premiumwill_tb_deleteTotalRecs <= 0) { // No record found, exit
	if ($premiumwill_tb_delete->Recordset)
		$premiumwill_tb_delete->Recordset->Close();
	$premiumwill_tb_delete->Page_Terminate("premiumwill_tblist.php"); // Return to list
}
?>
<?php $Breadcrumb->Render(); ?>
<?php $premiumwill_tb_delete->ShowPageHeader(); ?>
<?php
$premiumwill_tb_delete->ShowMessage();
?>
<form name="fpremiumwill_tbdelete" id="fpremiumwill_tbdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="premiumwill_tb">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($premiumwill_tb_delete->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_premiumwill_tbdelete" class="ewTable ewTableSeparate">
<?php echo $premiumwill_tb->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($premiumwill_tb->willtype->Visible) { // willtype ?>
		<td><span id="elh_premiumwill_tb_willtype" class="premiumwill_tb_willtype"><?php echo $premiumwill_tb->willtype->FldCaption() ?></span></td>
<?php } ?>
<?php if ($premiumwill_tb->fullname->Visible) { // fullname ?>
		<td><span id="elh_premiumwill_tb_fullname" class="premiumwill_tb_fullname"><?php echo $premiumwill_tb->fullname->FldCaption() ?></span></td>
<?php } ?>
<?php if ($premiumwill_tb->_email->Visible) { // email ?>
		<td><span id="elh_premiumwill_tb__email" class="premiumwill_tb__email"><?php echo $premiumwill_tb->_email->FldCaption() ?></span></td>
<?php } ?>
<?php if ($premiumwill_tb->phoneno->Visible) { // phoneno ?>
		<td><span id="elh_premiumwill_tb_phoneno" class="premiumwill_tb_phoneno"><?php echo $premiumwill_tb->phoneno->FldCaption() ?></span></td>
<?php } ?>
<?php if ($premiumwill_tb->aphoneno->Visible) { // aphoneno ?>
		<td><span id="elh_premiumwill_tb_aphoneno" class="premiumwill_tb_aphoneno"><?php echo $premiumwill_tb->aphoneno->FldCaption() ?></span></td>
<?php } ?>
<?php if ($premiumwill_tb->gender->Visible) { // gender ?>
		<td><span id="elh_premiumwill_tb_gender" class="premiumwill_tb_gender"><?php echo $premiumwill_tb->gender->FldCaption() ?></span></td>
<?php } ?>
<?php if ($premiumwill_tb->dob->Visible) { // dob ?>
		<td><span id="elh_premiumwill_tb_dob" class="premiumwill_tb_dob"><?php echo $premiumwill_tb->dob->FldCaption() ?></span></td>
<?php } ?>
<?php if ($premiumwill_tb->state->Visible) { // state ?>
		<td><span id="elh_premiumwill_tb_state" class="premiumwill_tb_state"><?php echo $premiumwill_tb->state->FldCaption() ?></span></td>
<?php } ?>
<?php if ($premiumwill_tb->employmentstatus->Visible) { // employmentstatus ?>
		<td><span id="elh_premiumwill_tb_employmentstatus" class="premiumwill_tb_employmentstatus"><?php echo $premiumwill_tb->employmentstatus->FldCaption() ?></span></td>
<?php } ?>
<?php if ($premiumwill_tb->maritalstatus->Visible) { // maritalstatus ?>
		<td><span id="elh_premiumwill_tb_maritalstatus" class="premiumwill_tb_maritalstatus"><?php echo $premiumwill_tb->maritalstatus->FldCaption() ?></span></td>
<?php } ?>
<?php if ($premiumwill_tb->datecreated->Visible) { // datecreated ?>
		<td><span id="elh_premiumwill_tb_datecreated" class="premiumwill_tb_datecreated"><?php echo $premiumwill_tb->datecreated->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$premiumwill_tb_delete->RecCnt = 0;
$i = 0;
while (!$premiumwill_tb_delete->Recordset->EOF) {
	$premiumwill_tb_delete->RecCnt++;
	$premiumwill_tb_delete->RowCnt++;

	// Set row properties
	$premiumwill_tb->ResetAttrs();
	$premiumwill_tb->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$premiumwill_tb_delete->LoadRowValues($premiumwill_tb_delete->Recordset);

	// Render row
	$premiumwill_tb_delete->RenderRow();
?>
	<tr<?php echo $premiumwill_tb->RowAttributes() ?>>
<?php if ($premiumwill_tb->willtype->Visible) { // willtype ?>
		<td<?php echo $premiumwill_tb->willtype->CellAttributes() ?>>
<span id="el<?php echo $premiumwill_tb_delete->RowCnt ?>_premiumwill_tb_willtype" class="control-group premiumwill_tb_willtype">
...
<span id="el<?php echo $premiumwill_tb_delete->RowCnt ?>_premiumwill_tb_fullname" class="control-group premiumwill_tb_fullname">
...
<span id="el<?php echo $premiumwill_tb_delete->RowCnt ?>_premiumwill_tb__email" class="control-group premiumwill_tb__email">
...
<span id="el<?php echo $premiumwill_tb_delete->RowCnt ?>_premiumwill_tb_phoneno" class="control-group premiumwill_tb_phoneno">
...
<span id="el<?php echo $premiumwill_tb_delete->RowCnt ?>_premiumwill_tb_aphoneno" class="control-group premiumwill_tb_aphoneno">
...
<span id="el<?php echo $premiumwill_tb_delete->RowCnt ?>_premiumwill_tb_gender" class="control-group premiumwill_tb_gender">
...
<span id="el<?php echo $premiumwill_tb_delete->RowCnt ?>_premiumwill_tb_dob" class="control-group premiumwill_tb_dob">
...
<span id="el<?php echo $premiumwill_tb_delete->RowCnt ?>_premiumwill_tb_state" class="control-group premiumwill_tb_state">
...
<span id="el<?php echo $premiumwill_tb_delete->RowCnt ?>_premiumwill_tb_employmentstatus" class="control-group premiumwill_tb_employmentstatus">
...
<span id="el<?php echo $premiumwill_tb_delete->RowCnt ?>_premiumwill_tb_maritalstatus" class="control-group premiumwill_tb_maritalstatus">
...
<span id="el<?php echo $premiumwill_tb_delete->RowCnt ?>_premiumwill_tb_datecreated" class="control-group premiumwill_tb_datecreated">
...
<?php
	$premiumwill_tb_delete->Recordset->MoveNext();
}
$premiumwill_tb_delete->Recordset->Close();
?>
</tbody>
...
<script type="text/javascript">
fpremiumwill_tbdelete.Init();
</script>
<?php
$premiumwill_tb_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$premiumwill_tb_delete->Page_Terminate();
?>
