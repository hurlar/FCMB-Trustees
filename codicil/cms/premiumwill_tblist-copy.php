...
$premiumwill_tb_list = NULL; // Initialize page object first

class cpremiumwill_tb_list extends cpremiumwill_tb {
	...
	// Page object name
	var $PageObjName = 'premiumwill_tb_list';

	// Grid form hidden field names
	var $FormName = 'fpremiumwill_tblist';
	...
	function __construct() {
		...
		$this->AddUrl = "premiumwill_tbadd.php?" . EW_TABLE_SHOW_DETAIL . "=";
		$this->InlineAddUrl = $this->PageUrl() . "a=add";
		$this->GridAddUrl = $this->PageUrl() . "a=gridadd";
		$this->GridEditUrl = $this->PageUrl() . "a=gridedit";
		$this->MultiDeleteUrl = "premiumwill_tbdelete.php";
		$this->MultiUpdateUrl = "premiumwill_tbupdate.php";
	...
	function RenderListOptions() {
		...
		if ($Security->IsLoggedIn()) {
			...
			$body = "<a class=\"btn btn-small ewRowLink ewDetailList\" data-action=\"list\" href=\"" . ew_HtmlEncode("personal_infolist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
			$links = "";
		...
		if ($Security->IsLoggedIn()) {
			...
			$body = "<a class=\"btn btn-small ewRowLink ewDetailList\" data-action=\"list\" href=\"" . ew_HtmlEncode("spouse_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
			$links = "";
		...
		if ($Security->IsLoggedIn()) {
			...
			$body = "<a class=\"btn btn-small ewRowLink ewDetailList\" data-action=\"list\" href=\"" . ew_HtmlEncode("divorce_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
			$links = "";
		...
		if ($Security->IsLoggedIn()) {
			...
			$body = "<a class=\"btn btn-small ewRowLink ewDetailList\" data-action=\"list\" href=\"" . ew_HtmlEncode("children_detailslist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
			$links = "";
		...
		if ($Security->IsLoggedIn()) {
			...
			$body = "<a class=\"btn btn-small ewRowLink ewDetailList\" data-action=\"list\" href=\"" . ew_HtmlEncode("beneficiary_dumplist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
			$links = "";
		...
		if ($Security->IsLoggedIn()) {
			...
			$body = "<a class=\"btn btn-small ewRowLink ewDetailList\" data-action=\"list\" href=\"" . ew_HtmlEncode("alt_beneficiarylist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
			$links = "";
		...
		if ($Security->IsLoggedIn()) {
			...
			$body = "<a class=\"btn btn-small ewRowLink ewDetailList\" data-action=\"list\" href=\"" . ew_HtmlEncode("assets_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
			$links = "";
		...
		if ($Security->IsLoggedIn()) {
			...
			$body = "<a class=\"btn btn-small ewRowLink ewDetailList\" data-action=\"list\" href=\"" . ew_HtmlEncode("overall_assetlist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
			$links = "";
		...
		if ($Security->IsLoggedIn()) {
			...
			$body = "<a class=\"btn btn-small ewRowLink ewDetailList\" data-action=\"list\" href=\"" . ew_HtmlEncode("executor_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
			$links = "";
		...
		if ($Security->IsLoggedIn()) {
			...
			$body = "<a class=\"btn btn-small ewRowLink ewDetailList\" data-action=\"list\" href=\"" . ew_HtmlEncode("trustee_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
			$links = "";
		...
		if ($Security->IsLoggedIn()) {
			...
			$body = "<a class=\"btn btn-small ewRowLink ewDetailList\" data-action=\"list\" href=\"" . ew_HtmlEncode("witness_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
			$links = "";
		...
		if ($Security->IsLoggedIn()) {
			...
			$body = "<a class=\"btn btn-small ewRowLink ewDetailList\" data-action=\"list\" href=\"" . ew_HtmlEncode("addinfo_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
			$links = "";
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" href=\"\" onclick=\"ew_SubmitSelected(document.fpremiumwill_tblist, '" . $this->MultiDeleteUrl . "', ewLanguage.Phrase('DeleteMultiConfirmMsg'));return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->IsLoggedIn());
	...
	function RenderOtherOptions() {
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->CustomActions as $action => $name) {
				...
				$item->Body = "<a class=\"ewAction ewCustomAction\" href=\"\" onclick=\"ew_SubmitSelected(document.fpremiumwill_tblist, '" . ew_CurrentUrl() . "', null, '" . $action . "');return false;\">" . $name . "</a>";
			}
	...
	function RenderListOptionsExt() {
		...
		if ($Security->IsLoggedIn()) {			
			...
			$links .= $link;
			$detaillnk = ew_JsEncode3("personal_infolist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . urlencode(strval($this->uid->CurrentValue)) . "");
		...
		if ($Security->IsLoggedIn()) {			
			...
			$links .= $link;
			$detaillnk = ew_JsEncode3("spouse_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . urlencode(strval($this->uid->CurrentValue)) . "");
		...
		if ($Security->IsLoggedIn()) {			
			...
			$links .= $link;
			$detaillnk = ew_JsEncode3("divorce_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . urlencode(strval($this->uid->CurrentValue)) . "");
		...
		if ($Security->IsLoggedIn()) {			
			...
			$links .= $link;
			$detaillnk = ew_JsEncode3("children_detailslist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . urlencode(strval($this->uid->CurrentValue)) . "");
		...
		if ($Security->IsLoggedIn()) {			
			...
			$links .= $link;
			$detaillnk = ew_JsEncode3("beneficiary_dumplist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . urlencode(strval($this->uid->CurrentValue)) . "");
		...
		if ($Security->IsLoggedIn()) {			
			...
			$links .= $link;
			$detaillnk = ew_JsEncode3("alt_beneficiarylist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . urlencode(strval($this->uid->CurrentValue)) . "");
		...
		if ($Security->IsLoggedIn()) {			
			...
			$links .= $link;
			$detaillnk = ew_JsEncode3("assets_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . urlencode(strval($this->uid->CurrentValue)) . "");
		...
		if ($Security->IsLoggedIn()) {			
			...
			$links .= $link;
			$detaillnk = ew_JsEncode3("overall_assetlist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . urlencode(strval($this->uid->CurrentValue)) . "");
		...
		if ($Security->IsLoggedIn()) {			
			...
			$links .= $link;
			$detaillnk = ew_JsEncode3("executor_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . urlencode(strval($this->uid->CurrentValue)) . "");
		...
		if ($Security->IsLoggedIn()) {			
			...
			$links .= $link;
			$detaillnk = ew_JsEncode3("trustee_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . urlencode(strval($this->uid->CurrentValue)) . "");
		...
		if ($Security->IsLoggedIn()) {			
			...
			$links .= $link;
			$detaillnk = ew_JsEncode3("witness_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . urlencode(strval($this->uid->CurrentValue)) . "");
		...
		if ($Security->IsLoggedIn()) {			
			...
			$links .= $link;
			$detaillnk = ew_JsEncode3("addinfo_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . urlencode(strval($this->uid->CurrentValue)) . "");
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			if (!ew_Empty($this->uid->CurrentValue)) {
				$this->fullname->HrefValue = "http://tisvdigital.com/trustees/portal/adminpremiumwill-preview.php?a=" . ((!empty($this->uid->ViewValue)) ? $this->uid->ViewValue : $this->uid->CurrentValue); // Add prefix/suffix
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_premiumwill_tb\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_premiumwill_tb',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fpremiumwill_tblist,sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($premiumwill_tb_list)) $premiumwill_tb_list = new cpremiumwill_tb_list();

// Page init
$premiumwill_tb_list->Page_Init();

// Page main
$premiumwill_tb_list->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$premiumwill_tb_list->Page_Render();
?>
<?php include_once "header.php" ?>
<?php if ($premiumwill_tb->Export == "") { ?>
<script type="text/javascript">

// Page object
var premiumwill_tb_list = new ew_Page("premiumwill_tb_list");
premiumwill_tb_list.PageID = "list"; // Page ID
var EW_PAGE_ID = premiumwill_tb_list.PageID; // For backward compatibility

// Form object
var fpremiumwill_tblist = new ew_Form("fpremiumwill_tblist");
fpremiumwill_tblist.FormKeyCountName = '<?php echo $premiumwill_tb_list->FormKeyCountName ?>';

// Form_CustomValidate event
fpremiumwill_tblist.Form_CustomValidate = 
...
fpremiumwill_tblist.ValidateRequired = true;
<?php } else { ?>
fpremiumwill_tblist.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
// Form object for search

var fpremiumwill_tblistsrch = new ew_Form("fpremiumwill_tblistsrch");
</script>
<style type="text/css">
...
<?php } ?>
<?php if ($premiumwill_tb_list->ExportOptions->Visible()) { ?>
<div class="ewListExportOptions"><?php $premiumwill_tb_list->ExportOptions->Render("body") ?></div>
<?php } ?>
<?php
	$bSelectLimit = EW_SELECT_LIMIT;
	if ($bSelectLimit) {
		$premiumwill_tb_list->TotalRecs = $premiumwill_tb->SelectRecordCount();
	} else {
		if ($premiumwill_tb_list->Recordset = $premiumwill_tb_list->LoadRecordset())
			$premiumwill_tb_list->TotalRecs = $premiumwill_tb_list->Recordset->RecordCount();
	}
	$premiumwill_tb_list->StartRec = 1;
	if ($premiumwill_tb_list->DisplayRecs <= 0 || ($premiumwill_tb->Export <> "" && $premiumwill_tb->ExportAll)) // Display all records
		$premiumwill_tb_list->DisplayRecs = $premiumwill_tb_list->TotalRecs;
	if (!($premiumwill_tb->Export <> "" && $premiumwill_tb->ExportAll))
		$premiumwill_tb_list->SetUpStartRec(); // Set up start record position
	if ($bSelectLimit)
		$premiumwill_tb_list->Recordset = $premiumwill_tb_list->LoadRecordset($premiumwill_tb_list->StartRec-1, $premiumwill_tb_list->DisplayRecs);
$premiumwill_tb_list->RenderOtherOptions();
?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($premiumwill_tb->Export == "" && $premiumwill_tb->CurrentAction == "") { ?>
<form name="fpremiumwill_tblistsrch" id="fpremiumwill_tblistsrch" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>">
<table class="ewSearchTable"><tr><td>
<div class="accordion" id="fpremiumwill_tblistsrch_SearchGroup">
	<div class="accordion-group">
		<div class="accordion-heading">
<a class="accordion-toggle" data-toggle="collapse" data-parent="#fpremiumwill_tblistsrch_SearchGroup" href="#fpremiumwill_tblistsrch_SearchBody"><?php echo $Language->Phrase("Search") ?></a>
		</div>
		<div id="fpremiumwill_tblistsrch_SearchBody" class="accordion-body collapse in">
			<div class="accordion-inner">
<div id="fpremiumwill_tblistsrch_SearchPanel">
...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="input-large" value="<?php echo ew_HtmlEncode($premiumwill_tb_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo $Language->Phrase("Search") ?>">
	<button class="btn btn-primary ewButton" name="btnsubmit" id="btnsubmit" type="submit"><?php echo $Language->Phrase("QuickSearchBtn") ?></button>
	</div>
	</div>
	<div class="btn-group ewButtonGroup">
	<a class="btn ewShowAll" href="<?php echo $premiumwill_tb_list->PageUrl() ?>cmd=reset"><?php echo $Language->Phrase("ShowAll") ?></a>
</div>
<div id="xsr_2" class="ewRow">
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="="<?php if ($premiumwill_tb_list->BasicSearch->getType() == "=") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("ExactPhrase") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="AND"<?php if ($premiumwill_tb_list->BasicSearch->getType() == "AND") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AllWord") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="OR"<?php if ($premiumwill_tb_list->BasicSearch->getType() == "OR") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AnyWord") ?></label>
</div>
</div>
</div>
			</div>
...
<?php } ?>
<?php } ?>
<?php $premiumwill_tb_list->ShowPageHeader(); ?>
<?php
$premiumwill_tb_list->ShowMessage();
?>
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<form name="fpremiumwill_tblist" id="fpremiumwill_tblist" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="premiumwill_tb">
<div id="gmp_premiumwill_tb" class="ewGridMiddlePanel">
<?php if ($premiumwill_tb_list->TotalRecs > 0) { ?>
<table id="tbl_premiumwill_tblist" class="ewTable ewTableSeparate">
<?php echo $premiumwill_tb->TableCustomInnerHtml ?>
<thead><!-- Table header -->
	<tr class="ewTableHeader">
<?php

// Render list options
$premiumwill_tb_list->RenderListOptions();

// Render list options (header, left)
$premiumwill_tb_list->ListOptions->Render("header", "left");
?>
<?php if ($premiumwill_tb->willtype->Visible) { // willtype ?>
	<?php if ($premiumwill_tb->SortUrl($premiumwill_tb->willtype) == "") { ?>
		<td><div id="elh_premiumwill_tb_willtype" class="premiumwill_tb_willtype"><div class="ewTableHeaderCaption"><?php echo $premiumwill_tb->willtype->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $premiumwill_tb->SortUrl($premiumwill_tb->willtype) ?>',2);"><div id="elh_premiumwill_tb_willtype" class="premiumwill_tb_willtype">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $premiumwill_tb->willtype->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($premiumwill_tb->willtype->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($premiumwill_tb->willtype->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($premiumwill_tb->fullname->Visible) { // fullname ?>
	<?php if ($premiumwill_tb->SortUrl($premiumwill_tb->fullname) == "") { ?>
		<td><div id="elh_premiumwill_tb_fullname" class="premiumwill_tb_fullname"><div class="ewTableHeaderCaption"><?php echo $premiumwill_tb->fullname->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $premiumwill_tb->SortUrl($premiumwill_tb->fullname) ?>',2);"><div id="elh_premiumwill_tb_fullname" class="premiumwill_tb_fullname">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $premiumwill_tb->fullname->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($premiumwill_tb->fullname->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($premiumwill_tb->fullname->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($premiumwill_tb->_email->Visible) { // email ?>
	<?php if ($premiumwill_tb->SortUrl($premiumwill_tb->_email) == "") { ?>
		<td><div id="elh_premiumwill_tb__email" class="premiumwill_tb__email"><div class="ewTableHeaderCaption"><?php echo $premiumwill_tb->_email->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $premiumwill_tb->SortUrl($premiumwill_tb->_email) ?>',2);"><div id="elh_premiumwill_tb__email" class="premiumwill_tb__email">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $premiumwill_tb->_email->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($premiumwill_tb->_email->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($premiumwill_tb->_email->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($premiumwill_tb->phoneno->Visible) { // phoneno ?>
	<?php if ($premiumwill_tb->SortUrl($premiumwill_tb->phoneno) == "") { ?>
		<td><div id="elh_premiumwill_tb_phoneno" class="premiumwill_tb_phoneno"><div class="ewTableHeaderCaption"><?php echo $premiumwill_tb->phoneno->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $premiumwill_tb->SortUrl($premiumwill_tb->phoneno) ?>',2);"><div id="elh_premiumwill_tb_phoneno" class="premiumwill_tb_phoneno">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $premiumwill_tb->phoneno->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($premiumwill_tb->phoneno->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($premiumwill_tb->phoneno->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($premiumwill_tb->aphoneno->Visible) { // aphoneno ?>
	<?php if ($premiumwill_tb->SortUrl($premiumwill_tb->aphoneno) == "") { ?>
		<td><div id="elh_premiumwill_tb_aphoneno" class="premiumwill_tb_aphoneno"><div class="ewTableHeaderCaption"><?php echo $premiumwill_tb->aphoneno->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $premiumwill_tb->SortUrl($premiumwill_tb->aphoneno) ?>',2);"><div id="elh_premiumwill_tb_aphoneno" class="premiumwill_tb_aphoneno">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $premiumwill_tb->aphoneno->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($premiumwill_tb->aphoneno->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($premiumwill_tb->aphoneno->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($premiumwill_tb->gender->Visible) { // gender ?>
	<?php if ($premiumwill_tb->SortUrl($premiumwill_tb->gender) == "") { ?>
		<td><div id="elh_premiumwill_tb_gender" class="premiumwill_tb_gender"><div class="ewTableHeaderCaption"><?php echo $premiumwill_tb->gender->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $premiumwill_tb->SortUrl($premiumwill_tb->gender) ?>',2);"><div id="elh_premiumwill_tb_gender" class="premiumwill_tb_gender">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $premiumwill_tb->gender->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($premiumwill_tb->gender->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($premiumwill_tb->gender->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($premiumwill_tb->dob->Visible) { // dob ?>
	<?php if ($premiumwill_tb->SortUrl($premiumwill_tb->dob) == "") { ?>
		<td><div id="elh_premiumwill_tb_dob" class="premiumwill_tb_dob"><div class="ewTableHeaderCaption"><?php echo $premiumwill_tb->dob->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $premiumwill_tb->SortUrl($premiumwill_tb->dob) ?>',2);"><div id="elh_premiumwill_tb_dob" class="premiumwill_tb_dob">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $premiumwill_tb->dob->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($premiumwill_tb->dob->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($premiumwill_tb->dob->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($premiumwill_tb->state->Visible) { // state ?>
	<?php if ($premiumwill_tb->SortUrl($premiumwill_tb->state) == "") { ?>
		<td><div id="elh_premiumwill_tb_state" class="premiumwill_tb_state"><div class="ewTableHeaderCaption"><?php echo $premiumwill_tb->state->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $premiumwill_tb->SortUrl($premiumwill_tb->state) ?>',2);"><div id="elh_premiumwill_tb_state" class="premiumwill_tb_state">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $premiumwill_tb->state->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($premiumwill_tb->state->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($premiumwill_tb->state->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($premiumwill_tb->employmentstatus->Visible) { // employmentstatus ?>
	<?php if ($premiumwill_tb->SortUrl($premiumwill_tb->employmentstatus) == "") { ?>
		<td><div id="elh_premiumwill_tb_employmentstatus" class="premiumwill_tb_employmentstatus"><div class="ewTableHeaderCaption"><?php echo $premiumwill_tb->employmentstatus->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $premiumwill_tb->SortUrl($premiumwill_tb->employmentstatus) ?>',2);"><div id="elh_premiumwill_tb_employmentstatus" class="premiumwill_tb_employmentstatus">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $premiumwill_tb->employmentstatus->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($premiumwill_tb->employmentstatus->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($premiumwill_tb->employmentstatus->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($premiumwill_tb->maritalstatus->Visible) { // maritalstatus ?>
	<?php if ($premiumwill_tb->SortUrl($premiumwill_tb->maritalstatus) == "") { ?>
		<td><div id="elh_premiumwill_tb_maritalstatus" class="premiumwill_tb_maritalstatus"><div class="ewTableHeaderCaption"><?php echo $premiumwill_tb->maritalstatus->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $premiumwill_tb->SortUrl($premiumwill_tb->maritalstatus) ?>',2);"><div id="elh_premiumwill_tb_maritalstatus" class="premiumwill_tb_maritalstatus">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $premiumwill_tb->maritalstatus->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($premiumwill_tb->maritalstatus->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($premiumwill_tb->maritalstatus->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($premiumwill_tb->datecreated->Visible) { // datecreated ?>
	<?php if ($premiumwill_tb->SortUrl($premiumwill_tb->datecreated) == "") { ?>
		<td><div id="elh_premiumwill_tb_datecreated" class="premiumwill_tb_datecreated"><div class="ewTableHeaderCaption"><?php echo $premiumwill_tb->datecreated->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $premiumwill_tb->SortUrl($premiumwill_tb->datecreated) ?>',2);"><div id="elh_premiumwill_tb_datecreated" class="premiumwill_tb_datecreated">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $premiumwill_tb->datecreated->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($premiumwill_tb->datecreated->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($premiumwill_tb->datecreated->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
$premiumwill_tb_list->ListOptions->Render("header", "right");
?>
	</tr>
</thead>
<tbody>
<?php
if ($premiumwill_tb->ExportAll && $premiumwill_tb->Export <> "") {
	$premiumwill_tb_list->StopRec = $premiumwill_tb_list->TotalRecs;
} else {

	// Set the last record to display
	if ($premiumwill_tb_list->TotalRecs > $premiumwill_tb_list->StartRec + $premiumwill_tb_list->DisplayRecs - 1)
		$premiumwill_tb_list->StopRec = $premiumwill_tb_list->StartRec + $premiumwill_tb_list->DisplayRecs - 1;
	else
		$premiumwill_tb_list->StopRec = $premiumwill_tb_list->TotalRecs;
}
$premiumwill_tb_list->RecCnt = $premiumwill_tb_list->StartRec - 1;
if ($premiumwill_tb_list->Recordset && !$premiumwill_tb_list->Recordset->EOF) {
	$premiumwill_tb_list->Recordset->MoveFirst();
	if (!$bSelectLimit && $premiumwill_tb_list->StartRec > 1)
		$premiumwill_tb_list->Recordset->Move($premiumwill_tb_list->StartRec - 1);
} elseif (!$premiumwill_tb->AllowAddDeleteRow && $premiumwill_tb_list->StopRec == 0) {
	$premiumwill_tb_list->StopRec = $premiumwill_tb->GridAddRowCount;
}

// Initialize aggregate
$premiumwill_tb->RowType = EW_ROWTYPE_AGGREGATEINIT;
$premiumwill_tb->ResetAttrs();
$premiumwill_tb_list->RenderRow();
while ($premiumwill_tb_list->RecCnt < $premiumwill_tb_list->StopRec) {
	$premiumwill_tb_list->RecCnt++;
	if (intval($premiumwill_tb_list->RecCnt) >= intval($premiumwill_tb_list->StartRec)) {
		$premiumwill_tb_list->RowCnt++;

		// Set up key count
		$premiumwill_tb_list->KeyCount = $premiumwill_tb_list->RowIndex;

		// Init row class and style
		$premiumwill_tb->ResetAttrs();
		$premiumwill_tb->CssClass = "";
		if ($premiumwill_tb->CurrentAction == "gridadd") {
		} else {
			$premiumwill_tb_list->LoadRowValues($premiumwill_tb_list->Recordset); // Load row values
		}
		$premiumwill_tb->RowType = EW_ROWTYPE_VIEW; // Render view

		// Set up row id / data-rowindex
		$premiumwill_tb->RowAttrs = array_merge($premiumwill_tb->RowAttrs, array('data-rowindex'=>$premiumwill_tb_list->RowCnt, 'id'=>'r' . $premiumwill_tb_list->RowCnt . '_premiumwill_tb', 'data-rowtype'=>$premiumwill_tb->RowType));
		...
		$premiumwill_tb_list->RenderListOptions();
?>
	<tr<?php echo $premiumwill_tb->RowAttributes() ?>>
<?php

// Render list options (body, left)
$premiumwill_tb_list->ListOptions->Render("body", "left", $premiumwill_tb_list->RowCnt);
?>
	<?php if ($premiumwill_tb->willtype->Visible) { // willtype ?>
...
<a id="<?php echo $premiumwill_tb_list->PageObjName . "_row_" . $premiumwill_tb_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($premiumwill_tb->fullname->Visible) { // fullname ?>
...
$premiumwill_tb_list->ListOptions->Render("body", "right", $premiumwill_tb_list->RowCnt);
?>
	</tr>
<?php
	}
	if ($premiumwill_tb->CurrentAction <> "gridadd")
		$premiumwill_tb_list->Recordset->MoveNext();
}
?>
</tbody>
</table>
<?php } ?>
<?php if ($premiumwill_tb->CurrentAction == "") { ?>
...
// Close recordset
if ($premiumwill_tb_list->Recordset)
	$premiumwill_tb_list->Recordset->Close();
?>
<?php if ($premiumwill_tb->Export == "") { ?>
<div class="ewGridLowerPanel">
<?php if ($premiumwill_tb->CurrentAction <> "gridadd" && $premiumwill_tb->CurrentAction <> "gridedit") { ?>
<form name="ewPagerForm" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>">
<table class="ewPager">
<tr><td>
<?php if (!isset($premiumwill_tb_list->Pager)) $premiumwill_tb_list->Pager = new cNumericPager($premiumwill_tb_list->StartRec, $premiumwill_tb_list->DisplayRecs, $premiumwill_tb_list->TotalRecs, $premiumwill_tb_list->RecRange) ?>
<?php if ($premiumwill_tb_list->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($premiumwill_tb_list->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $premiumwill_tb_list->PageUrl() ?>start=<?php echo $premiumwill_tb_list->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($premiumwill_tb_list->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $premiumwill_tb_list->PageUrl() ?>start=<?php echo $premiumwill_tb_list->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($premiumwill_tb_list->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $premiumwill_tb_list->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($premiumwill_tb_list->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $premiumwill_tb_list->PageUrl() ?>start=<?php echo $premiumwill_tb_list->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($premiumwill_tb_list->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $premiumwill_tb_list->PageUrl() ?>start=<?php echo $premiumwill_tb_list->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
<td>
	<?php if ($premiumwill_tb_list->Pager->ButtonCount > 0) { ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
	<?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $premiumwill_tb_list->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $premiumwill_tb_list->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $premiumwill_tb_list->Pager->RecordCount ?>
</td>
</tr></tbody></table>
<?php } else { ?>
	<?php if ($premiumwill_tb_list->SearchWhere == "0=101") { ?>
...
<option value="25"<?php if ($premiumwill_tb_list->DisplayRecs == 25) { ?> selected="selected"<?php } ?>>25</option>
<option value="50"<?php if ($premiumwill_tb_list->DisplayRecs == 50) { ?> selected="selected"<?php } ?>>50</option>
<option value="100"<?php if ($premiumwill_tb_list->DisplayRecs == 100) { ?> selected="selected"<?php } ?>>100</option>
<option value="200"<?php if ($premiumwill_tb_list->DisplayRecs == 200) { ?> selected="selected"<?php } ?>>200</option>
<option value="500"<?php if ($premiumwill_tb_list->DisplayRecs == 500) { ?> selected="selected"<?php } ?>>500</option>
<option value="ALL"<?php if ($premiumwill_tb->getRecordsPerPage() == -1) { ?> selected="selected"<?php } ?>><?php echo $Language->Phrase("AllRecords") ?></option>
</select>
</td>
<?php } ?>
</tr></table>
...
<?php
	foreach ($premiumwill_tb_list->OtherOptions as &$option)
...
<?php if ($premiumwill_tb->Export == "") { ?>
<script type="text/javascript">
fpremiumwill_tblistsrch.Init();
fpremiumwill_tblist.Init();
...
<?php } ?>
<?php
$premiumwill_tb_list->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($premiumwill_tb->Export == "") { ?>
...
<?php
$premiumwill_tb_list->Page_Terminate();
?>
