...
//
// Table class for simplewill_tb
//
class csimplewill_tb extends cTable {
	var $id;
	var $uid;
	var $willtype;
	var $fullname;
	...
	function __construct() {
		...
		$this->TableVar = 'simplewill_tb';
		$this->TableName = 'simplewill_tb';
		...
		// id
		$this->id = new cField('simplewill_tb', 'simplewill_tb', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// uid
		$this->uid = new cField('simplewill_tb', 'simplewill_tb', 'x_uid', 'uid', '`uid`', '`uid`', 3, -1, FALSE, '`uid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->uid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['uid'] = &$this->uid;

		// willtype
		$this->willtype = new cField('simplewill_tb', 'simplewill_tb', 'x_willtype', 'willtype', '`willtype`', '`willtype`', 200, -1, FALSE, '`willtype`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['willtype'] = &$this->willtype;

		// fullname
		$this->fullname = new cField('simplewill_tb', 'simplewill_tb', 'x_fullname', 'fullname', '`fullname`', '`fullname`', 200, -1, FALSE, '`fullname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['fullname'] = &$this->fullname;

		// address
		$this->address = new cField('simplewill_tb', 'simplewill_tb', 'x_address', 'address', '`address`', '`address`', 201, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['address'] = &$this->address;

		// email
		$this->_email = new cField('simplewill_tb', 'simplewill_tb', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['email'] = &$this->_email;

		// phoneno
		$this->phoneno = new cField('simplewill_tb', 'simplewill_tb', 'x_phoneno', 'phoneno', '`phoneno`', '`phoneno`', 200, -1, FALSE, '`phoneno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['phoneno'] = &$this->phoneno;

		// aphoneno
		$this->aphoneno = new cField('simplewill_tb', 'simplewill_tb', 'x_aphoneno', 'aphoneno', '`aphoneno`', '`aphoneno`', 200, -1, FALSE, '`aphoneno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['aphoneno'] = &$this->aphoneno;

		// gender
		$this->gender = new cField('simplewill_tb', 'simplewill_tb', 'x_gender', 'gender', '`gender`', '`gender`', 200, -1, FALSE, '`gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['gender'] = &$this->gender;

		// dob
		$this->dob = new cField('simplewill_tb', 'simplewill_tb', 'x_dob', 'dob', '`dob`', '`dob`', 200, -1, FALSE, '`dob`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['dob'] = &$this->dob;

		// state
		$this->state = new cField('simplewill_tb', 'simplewill_tb', 'x_state', 'state', '`state`', '`state`', 200, -1, FALSE, '`state`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['state'] = &$this->state;

		// nationality
		$this->nationality = new cField('simplewill_tb', 'simplewill_tb', 'x_nationality', 'nationality', '`nationality`', '`nationality`', 200, -1, FALSE, '`nationality`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nationality'] = &$this->nationality;

		// lga
		$this->lga = new cField('simplewill_tb', 'simplewill_tb', 'x_lga', 'lga', '`lga`', '`lga`', 200, -1, FALSE, '`lga`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['lga'] = &$this->lga;

		// maidenname
		$this->maidenname = new cField('simplewill_tb', 'simplewill_tb', 'x_maidenname', 'maidenname', '`maidenname`', '`maidenname`', 200, -1, FALSE, '`maidenname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['maidenname'] = &$this->maidenname;

		// identificationtype
		$this->identificationtype = new cField('simplewill_tb', 'simplewill_tb', 'x_identificationtype', 'identificationtype', '`identificationtype`', '`identificationtype`', 200, -1, FALSE, '`identificationtype`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['identificationtype'] = &$this->identificationtype;

		// idnumber
		$this->idnumber = new cField('simplewill_tb', 'simplewill_tb', 'x_idnumber', 'idnumber', '`idnumber`', '`idnumber`', 200, -1, FALSE, '`idnumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['idnumber'] = &$this->idnumber;

		// issuedate
		$this->issuedate = new cField('simplewill_tb', 'simplewill_tb', 'x_issuedate', 'issuedate', '`issuedate`', '`issuedate`', 200, -1, FALSE, '`issuedate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['issuedate'] = &$this->issuedate;

		// expirydate
		$this->expirydate = new cField('simplewill_tb', 'simplewill_tb', 'x_expirydate', 'expirydate', '`expirydate`', '`expirydate`', 200, -1, FALSE, '`expirydate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['expirydate'] = &$this->expirydate;

		// issueplace
		$this->issueplace = new cField('simplewill_tb', 'simplewill_tb', 'x_issueplace', 'issueplace', '`issueplace`', '`issueplace`', 200, -1, FALSE, '`issueplace`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['issueplace'] = &$this->issueplace;

		// employmentstatus
		$this->employmentstatus = new cField('simplewill_tb', 'simplewill_tb', 'x_employmentstatus', 'employmentstatus', '`employmentstatus`', '`employmentstatus`', 200, -1, FALSE, '`employmentstatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['employmentstatus'] = &$this->employmentstatus;

		// employer
		$this->employer = new cField('simplewill_tb', 'simplewill_tb', 'x_employer', 'employer', '`employer`', '`employer`', 201, -1, FALSE, '`employer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['employer'] = &$this->employer;

		// employerphone
		$this->employerphone = new cField('simplewill_tb', 'simplewill_tb', 'x_employerphone', 'employerphone', '`employerphone`', '`employerphone`', 200, -1, FALSE, '`employerphone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['employerphone'] = &$this->employerphone;

		// employeraddr
		$this->employeraddr = new cField('simplewill_tb', 'simplewill_tb', 'x_employeraddr', 'employeraddr', '`employeraddr`', '`employeraddr`', 201, -1, FALSE, '`employeraddr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['employeraddr'] = &$this->employeraddr;

		// maritalstatus
		$this->maritalstatus = new cField('simplewill_tb', 'simplewill_tb', 'x_maritalstatus', 'maritalstatus', '`maritalstatus`', '`maritalstatus`', 200, -1, FALSE, '`maritalstatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['maritalstatus'] = &$this->maritalstatus;

		// spousename
		$this->spousename = new cField('simplewill_tb', 'simplewill_tb', 'x_spousename', 'spousename', '`spousename`', '`spousename`', 200, -1, FALSE, '`spousename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spousename'] = &$this->spousename;

		// spouseemail
		$this->spouseemail = new cField('simplewill_tb', 'simplewill_tb', 'x_spouseemail', 'spouseemail', '`spouseemail`', '`spouseemail`', 200, -1, FALSE, '`spouseemail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spouseemail'] = &$this->spouseemail;

		// spousephone
		$this->spousephone = new cField('simplewill_tb', 'simplewill_tb', 'x_spousephone', 'spousephone', '`spousephone`', '`spousephone`', 200, -1, FALSE, '`spousephone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spousephone'] = &$this->spousephone;

		// spousedob
		$this->spousedob = new cField('simplewill_tb', 'simplewill_tb', 'x_spousedob', 'spousedob', '`spousedob`', '`spousedob`', 200, -1, FALSE, '`spousedob`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spousedob'] = &$this->spousedob;

		// spouseaddr
		$this->spouseaddr = new cField('simplewill_tb', 'simplewill_tb', 'x_spouseaddr', 'spouseaddr', '`spouseaddr`', '`spouseaddr`', 201, -1, FALSE, '`spouseaddr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spouseaddr'] = &$this->spouseaddr;

		// spousecity
		$this->spousecity = new cField('simplewill_tb', 'simplewill_tb', 'x_spousecity', 'spousecity', '`spousecity`', '`spousecity`', 200, -1, FALSE, '`spousecity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spousecity'] = &$this->spousecity;

		// spousestate
		$this->spousestate = new cField('simplewill_tb', 'simplewill_tb', 'x_spousestate', 'spousestate', '`spousestate`', '`spousestate`', 200, -1, FALSE, '`spousestate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spousestate'] = &$this->spousestate;

		// marriagetype
		$this->marriagetype = new cField('simplewill_tb', 'simplewill_tb', 'x_marriagetype', 'marriagetype', '`marriagetype`', '`marriagetype`', 200, -1, FALSE, '`marriagetype`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['marriagetype'] = &$this->marriagetype;

		// marriageyear
		$this->marriageyear = new cField('simplewill_tb', 'simplewill_tb', 'x_marriageyear', 'marriageyear', '`marriageyear`', '`marriageyear`', 200, -1, FALSE, '`marriageyear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['marriageyear'] = &$this->marriageyear;

		// marriagecert
		$this->marriagecert = new cField('simplewill_tb', 'simplewill_tb', 'x_marriagecert', 'marriagecert', '`marriagecert`', '`marriagecert`', 200, -1, FALSE, '`marriagecert`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['marriagecert'] = &$this->marriagecert;

		// cityofmarriage
		$this->cityofmarriage = new cField('simplewill_tb', 'simplewill_tb', 'x_cityofmarriage', 'cityofmarriage', '`cityofmarriage`', '`cityofmarriage`', 200, -1, FALSE, '`cityofmarriage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cityofmarriage'] = &$this->cityofmarriage;

		// countryofmarriage
		$this->countryofmarriage = new cField('simplewill_tb', 'simplewill_tb', 'x_countryofmarriage', 'countryofmarriage', '`countryofmarriage`', '`countryofmarriage`', 200, -1, FALSE, '`countryofmarriage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['countryofmarriage'] = &$this->countryofmarriage;

		// divorce
		$this->divorce = new cField('simplewill_tb', 'simplewill_tb', 'x_divorce', 'divorce', '`divorce`', '`divorce`', 200, -1, FALSE, '`divorce`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['divorce'] = &$this->divorce;

		// divorceyear
		$this->divorceyear = new cField('simplewill_tb', 'simplewill_tb', 'x_divorceyear', 'divorceyear', '`divorceyear`', '`divorceyear`', 200, -1, FALSE, '`divorceyear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['divorceyear'] = &$this->divorceyear;

		// nextofkinfullname
		$this->nextofkinfullname = new cField('simplewill_tb', 'simplewill_tb', 'x_nextofkinfullname', 'nextofkinfullname', '`nextofkinfullname`', '`nextofkinfullname`', 200, -1, FALSE, '`nextofkinfullname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nextofkinfullname'] = &$this->nextofkinfullname;

		// nextofkintelephone
		$this->nextofkintelephone = new cField('simplewill_tb', 'simplewill_tb', 'x_nextofkintelephone', 'nextofkintelephone', '`nextofkintelephone`', '`nextofkintelephone`', 200, -1, FALSE, '`nextofkintelephone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nextofkintelephone'] = &$this->nextofkintelephone;

		// nextofkinemail
		$this->nextofkinemail = new cField('simplewill_tb', 'simplewill_tb', 'x_nextofkinemail', 'nextofkinemail', '`nextofkinemail`', '`nextofkinemail`', 200, -1, FALSE, '`nextofkinemail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nextofkinemail'] = &$this->nextofkinemail;

		// nextofkinaddress
		$this->nextofkinaddress = new cField('simplewill_tb', 'simplewill_tb', 'x_nextofkinaddress', 'nextofkinaddress', '`nextofkinaddress`', '`nextofkinaddress`', 201, -1, FALSE, '`nextofkinaddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nextofkinaddress'] = &$this->nextofkinaddress;

		// nameofcompany
		$this->nameofcompany = new cField('simplewill_tb', 'simplewill_tb', 'x_nameofcompany', 'nameofcompany', '`nameofcompany`', '`nameofcompany`', 200, -1, FALSE, '`nameofcompany`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nameofcompany'] = &$this->nameofcompany;

		// humanresourcescontacttelephone
		$this->humanresourcescontacttelephone = new cField('simplewill_tb', 'simplewill_tb', 'x_humanresourcescontacttelephone', 'humanresourcescontacttelephone', '`humanresourcescontacttelephone`', '`humanresourcescontacttelephone`', 200, -1, FALSE, '`humanresourcescontacttelephone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['humanresourcescontacttelephone'] = &$this->humanresourcescontacttelephone;

		// humanresourcescontactemailaddress
		$this->humanresourcescontactemailaddress = new cField('simplewill_tb', 'simplewill_tb', 'x_humanresourcescontactemailaddress', 'humanresourcescontactemailaddress', '`humanresourcescontactemailaddress`', '`humanresourcescontactemailaddress`', 200, -1, FALSE, '`humanresourcescontactemailaddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['humanresourcescontactemailaddress'] = &$this->humanresourcescontactemailaddress;

		// datecreated
		$this->datecreated = new cField('simplewill_tb', 'simplewill_tb', 'x_datecreated', 'datecreated', '`datecreated`', 'DATE_FORMAT(`datecreated`, \'%d/%m/%y\')', 135, -1, FALSE, '`datecreated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "simplewill_assets_tb") {
			$sDetailUrl = $GLOBALS["simplewill_assets_tb"]->GetListUrl() . "?showmaster=" . $this->TableVar;
		...
		if ($sDetailUrl == "") {
			$sDetailUrl = "simplewill_tblist.php";
		}
		return $sDetailUrl;
	}
	...
	function Update(&$rs, $where = "", $rsold = NULL) {
		...
		if (!is_null($rsold) && (isset($rs['uid']) && $rsold['uid'] <> $rs['uid'])) {
			...
			$GLOBALS["simplewill_assets_tb"]->Update($rscascade, "`uid` = " . ew_QuotedValue($rsold['uid'], EW_DATATYPE_NUMBER));
		}
	...
	function Delete(&$rs, $where = "") {
		...
		// Cascade delete detail table 'simplewill_assets_tb'
		if (!isset($GLOBALS["simplewill_assets_tb"])) $GLOBALS["simplewill_assets_tb"] = new csimplewill_assets_tb();
		$rscascade = array();
		$GLOBALS["simplewill_assets_tb"]->Delete($rscascade, "`uid` = " . ew_QuotedValue($rs['uid'], EW_DATATYPE_NUMBER));
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("simplewill_tbview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("simplewill_tbview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "simplewill_tbadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("simplewill_tbedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("simplewill_tbedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("simplewill_tbadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("simplewill_tbadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("simplewill_tbdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
		...
		if (!ew_Empty($this->uid->CurrentValue)) {
			$this->fullname->HrefValue = "../portal/adminsimplewill-preview.php?a=" . ((!empty($this->uid->ViewValue)) ? $this->uid->ViewValue : $this->uid->CurrentValue); // Add prefix/suffix
