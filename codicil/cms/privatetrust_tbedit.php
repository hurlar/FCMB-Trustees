...
$privatetrust_tb_edit = NULL; // Initialize page object first

class cprivatetrust_tb_edit extends cprivatetrust_tb {
	...
	// Page object name
	var $PageObjName = 'privatetrust_tb_edit';
		...
		switch ($this->CurrentAction) {
			...
			Case "U": // Update
				...
				if ($this->EditRow()) { // Update record based on key
					...
					if (ew_GetPageName($sReturnUrl) == "privatetrust_tbview.php")
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			// fullname
			if (!ew_Empty($this->uid->CurrentValue)) {
				$this->fullname->HrefValue = "http://tisvdigital.com/trustees/portal/adminprivatetrust-preview.php?a=" . ((!empty($this->uid->EditValue)) ? $this->uid->EditValue : $this->uid->CurrentValue); // Add prefix/suffix
				$this->fullname->LinkAttrs["target"] = "_blank"; // Add target
				if ($this->Export <> "") $this->fullname->HrefValue = ew_ConvertFullUrl($this->fullname->HrefValue);
			} else {
				$this->fullname->HrefValue = "";
...
// Create page object
if (!isset($privatetrust_tb_edit)) $privatetrust_tb_edit = new cprivatetrust_tb_edit();

// Page init
$privatetrust_tb_edit->Page_Init();

// Page main
$privatetrust_tb_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$privatetrust_tb_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var privatetrust_tb_edit = new ew_Page("privatetrust_tb_edit");
privatetrust_tb_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = privatetrust_tb_edit.PageID; // For backward compatibility

// Form object
var fprivatetrust_tbedit = new ew_Form("fprivatetrust_tbedit");

// Validate form
fprivatetrust_tbedit.Validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($privatetrust_tb->uid->FldErrMsg()) ?>");
...
fprivatetrust_tbedit.Form_CustomValidate = 
...
fprivatetrust_tbedit.ValidateRequired = true;
<?php } else { ?>
fprivatetrust_tbedit.ValidateRequired = false; 
<?php } ?>
...
<?php $privatetrust_tb_edit->ShowPageHeader(); ?>
<?php
$privatetrust_tb_edit->ShowMessage();
?>
<form name="fprivatetrust_tbedit" id="fprivatetrust_tbedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="privatetrust_tb">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_privatetrust_tbedit" class="table table-bordered table-striped">
...
<?php echo $privatetrust_tb->id->EditValue ?></span>
</span>
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($privatetrust_tb->id->CurrentValue) ?>">
<?php echo $privatetrust_tb->id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_uid" name="x_uid" id="x_uid" size="30" placeholder="<?php echo $privatetrust_tb->uid->PlaceHolder ?>" value="<?php echo $privatetrust_tb->uid->EditValue ?>"<?php echo $privatetrust_tb->uid->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->uid->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_willtype" name="x_willtype" id="x_willtype" size="30" maxlength="100" placeholder="<?php echo $privatetrust_tb->willtype->PlaceHolder ?>" value="<?php echo $privatetrust_tb->willtype->EditValue ?>"<?php echo $privatetrust_tb->willtype->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->willtype->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_fullname" name="x_fullname" id="x_fullname" size="30" maxlength="100" placeholder="<?php echo $privatetrust_tb->fullname->PlaceHolder ?>" value="<?php echo $privatetrust_tb->fullname->EditValue ?>"<?php echo $privatetrust_tb->fullname->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->fullname->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<textarea data-field="x_address" name="x_address" id="x_address" cols="35" rows="4" placeholder="<?php echo $privatetrust_tb->address->PlaceHolder ?>"<?php echo $privatetrust_tb->address->EditAttributes() ?>><?php echo $privatetrust_tb->address->EditValue ?></textarea>
</span>
<?php echo $privatetrust_tb->address->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x__email" name="x__email" id="x__email" size="30" maxlength="50" placeholder="<?php echo $privatetrust_tb->_email->PlaceHolder ?>" value="<?php echo $privatetrust_tb->_email->EditValue ?>"<?php echo $privatetrust_tb->_email->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->_email->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_phoneno" name="x_phoneno" id="x_phoneno" size="30" maxlength="20" placeholder="<?php echo $privatetrust_tb->phoneno->PlaceHolder ?>" value="<?php echo $privatetrust_tb->phoneno->EditValue ?>"<?php echo $privatetrust_tb->phoneno->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->phoneno->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_aphoneno" name="x_aphoneno" id="x_aphoneno" size="30" maxlength="20" placeholder="<?php echo $privatetrust_tb->aphoneno->PlaceHolder ?>" value="<?php echo $privatetrust_tb->aphoneno->EditValue ?>"<?php echo $privatetrust_tb->aphoneno->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->aphoneno->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_gender" name="x_gender" id="x_gender" size="30" maxlength="10" placeholder="<?php echo $privatetrust_tb->gender->PlaceHolder ?>" value="<?php echo $privatetrust_tb->gender->EditValue ?>"<?php echo $privatetrust_tb->gender->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->gender->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_dob" name="x_dob" id="x_dob" size="30" maxlength="20" placeholder="<?php echo $privatetrust_tb->dob->PlaceHolder ?>" value="<?php echo $privatetrust_tb->dob->EditValue ?>"<?php echo $privatetrust_tb->dob->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->dob->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_state" name="x_state" id="x_state" size="30" maxlength="20" placeholder="<?php echo $privatetrust_tb->state->PlaceHolder ?>" value="<?php echo $privatetrust_tb->state->EditValue ?>"<?php echo $privatetrust_tb->state->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->state->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_nationality" name="x_nationality" id="x_nationality" size="30" maxlength="20" placeholder="<?php echo $privatetrust_tb->nationality->PlaceHolder ?>" value="<?php echo $privatetrust_tb->nationality->EditValue ?>"<?php echo $privatetrust_tb->nationality->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->nationality->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_lga" name="x_lga" id="x_lga" size="30" maxlength="50" placeholder="<?php echo $privatetrust_tb->lga->PlaceHolder ?>" value="<?php echo $privatetrust_tb->lga->EditValue ?>"<?php echo $privatetrust_tb->lga->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->lga->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_employmentstatus" name="x_employmentstatus" id="x_employmentstatus" size="30" maxlength="50" placeholder="<?php echo $privatetrust_tb->employmentstatus->PlaceHolder ?>" value="<?php echo $privatetrust_tb->employmentstatus->EditValue ?>"<?php echo $privatetrust_tb->employmentstatus->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->employmentstatus->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<textarea data-field="x_employer" name="x_employer" id="x_employer" cols="35" rows="4" placeholder="<?php echo $privatetrust_tb->employer->PlaceHolder ?>"<?php echo $privatetrust_tb->employer->EditAttributes() ?>><?php echo $privatetrust_tb->employer->EditValue ?></textarea>
</span>
<?php echo $privatetrust_tb->employer->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_employerphone" name="x_employerphone" id="x_employerphone" size="30" maxlength="50" placeholder="<?php echo $privatetrust_tb->employerphone->PlaceHolder ?>" value="<?php echo $privatetrust_tb->employerphone->EditValue ?>"<?php echo $privatetrust_tb->employerphone->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->employerphone->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<textarea data-field="x_employeraddr" name="x_employeraddr" id="x_employeraddr" cols="35" rows="4" placeholder="<?php echo $privatetrust_tb->employeraddr->PlaceHolder ?>"<?php echo $privatetrust_tb->employeraddr->EditAttributes() ?>><?php echo $privatetrust_tb->employeraddr->EditValue ?></textarea>
</span>
<?php echo $privatetrust_tb->employeraddr->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_maritalstatus" name="x_maritalstatus" id="x_maritalstatus" size="30" maxlength="50" placeholder="<?php echo $privatetrust_tb->maritalstatus->PlaceHolder ?>" value="<?php echo $privatetrust_tb->maritalstatus->EditValue ?>"<?php echo $privatetrust_tb->maritalstatus->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->maritalstatus->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_spname" name="x_spname" id="x_spname" size="30" maxlength="50" placeholder="<?php echo $privatetrust_tb->spname->PlaceHolder ?>" value="<?php echo $privatetrust_tb->spname->EditValue ?>"<?php echo $privatetrust_tb->spname->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->spname->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_spemail" name="x_spemail" id="x_spemail" size="30" maxlength="50" placeholder="<?php echo $privatetrust_tb->spemail->PlaceHolder ?>" value="<?php echo $privatetrust_tb->spemail->EditValue ?>"<?php echo $privatetrust_tb->spemail->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->spemail->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_spphone" name="x_spphone" id="x_spphone" size="30" maxlength="20" placeholder="<?php echo $privatetrust_tb->spphone->PlaceHolder ?>" value="<?php echo $privatetrust_tb->spphone->EditValue ?>"<?php echo $privatetrust_tb->spphone->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->spphone->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_sdob" name="x_sdob" id="x_sdob" size="30" maxlength="10" placeholder="<?php echo $privatetrust_tb->sdob->PlaceHolder ?>" value="<?php echo $privatetrust_tb->sdob->EditValue ?>"<?php echo $privatetrust_tb->sdob->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->sdob->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<textarea data-field="x_spaddr" name="x_spaddr" id="x_spaddr" cols="35" rows="4" placeholder="<?php echo $privatetrust_tb->spaddr->PlaceHolder ?>"<?php echo $privatetrust_tb->spaddr->EditAttributes() ?>><?php echo $privatetrust_tb->spaddr->EditValue ?></textarea>
</span>
<?php echo $privatetrust_tb->spaddr->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_spcity" name="x_spcity" id="x_spcity" size="30" maxlength="50" placeholder="<?php echo $privatetrust_tb->spcity->PlaceHolder ?>" value="<?php echo $privatetrust_tb->spcity->EditValue ?>"<?php echo $privatetrust_tb->spcity->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->spcity->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_spstate" name="x_spstate" id="x_spstate" size="30" maxlength="50" placeholder="<?php echo $privatetrust_tb->spstate->PlaceHolder ?>" value="<?php echo $privatetrust_tb->spstate->EditValue ?>"<?php echo $privatetrust_tb->spstate->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->spstate->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_marriagetype" name="x_marriagetype" id="x_marriagetype" size="30" maxlength="20" placeholder="<?php echo $privatetrust_tb->marriagetype->PlaceHolder ?>" value="<?php echo $privatetrust_tb->marriagetype->EditValue ?>"<?php echo $privatetrust_tb->marriagetype->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->marriagetype->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_marriageyear" name="x_marriageyear" id="x_marriageyear" size="30" maxlength="10" placeholder="<?php echo $privatetrust_tb->marriageyear->PlaceHolder ?>" value="<?php echo $privatetrust_tb->marriageyear->EditValue ?>"<?php echo $privatetrust_tb->marriageyear->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->marriageyear->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_marriagecert" name="x_marriagecert" id="x_marriagecert" size="30" maxlength="50" placeholder="<?php echo $privatetrust_tb->marriagecert->PlaceHolder ?>" value="<?php echo $privatetrust_tb->marriagecert->EditValue ?>"<?php echo $privatetrust_tb->marriagecert->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->marriagecert->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_marriagecity" name="x_marriagecity" id="x_marriagecity" size="30" maxlength="50" placeholder="<?php echo $privatetrust_tb->marriagecity->PlaceHolder ?>" value="<?php echo $privatetrust_tb->marriagecity->EditValue ?>"<?php echo $privatetrust_tb->marriagecity->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->marriagecity->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_marriagecountry" name="x_marriagecountry" id="x_marriagecountry" size="30" maxlength="50" placeholder="<?php echo $privatetrust_tb->marriagecountry->PlaceHolder ?>" value="<?php echo $privatetrust_tb->marriagecountry->EditValue ?>"<?php echo $privatetrust_tb->marriagecountry->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->marriagecountry->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_divorce" name="x_divorce" id="x_divorce" size="30" maxlength="10" placeholder="<?php echo $privatetrust_tb->divorce->PlaceHolder ?>" value="<?php echo $privatetrust_tb->divorce->EditValue ?>"<?php echo $privatetrust_tb->divorce->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->divorce->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_divorceyear" name="x_divorceyear" id="x_divorceyear" size="30" maxlength="10" placeholder="<?php echo $privatetrust_tb->divorceyear->PlaceHolder ?>" value="<?php echo $privatetrust_tb->divorceyear->EditValue ?>"<?php echo $privatetrust_tb->divorceyear->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->divorceyear->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<textarea data-field="x_addinfo" name="x_addinfo" id="x_addinfo" cols="35" rows="4" placeholder="<?php echo $privatetrust_tb->addinfo->PlaceHolder ?>"<?php echo $privatetrust_tb->addinfo->EditAttributes() ?>><?php echo $privatetrust_tb->addinfo->EditValue ?></textarea>
</span>
<?php echo $privatetrust_tb->addinfo->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="text" data-field="x_datecreated" name="x_datecreated" id="x_datecreated" placeholder="<?php echo $privatetrust_tb->datecreated->PlaceHolder ?>" value="<?php echo $privatetrust_tb->datecreated->EditValue ?>"<?php echo $privatetrust_tb->datecreated->EditAttributes() ?>>
</span>
<?php echo $privatetrust_tb->datecreated->CustomMsg ?></td>
	</tr>
<?php } ?>
</table>
</td></tr></table>
<table class="ewPager">
<tr><td>
<?php if (!isset($privatetrust_tb_edit->Pager)) $privatetrust_tb_edit->Pager = new cNumericPager($privatetrust_tb_edit->StartRec, $privatetrust_tb_edit->DisplayRecs, $privatetrust_tb_edit->TotalRecs, $privatetrust_tb_edit->RecRange) ?>
<?php if ($privatetrust_tb_edit->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($privatetrust_tb_edit->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $privatetrust_tb_edit->PageUrl() ?>start=<?php echo $privatetrust_tb_edit->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($privatetrust_tb_edit->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $privatetrust_tb_edit->PageUrl() ?>start=<?php echo $privatetrust_tb_edit->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($privatetrust_tb_edit->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $privatetrust_tb_edit->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($privatetrust_tb_edit->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $privatetrust_tb_edit->PageUrl() ?>start=<?php echo $privatetrust_tb_edit->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($privatetrust_tb_edit->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $privatetrust_tb_edit->PageUrl() ?>start=<?php echo $privatetrust_tb_edit->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
...
<?php
	if (in_array("personal_info", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $personal_info->DetailEdit) {
?>
<?php include_once "personal_infogrid.php" ?>
<?php } ?>
<?php
	if (in_array("spouse_tb", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $spouse_tb->DetailEdit) {
?>
<?php include_once "spouse_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("divorce_tb", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $divorce_tb->DetailEdit) {
?>
<?php include_once "divorce_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("children_details", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $children_details->DetailEdit) {
?>
<?php include_once "children_detailsgrid.php" ?>
<?php } ?>
<?php
	if (in_array("beneficiary_dump", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $beneficiary_dump->DetailEdit) {
?>
<?php include_once "beneficiary_dumpgrid.php" ?>
<?php } ?>
<?php
	if (in_array("alt_beneficiary", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $alt_beneficiary->DetailEdit) {
?>
<?php include_once "alt_beneficiarygrid.php" ?>
<?php } ?>
<?php
	if (in_array("assets_tb", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $assets_tb->DetailEdit) {
?>
<?php include_once "assets_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("overall_asset", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $overall_asset->DetailEdit) {
?>
<?php include_once "overall_assetgrid.php" ?>
<?php } ?>
<?php
	if (in_array("executor_tb", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $executor_tb->DetailEdit) {
?>
<?php include_once "executor_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("trustee_tb", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $trustee_tb->DetailEdit) {
?>
<?php include_once "trustee_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("witness_tb", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $witness_tb->DetailEdit) {
?>
<?php include_once "witness_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("addinfo_tb", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $addinfo_tb->DetailEdit) {
?>
...
<script type="text/javascript">
fprivatetrust_tbedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$privatetrust_tb_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$privatetrust_tb_edit->Page_Terminate();
?>
