...
<?php } ?>
<link rel="shortcut icon" type="image/vnd.microsoft.icon" href="<?php echo ew_ConvertFullUrl("mycms.ico") ?>"><link rel="icon" type="image/vnd.microsoft.icon" href="<?php echo ew_ConvertFullUrl("mycms.ico") ?>">
...
<?php if (!ew_IsMobile()) { ?>
  ...
  <div id="ewHeaderRow" class="ewHeaderRow"><img src="phpimages/mycmslogo2.png" alt="" style="border: 0;">	</div>
	<!-- header (end) -->
<?php } ?>
<?php if (ew_IsMobile()) { ?>
