...
$humanresourcescontact_add = NULL; // Initialize page object first

class chumanresourcescontact_add extends chumanresourcescontact {
	...
	// Page object name
	var $PageObjName = 'humanresourcescontact_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("humanresourcescontactlist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($humanresourcescontact_add)) $humanresourcescontact_add = new chumanresourcescontact_add();

// Page init
$humanresourcescontact_add->Page_Init();

// Page main
$humanresourcescontact_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$humanresourcescontact_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var humanresourcescontact_add = new ew_Page("humanresourcescontact_add");
humanresourcescontact_add.PageID = "add"; // Page ID
var EW_PAGE_ID = humanresourcescontact_add.PageID; // For backward compatibility

// Form object
var fhumanresourcescontactadd = new ew_Form("fhumanresourcescontactadd");

// Validate form
fhumanresourcescontactadd.Validate = function() {
...
fhumanresourcescontactadd.Form_CustomValidate = 
...
fhumanresourcescontactadd.ValidateRequired = true;
<?php } else { ?>
fhumanresourcescontactadd.ValidateRequired = false; 
<?php } ?>
...
<?php $humanresourcescontact_add->ShowPageHeader(); ?>
<?php
$humanresourcescontact_add->ShowMessage();
?>
<form name="fhumanresourcescontactadd" id="fhumanresourcescontactadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="humanresourcescontact">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_humanresourcescontactadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fhumanresourcescontactadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$humanresourcescontact_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$humanresourcescontact_add->Page_Terminate();
?>
