...
//
// Table class for witness_tb
//
class cwitness_tb extends cTable {
	var $id;
	var $uid;
	var $title;
	var $fullname;
	...
	function __construct() {
		...
		$this->TableVar = 'witness_tb';
		$this->TableName = 'witness_tb';
		...
		// id
		$this->id = new cField('witness_tb', 'witness_tb', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// uid
		$this->uid = new cField('witness_tb', 'witness_tb', 'x_uid', 'uid', '`uid`', '`uid`', 3, -1, FALSE, '`uid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->uid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['uid'] = &$this->uid;

		// title
		$this->title = new cField('witness_tb', 'witness_tb', 'x_title', 'title', '`title`', '`title`', 200, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['title'] = &$this->title;

		// fullname
		$this->fullname = new cField('witness_tb', 'witness_tb', 'x_fullname', 'fullname', '`fullname`', '`fullname`', 200, -1, FALSE, '`fullname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['fullname'] = &$this->fullname;

		// rtionship
		$this->rtionship = new cField('witness_tb', 'witness_tb', 'x_rtionship', 'rtionship', '`rtionship`', '`rtionship`', 200, -1, FALSE, '`rtionship`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['rtionship'] = &$this->rtionship;

		// email
		$this->_email = new cField('witness_tb', 'witness_tb', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['email'] = &$this->_email;

		// phone
		$this->phone = new cField('witness_tb', 'witness_tb', 'x_phone', 'phone', '`phone`', '`phone`', 200, -1, FALSE, '`phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['phone'] = &$this->phone;

		// addr
		$this->addr = new cField('witness_tb', 'witness_tb', 'x_addr', 'addr', '`addr`', '`addr`', 201, -1, FALSE, '`addr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['addr'] = &$this->addr;

		// address
		$this->address = new cField('witness_tb', 'witness_tb', 'x_address', 'address', '`address`', '`address`', 201, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['address'] = &$this->address;

		// city
		$this->city = new cField('witness_tb', 'witness_tb', 'x_city', 'city', '`city`', '`city`', 200, -1, FALSE, '`city`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['city'] = &$this->city;

		// state
		$this->state = new cField('witness_tb', 'witness_tb', 'x_state', 'state', '`state`', '`state`', 200, -1, FALSE, '`state`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['state'] = &$this->state;

		// datecreated
		$this->datecreated = new cField('witness_tb', 'witness_tb', 'x_datecreated', 'datecreated', '`datecreated`', 'DATE_FORMAT(`datecreated`, \'%d/%m/%y\')', 135, -1, FALSE, '`datecreated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['datecreated'] = &$this->datecreated;

		// occupation
		$this->occupation = new cField('witness_tb', 'witness_tb', 'x_occupation', 'occupation', '`occupation`', '`occupation`', 200, -1, FALSE, '`occupation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['occupation'] = &$this->occupation;

		// mobile
		$this->mobile = new cField('witness_tb', 'witness_tb', 'x_mobile', 'mobile', '`mobile`', '`mobile`', 200, -1, FALSE, '`mobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mobile'] = &$this->mobile;

		// signature
		$this->signature = new cField('witness_tb', 'witness_tb', 'x_signature', 'signature', '`signature`', '`signature`', 200, -1, FALSE, '`signature`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetMasterFilter() {
		...
		if ($this->getCurrentMasterTable() == "privatetrust_tb") {
			if ($this->id->getSessionValue() <> "")
				$sMasterFilter .= "`uid`=" . ew_QuotedValue($this->id->getSessionValue(), EW_DATATYPE_NUMBER);
			else
				return "";
		}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("witness_tbview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("witness_tbview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "witness_tbadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("witness_tbedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("witness_tbadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("witness_tbdelete.php", $this->UrlParm());
	}
