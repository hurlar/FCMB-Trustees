...
$trustee_tb_add = NULL; // Initialize page object first

class ctrustee_tb_add extends ctrustee_tb {
	...
	// Page object name
	var $PageObjName = 'trustee_tb_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("trustee_tblist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($trustee_tb_add)) $trustee_tb_add = new ctrustee_tb_add();

// Page init
$trustee_tb_add->Page_Init();

// Page main
$trustee_tb_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$trustee_tb_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var trustee_tb_add = new ew_Page("trustee_tb_add");
trustee_tb_add.PageID = "add"; // Page ID
var EW_PAGE_ID = trustee_tb_add.PageID; // For backward compatibility

// Form object
var ftrustee_tbadd = new ew_Form("ftrustee_tbadd");

// Validate form
ftrustee_tbadd.Validate = function() {
...
ftrustee_tbadd.Form_CustomValidate = 
...
ftrustee_tbadd.ValidateRequired = true;
<?php } else { ?>
ftrustee_tbadd.ValidateRequired = false; 
<?php } ?>
...
<?php $trustee_tb_add->ShowPageHeader(); ?>
<?php
$trustee_tb_add->ShowMessage();
?>
<form name="ftrustee_tbadd" id="ftrustee_tbadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="trustee_tb">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_trustee_tbadd" class="table table-bordered table-striped">
