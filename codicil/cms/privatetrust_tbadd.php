...
$privatetrust_tb_add = NULL; // Initialize page object first

class cprivatetrust_tb_add extends cprivatetrust_tb {
	...
	// Page object name
	var $PageObjName = 'privatetrust_tb_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("privatetrust_tblist.php"); // No matching record, return to list
				}
	...
	function AddRow($rsold = NULL) {
		...
		if ($AddRow) {
			...
			if (in_array("witness_tb", $DetailTblVar) && $GLOBALS["witness_tb"]->DetailAdd) {
				$GLOBALS["witness_tb"]->id->setSessionValue($this->uid->CurrentValue); // Set master key
				if (!isset($GLOBALS["witness_tb_grid"])) $GLOBALS["witness_tb_grid"] = new cwitness_tb_grid(); // Get detail page object
				$AddRow = $GLOBALS["witness_tb_grid"]->GridInsert();
				if (!$AddRow)
					$GLOBALS["witness_tb"]->id->setSessionValue(""); // Clear master key if insert failed
			}
			if (in_array("addinfo_tb", $DetailTblVar) && $GLOBALS["addinfo_tb"]->DetailAdd) {
...
// Create page object
if (!isset($privatetrust_tb_add)) $privatetrust_tb_add = new cprivatetrust_tb_add();

// Page init
$privatetrust_tb_add->Page_Init();

// Page main
$privatetrust_tb_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$privatetrust_tb_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var privatetrust_tb_add = new ew_Page("privatetrust_tb_add");
privatetrust_tb_add.PageID = "add"; // Page ID
var EW_PAGE_ID = privatetrust_tb_add.PageID; // For backward compatibility

// Form object
var fprivatetrust_tbadd = new ew_Form("fprivatetrust_tbadd");

// Validate form
fprivatetrust_tbadd.Validate = function() {
...
fprivatetrust_tbadd.Form_CustomValidate = 
...
fprivatetrust_tbadd.ValidateRequired = true;
<?php } else { ?>
fprivatetrust_tbadd.ValidateRequired = false; 
<?php } ?>
...
<?php $privatetrust_tb_add->ShowPageHeader(); ?>
<?php
$privatetrust_tb_add->ShowMessage();
?>
<form name="fprivatetrust_tbadd" id="fprivatetrust_tbadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="privatetrust_tb">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_privatetrust_tbadd" class="table table-bordered table-striped">
...
<?php
	if (in_array("personal_info", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $personal_info->DetailAdd) {
?>
<?php include_once "personal_infogrid.php" ?>
<?php } ?>
<?php
	if (in_array("spouse_tb", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $spouse_tb->DetailAdd) {
?>
<?php include_once "spouse_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("divorce_tb", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $divorce_tb->DetailAdd) {
?>
<?php include_once "divorce_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("children_details", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $children_details->DetailAdd) {
?>
<?php include_once "children_detailsgrid.php" ?>
<?php } ?>
<?php
	if (in_array("beneficiary_dump", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $beneficiary_dump->DetailAdd) {
?>
<?php include_once "beneficiary_dumpgrid.php" ?>
<?php } ?>
<?php
	if (in_array("alt_beneficiary", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $alt_beneficiary->DetailAdd) {
?>
<?php include_once "alt_beneficiarygrid.php" ?>
<?php } ?>
<?php
	if (in_array("assets_tb", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $assets_tb->DetailAdd) {
?>
<?php include_once "assets_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("overall_asset", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $overall_asset->DetailAdd) {
?>
<?php include_once "overall_assetgrid.php" ?>
<?php } ?>
<?php
	if (in_array("executor_tb", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $executor_tb->DetailAdd) {
?>
<?php include_once "executor_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("trustee_tb", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $trustee_tb->DetailAdd) {
?>
<?php include_once "trustee_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("witness_tb", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $witness_tb->DetailAdd) {
?>
<?php include_once "witness_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("addinfo_tb", explode(",", $privatetrust_tb->getCurrentDetailTable())) && $addinfo_tb->DetailAdd) {
?>
...
<script type="text/javascript">
fprivatetrust_tbadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$privatetrust_tb_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$privatetrust_tb_add->Page_Terminate();
?>
