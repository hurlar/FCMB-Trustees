...
//
// Table class for fileuploads
//
class cfileuploads extends cTable {
	var $id;
	var $name;
	var $_upload;
	var $datecr;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('fileuploads', 'fileuploads', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name
		$this->name = new cField('fileuploads', 'fileuploads', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] = &$this->name;

		// upload
		$this->_upload = new cField('fileuploads', 'fileuploads', 'x__upload', 'upload', '`upload`', '`upload`', 200, -1, TRUE, '`upload`', FALSE, FALSE, FALSE, 'IMAGE');
		$this->fields['upload'] = &$this->_upload;

		// datecr
		$this->datecr = new cField('fileuploads', 'fileuploads', 'x_datecr', 'datecr', '`datecr`', 'DATE_FORMAT(`datecr`, \'%d/%m/%y\')', 135, -1, FALSE, '`datecr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("fileuploadsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("fileuploadsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "fileuploadsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("fileuploadsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("fileuploadsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("fileuploadsdelete.php", $this->UrlParm());
	}
