...
$layout_add = NULL; // Initialize page object first

class clayout_add extends clayout {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("layoutlist.php"); // No matching record, return to list
				}
				break;
	...
	function LoadDefaultValues() {
		$this->top2Dl->CurrentValue = NULL;
		$this->top2Dl->OldValue = $this->top2Dl->CurrentValue;
		$this->top2Dr->CurrentValue = NULL;
		$this->top2Dr->OldValue = $this->top2Dr->CurrentValue;
		$this->head2Dl->CurrentValue = NULL;
		$this->head2Dl->OldValue = $this->head2Dl->CurrentValue;
		$this->head2Dr->CurrentValue = NULL;
		$this->head2Dr->OldValue = $this->head2Dr->CurrentValue;
		$this->slide1->Upload->DbValue = NULL;
		$this->slide1->OldValue = $this->slide1->Upload->DbValue;
		$this->slide1->CurrentValue = NULL; // Clear file related field
		$this->slide2->Upload->DbValue = NULL;
		$this->slide2->OldValue = $this->slide2->Upload->DbValue;
		$this->slide2->CurrentValue = NULL; // Clear file related field
		$this->slide3->Upload->DbValue = NULL;
		$this->slide3->OldValue = $this->slide3->Upload->DbValue;
		$this->slide3->CurrentValue = NULL; // Clear file related field
		$this->slide4->Upload->DbValue = NULL;
		$this->slide4->OldValue = $this->slide4->Upload->DbValue;
		$this->slide4->CurrentValue = NULL; // Clear file related field
		$this->slide5->Upload->DbValue = NULL;
		$this->slide5->OldValue = $this->slide5->Upload->DbValue;
		$this->slide5->CurrentValue = NULL; // Clear file related field
		$this->slide6->Upload->DbValue = NULL;
		$this->slide6->OldValue = $this->slide6->Upload->DbValue;
		$this->slide6->CurrentValue = NULL; // Clear file related field
		$this->home2Dcaption1->CurrentValue = NULL;
		$this->home2Dcaption1->OldValue = $this->home2Dcaption1->CurrentValue;
		$this->home2Dtext1->CurrentValue = NULL;
		$this->home2Dtext1->OldValue = $this->home2Dtext1->CurrentValue;
		$this->home2Dcaption2->CurrentValue = NULL;
		$this->home2Dcaption2->OldValue = $this->home2Dcaption2->CurrentValue;
		$this->home2Dtext2->CurrentValue = NULL;
		$this->home2Dtext2->OldValue = $this->home2Dtext2->CurrentValue;
		$this->home2Dcaption3->CurrentValue = NULL;
		$this->home2Dcaption3->OldValue = $this->home2Dcaption3->CurrentValue;
		$this->home2Dtext3->CurrentValue = NULL;
		$this->home2Dtext3->OldValue = $this->home2Dtext3->CurrentValue;
		$this->home2Dcaption4->CurrentValue = NULL;
		$this->home2Dcaption4->OldValue = $this->home2Dcaption4->CurrentValue;
		$this->home2Dtext4->CurrentValue = NULL;
		$this->home2Dtext4->OldValue = $this->home2Dtext4->CurrentValue;
		$this->home2Dcaption5->CurrentValue = NULL;
		$this->home2Dcaption5->OldValue = $this->home2Dcaption5->CurrentValue;
		$this->home2Dtext5->CurrentValue = NULL;
		$this->home2Dtext5->OldValue = $this->home2Dtext5->CurrentValue;
		$this->home2Dcaption6->CurrentValue = NULL;
		$this->home2Dcaption6->OldValue = $this->home2Dcaption6->CurrentValue;
		$this->home2Dtext6->CurrentValue = NULL;
		$this->home2Dtext6->OldValue = $this->home2Dtext6->CurrentValue;
		$this->footer2D1->CurrentValue = NULL;
		$this->footer2D1->OldValue = $this->footer2D1->CurrentValue;
		$this->footer2D2->CurrentValue = NULL;
		$this->footer2D2->OldValue = $this->footer2D2->CurrentValue;
		$this->footer2D3->CurrentValue = NULL;
		$this->footer2D3->OldValue = $this->footer2D3->CurrentValue;
		$this->footer2D4->CurrentValue = NULL;
		$this->footer2D4->OldValue = $this->footer2D4->CurrentValue;
		$this->contact2Demail->CurrentValue = NULL;
		$this->contact2Demail->OldValue = $this->contact2Demail->CurrentValue;
		$this->contact2Dtext1->CurrentValue = NULL;
		$this->contact2Dtext1->OldValue = $this->contact2Dtext1->CurrentValue;
		$this->contact2Dtext2->CurrentValue = NULL;
		$this->contact2Dtext2->OldValue = $this->contact2Dtext2->CurrentValue;
		$this->contact2Dtext3->CurrentValue = NULL;
		$this->contact2Dtext3->OldValue = $this->contact2Dtext3->CurrentValue;
		$this->contact2Dtext4->CurrentValue = NULL;
		$this->contact2Dtext4->OldValue = $this->contact2Dtext4->CurrentValue;
	}
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->slide1);
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->slide2);
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->slide3);
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->slide4);
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->slide5);
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->slide6);
	...
	function AddRow($rsold = NULL) {
		...
		// top-l
		$this->top2Dl->SetDbValueDef($rsnew, $this->top2Dl->CurrentValue, NULL, FALSE);

		// top-r
		$this->top2Dr->SetDbValueDef($rsnew, $this->top2Dr->CurrentValue, NULL, FALSE);

		// head-l
		$this->head2Dl->SetDbValueDef($rsnew, $this->head2Dl->CurrentValue, NULL, FALSE);

		// head-r
		$this->head2Dr->SetDbValueDef($rsnew, $this->head2Dr->CurrentValue, NULL, FALSE);
		...
		// home-caption1
		$this->home2Dcaption1->SetDbValueDef($rsnew, $this->home2Dcaption1->CurrentValue, NULL, FALSE);

		// home-text1
		$this->home2Dtext1->SetDbValueDef($rsnew, $this->home2Dtext1->CurrentValue, NULL, FALSE);

		// home-caption2
		$this->home2Dcaption2->SetDbValueDef($rsnew, $this->home2Dcaption2->CurrentValue, NULL, FALSE);

		// home-text2
		$this->home2Dtext2->SetDbValueDef($rsnew, $this->home2Dtext2->CurrentValue, NULL, FALSE);

		// home-caption3
		$this->home2Dcaption3->SetDbValueDef($rsnew, $this->home2Dcaption3->CurrentValue, NULL, FALSE);

		// home-text3
		$this->home2Dtext3->SetDbValueDef($rsnew, $this->home2Dtext3->CurrentValue, NULL, FALSE);

		// home-caption4
		$this->home2Dcaption4->SetDbValueDef($rsnew, $this->home2Dcaption4->CurrentValue, NULL, FALSE);

		// home-text4
		$this->home2Dtext4->SetDbValueDef($rsnew, $this->home2Dtext4->CurrentValue, NULL, FALSE);

		// home-caption5
		$this->home2Dcaption5->SetDbValueDef($rsnew, $this->home2Dcaption5->CurrentValue, NULL, FALSE);

		// home-text5
		$this->home2Dtext5->SetDbValueDef($rsnew, $this->home2Dtext5->CurrentValue, NULL, FALSE);

		// home-caption6
		$this->home2Dcaption6->SetDbValueDef($rsnew, $this->home2Dcaption6->CurrentValue, NULL, FALSE);

		// home-text6
		$this->home2Dtext6->SetDbValueDef($rsnew, $this->home2Dtext6->CurrentValue, NULL, FALSE);

		// footer-1
		$this->footer2D1->SetDbValueDef($rsnew, $this->footer2D1->CurrentValue, NULL, FALSE);

		// footer-2
		$this->footer2D2->SetDbValueDef($rsnew, $this->footer2D2->CurrentValue, NULL, FALSE);

		// footer-3
		$this->footer2D3->SetDbValueDef($rsnew, $this->footer2D3->CurrentValue, NULL, FALSE);

		// footer-4
		$this->footer2D4->SetDbValueDef($rsnew, $this->footer2D4->CurrentValue, NULL, FALSE);

		// contact-email
		$this->contact2Demail->SetDbValueDef($rsnew, $this->contact2Demail->CurrentValue, NULL, FALSE);

		// contact-text1
		$this->contact2Dtext1->SetDbValueDef($rsnew, $this->contact2Dtext1->CurrentValue, NULL, FALSE);

		// contact-text2
		$this->contact2Dtext2->SetDbValueDef($rsnew, $this->contact2Dtext2->CurrentValue, NULL, FALSE);

		// contact-text3
		$this->contact2Dtext3->SetDbValueDef($rsnew, $this->contact2Dtext3->CurrentValue, NULL, FALSE);

		// contact-text4
		$this->contact2Dtext4->SetDbValueDef($rsnew, $this->contact2Dtext4->CurrentValue, NULL, FALSE);
		if (!$this->slide1->Upload->KeepFile) {
			$this->slide1->UploadPath = "../images/slides/";
...
// Create page object
if (!isset($layout_add)) $layout_add = new clayout_add();

// Page init
$layout_add->Page_Init();

// Page main
$layout_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$layout_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var layout_add = new ew_Page("layout_add");
layout_add.PageID = "add"; // Page ID
var EW_PAGE_ID = layout_add.PageID; // For backward compatibility

// Form object
var flayoutadd = new ew_Form("flayoutadd");

// Validate form
flayoutadd.Validate = function() {
...
flayoutadd.Form_CustomValidate = 
...
<?php $layout_add->ShowPageHeader(); ?>
<?php
$layout_add->ShowMessage();
?>
<form name="flayoutadd" id="flayoutadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="layout">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewStdTable"><tbody><tr><td>
<div class="tabbable" id="layout_add">
...
<table id="tbl_layoutadd1" class="table table-bordered table-striped">
...
<table cellspacing="0" class="ewGrid" style="width: 100%"><tr><td>
<table id="tbl_layoutadd3" class="table table-bordered table-striped">
...
<script type="text/javascript">
ew_CreateEditor("flayoutadd", "x_home2Dtext1", 35, 4, <?php echo ($layout->home2Dtext1->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<script type="text/javascript">
ew_CreateEditor("flayoutadd", "x_home2Dtext2", 35, 4, <?php echo ($layout->home2Dtext2->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<script type="text/javascript">
ew_CreateEditor("flayoutadd", "x_home2Dtext3", 35, 4, <?php echo ($layout->home2Dtext3->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<script type="text/javascript">
ew_CreateEditor("flayoutadd", "x_home2Dtext4", 35, 4, <?php echo ($layout->home2Dtext4->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<script type="text/javascript">
ew_CreateEditor("flayoutadd", "x_home2Dtext5", 35, 4, <?php echo ($layout->home2Dtext5->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<script type="text/javascript">
ew_CreateEditor("flayoutadd", "x_home2Dtext6", 35, 4, <?php echo ($layout->home2Dtext6->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<table cellspacing="0" class="ewGrid" style="width: 100%"><tr><td>
<table id="tbl_layoutadd4" class="table table-bordered table-striped">
...
<table cellspacing="0" class="ewGrid" style="width: 100%"><tr><td>
<table id="tbl_layoutadd5" class="table table-bordered table-striped">
