...
$simplewill_overall_asset_grid = NULL; // Initialize page object first

class csimplewill_overall_asset_grid extends csimplewill_overall_asset {
	...
	// Page object name
	var $PageObjName = 'simplewill_overall_asset_grid';

	// Grid form hidden field names
	var $FormName = 'fsimplewill_overall_assetgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["simplewill_overall_asset"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "simplewill_assets_tb") {
			...
			if ($GLOBALS["simplewill_assets_tb"]->EventCancelled) $this->EventCancelled = TRUE;
		}
		if ($sMasterTblVar == "simplewill_tb") {
			$this->uid->Visible = FALSE;
			if ($GLOBALS["simplewill_tb"]->EventCancelled) $this->EventCancelled = TRUE;
		}
