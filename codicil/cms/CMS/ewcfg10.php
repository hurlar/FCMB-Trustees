...
define("EW_DEFAULT_DATE_FORMAT_ID", "14", TRUE); // Default date format
define("EW_DATE_SEPARATOR", "/", TRUE); // Date separator
define("EW_UNFORMAT_YEAR", 50, TRUE); // Unformat year
define("EW_PROJECT_NAME", "cms2Dtrustees", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{D9B361E7-B2C1-4293-B9B3-B581986A15CC}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'WNYdtoyv2przy26u', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/cms2Dtrustees.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_USER", 'sr11apm4_trust', TRUE);
define("EW_CONN_PASS", 'user@2018', TRUE);
define("EW_CONN_DB", 'sr11apm4_trust', TRUE);
...
// User table filters
define("EW_USER_TABLE", "`adminusers`",  TRUE);
...
define("EW_SENDER_EMAIL", "info@joymeitschool.com", TRUE); // Sender email address
