...
$management_image_blobview = NULL; // Initialize page object first

class cmanagement_image_blobview extends cmanagement {
	...
	// Page object name
	var $PageObjName = 'management_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('management', 'x_image');
...
// Create page object
if (!isset($management_image_blobview)) $management_image_blobview = new cmanagement_image_blobview();

// Page init
$management_image_blobview->Page_Init();

// Page main
$management_image_blobview->Page_Main();
?>
<?php
$management_image_blobview->Page_Terminate();
?>
