...
$education_tb_view = NULL; // Initialize page object first

class ceducation_tb_view extends ceducation_tb {
	...
	// Page object name
	var $PageObjName = 'education_tb_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("education_tblist.php"); // Return to list page
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "education_tblist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "education_tblist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_education_tb\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_education_tb',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.feducation_tbview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($education_tb_view)) $education_tb_view = new ceducation_tb_view();

// Page init
$education_tb_view->Page_Init();

// Page main
$education_tb_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$education_tb_view->Page_Render();
?>
...
// Page object
var education_tb_view = new ew_Page("education_tb_view");
education_tb_view.PageID = "view"; // Page ID
var EW_PAGE_ID = education_tb_view.PageID; // For backward compatibility

// Form object
var feducation_tbview = new ew_Form("feducation_tbview");

// Form_CustomValidate event
feducation_tbview.Form_CustomValidate = 
...
feducation_tbview.ValidateRequired = true;
<?php } else { ?>
feducation_tbview.ValidateRequired = false; 
<?php } ?>
...
<?php $education_tb_view->ExportOptions->Render("body") ?>
<?php if (!$education_tb_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($education_tb_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $education_tb_view->ShowPageHeader(); ?>
<?php
$education_tb_view->ShowMessage();
?>
<form name="feducation_tbview" id="feducation_tbview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="education_tb">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_education_tbview" class="table table-bordered table-striped">
<?php if ($education_tb->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_education_tb_id"><?php echo $education_tb->id->FldCaption() ?></span></td>
		<td<?php echo $education_tb->id->CellAttributes() ?>>
<span id="el_education_tb_id" class="control-group">
<span<?php echo $education_tb->id->ViewAttributes() ?>>
<?php echo $education_tb->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->uid->ViewAttributes() ?>>
<?php echo $education_tb->uid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $education_tb->fullname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->address->ViewAttributes() ?>>
<?php echo $education_tb->address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $education_tb->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->maidenname->ViewAttributes() ?>>
<?php echo $education_tb->maidenname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $education_tb->phoneno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $education_tb->aphoneno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $education_tb->maritalstatus->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $education_tb->gender->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $education_tb->dob->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->state->ViewAttributes() ?>>
<?php echo $education_tb->state->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->nationality->ViewAttributes() ?>>
<?php echo $education_tb->nationality->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->lga->ViewAttributes() ?>>
<?php echo $education_tb->lga->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->employer->ViewAttributes() ?>>
<?php echo $education_tb->employer->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->employerphone->ViewAttributes() ?>>
<?php echo $education_tb->employerphone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->employeraddr->ViewAttributes() ?>>
<?php echo $education_tb->employeraddr->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->idnumber->ViewAttributes() ?>>
<?php echo $education_tb->idnumber->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->issuedate->ViewAttributes() ?>>
<?php echo $education_tb->issuedate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $education_tb->employmentstatus->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->expirydate->ViewAttributes() ?>>
<?php echo $education_tb->expirydate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $education_tb->datecreated->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->willtype->ViewAttributes() ?>>
<?php echo $education_tb->willtype->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->identificationtype->ViewAttributes() ?>>
<?php echo $education_tb->identificationtype->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->issueplace->ViewAttributes() ?>>
<?php echo $education_tb->issueplace->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->spousename->ViewAttributes() ?>>
<?php echo $education_tb->spousename->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->spouseemail->ViewAttributes() ?>>
<?php echo $education_tb->spouseemail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->spousephone->ViewAttributes() ?>>
<?php echo $education_tb->spousephone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->spousedob->ViewAttributes() ?>>
<?php echo $education_tb->spousedob->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->spouseaddr->ViewAttributes() ?>>
<?php echo $education_tb->spouseaddr->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->spousecity->ViewAttributes() ?>>
<?php echo $education_tb->spousecity->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->spousestate->ViewAttributes() ?>>
<?php echo $education_tb->spousestate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->marriagetype->ViewAttributes() ?>>
<?php echo $education_tb->marriagetype->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->marriageyear->ViewAttributes() ?>>
<?php echo $education_tb->marriageyear->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->marriagecert->ViewAttributes() ?>>
<?php echo $education_tb->marriagecert->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->cityofmarriage->ViewAttributes() ?>>
<?php echo $education_tb->cityofmarriage->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->countryofmarriage->ViewAttributes() ?>>
<?php echo $education_tb->countryofmarriage->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->divorce->ViewAttributes() ?>>
<?php echo $education_tb->divorce->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->divorceyear->ViewAttributes() ?>>
<?php echo $education_tb->divorceyear->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->nextofkinfullname->ViewAttributes() ?>>
<?php echo $education_tb->nextofkinfullname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->nextofkintelephone->ViewAttributes() ?>>
<?php echo $education_tb->nextofkintelephone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->nextofkinemail->ViewAttributes() ?>>
<?php echo $education_tb->nextofkinemail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->nextofkinaddress->ViewAttributes() ?>>
<?php echo $education_tb->nextofkinaddress->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->nameofcompany->ViewAttributes() ?>>
<?php echo $education_tb->nameofcompany->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->humanresourcescontacttelephone->ViewAttributes() ?>>
<?php echo $education_tb->humanresourcescontacttelephone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $education_tb->humanresourcescontactemailaddress->ViewAttributes() ?>>
<?php echo $education_tb->humanresourcescontactemailaddress->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<table class="ewPager">
<tr><td>
<?php if (!isset($education_tb_view->Pager)) $education_tb_view->Pager = new cNumericPager($education_tb_view->StartRec, $education_tb_view->DisplayRecs, $education_tb_view->TotalRecs, $education_tb_view->RecRange) ?>
<?php if ($education_tb_view->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($education_tb_view->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $education_tb_view->PageUrl() ?>start=<?php echo $education_tb_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($education_tb_view->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $education_tb_view->PageUrl() ?>start=<?php echo $education_tb_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($education_tb_view->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $education_tb_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($education_tb_view->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $education_tb_view->PageUrl() ?>start=<?php echo $education_tb_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($education_tb_view->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $education_tb_view->PageUrl() ?>start=<?php echo $education_tb_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
...
<script type="text/javascript">
feducation_tbview.Init();
</script>
<?php
$education_tb_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($education_tb->Export == "") { ?>
...
<?php
$education_tb_view->Page_Terminate();
?>
