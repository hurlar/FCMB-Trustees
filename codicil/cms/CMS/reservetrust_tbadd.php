...
$reservetrust_tb_add = NULL; // Initialize page object first

class creservetrust_tb_add extends creservetrust_tb {
	...
	// Page object name
	var $PageObjName = 'reservetrust_tb_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("reservetrust_tblist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($reservetrust_tb_add)) $reservetrust_tb_add = new creservetrust_tb_add();

// Page init
$reservetrust_tb_add->Page_Init();

// Page main
$reservetrust_tb_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$reservetrust_tb_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var reservetrust_tb_add = new ew_Page("reservetrust_tb_add");
reservetrust_tb_add.PageID = "add"; // Page ID
var EW_PAGE_ID = reservetrust_tb_add.PageID; // For backward compatibility

// Form object
var freservetrust_tbadd = new ew_Form("freservetrust_tbadd");

// Validate form
freservetrust_tbadd.Validate = function() {
...
freservetrust_tbadd.Form_CustomValidate = 
...
freservetrust_tbadd.ValidateRequired = true;
<?php } else { ?>
freservetrust_tbadd.ValidateRequired = false; 
<?php } ?>
...
<?php $reservetrust_tb_add->ShowPageHeader(); ?>
<?php
$reservetrust_tb_add->ShowMessage();
?>
<form name="freservetrust_tbadd" id="freservetrust_tbadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="reservetrust_tb">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_reservetrust_tbadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
freservetrust_tbadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$reservetrust_tb_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$reservetrust_tb_add->Page_Terminate();
?>
