...
$investmenttrust_tb_add = NULL; // Initialize page object first

class cinvestmenttrust_tb_add extends cinvestmenttrust_tb {
	...
	// Page object name
	var $PageObjName = 'investmenttrust_tb_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("investmenttrust_tblist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($investmenttrust_tb_add)) $investmenttrust_tb_add = new cinvestmenttrust_tb_add();

// Page init
$investmenttrust_tb_add->Page_Init();

// Page main
$investmenttrust_tb_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$investmenttrust_tb_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var investmenttrust_tb_add = new ew_Page("investmenttrust_tb_add");
investmenttrust_tb_add.PageID = "add"; // Page ID
var EW_PAGE_ID = investmenttrust_tb_add.PageID; // For backward compatibility

// Form object
var finvestmenttrust_tbadd = new ew_Form("finvestmenttrust_tbadd");

// Validate form
finvestmenttrust_tbadd.Validate = function() {
...
finvestmenttrust_tbadd.Form_CustomValidate = 
...
finvestmenttrust_tbadd.ValidateRequired = true;
<?php } else { ?>
finvestmenttrust_tbadd.ValidateRequired = false; 
<?php } ?>
...
<?php $investmenttrust_tb_add->ShowPageHeader(); ?>
<?php
$investmenttrust_tb_add->ShowMessage();
?>
<form name="finvestmenttrust_tbadd" id="finvestmenttrust_tbadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="investmenttrust_tb">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_investmenttrust_tbadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
finvestmenttrust_tbadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$investmenttrust_tb_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$investmenttrust_tb_add->Page_Terminate();
?>
