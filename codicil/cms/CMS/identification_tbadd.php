...
$identification_tb_add = NULL; // Initialize page object first

class cidentification_tb_add extends cidentification_tb {
	...
	// Page object name
	var $PageObjName = 'identification_tb_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("identification_tblist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($identification_tb_add)) $identification_tb_add = new cidentification_tb_add();

// Page init
$identification_tb_add->Page_Init();

// Page main
$identification_tb_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$identification_tb_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var identification_tb_add = new ew_Page("identification_tb_add");
identification_tb_add.PageID = "add"; // Page ID
var EW_PAGE_ID = identification_tb_add.PageID; // For backward compatibility

// Form object
var fidentification_tbadd = new ew_Form("fidentification_tbadd");

// Validate form
fidentification_tbadd.Validate = function() {
...
fidentification_tbadd.Form_CustomValidate = 
...
fidentification_tbadd.ValidateRequired = true;
<?php } else { ?>
fidentification_tbadd.ValidateRequired = false; 
<?php } ?>
...
<?php $identification_tb_add->ShowPageHeader(); ?>
<?php
$identification_tb_add->ShowMessage();
?>
<form name="fidentification_tbadd" id="fidentification_tbadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="identification_tb">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_identification_tbadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fidentification_tbadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$identification_tb_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$identification_tb_add->Page_Terminate();
?>
