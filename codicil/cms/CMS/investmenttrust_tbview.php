...
$investmenttrust_tb_view = NULL; // Initialize page object first

class cinvestmenttrust_tb_view extends cinvestmenttrust_tb {
	...
	// Page object name
	var $PageObjName = 'investmenttrust_tb_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "investmenttrust_tblist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "investmenttrust_tblist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($investmenttrust_tb_view)) $investmenttrust_tb_view = new cinvestmenttrust_tb_view();

// Page init
$investmenttrust_tb_view->Page_Init();

// Page main
$investmenttrust_tb_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$investmenttrust_tb_view->Page_Render();
?>
...
// Page object
var investmenttrust_tb_view = new ew_Page("investmenttrust_tb_view");
investmenttrust_tb_view.PageID = "view"; // Page ID
var EW_PAGE_ID = investmenttrust_tb_view.PageID; // For backward compatibility

// Form object
var finvestmenttrust_tbview = new ew_Form("finvestmenttrust_tbview");

// Form_CustomValidate event
finvestmenttrust_tbview.Form_CustomValidate = 
...
finvestmenttrust_tbview.ValidateRequired = true;
<?php } else { ?>
finvestmenttrust_tbview.ValidateRequired = false; 
<?php } ?>
...
<?php $investmenttrust_tb_view->ExportOptions->Render("body") ?>
<?php if (!$investmenttrust_tb_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($investmenttrust_tb_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $investmenttrust_tb_view->ShowPageHeader(); ?>
<?php
$investmenttrust_tb_view->ShowMessage();
?>
<form name="finvestmenttrust_tbview" id="finvestmenttrust_tbview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="investmenttrust_tb">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_investmenttrust_tbview" class="table table-bordered table-striped">
...
<?php echo $investmenttrust_tb->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->uid->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->uid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $investmenttrust_tb->fullname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->address->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $investmenttrust_tb->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->maidenname->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->maidenname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $investmenttrust_tb->phoneno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $investmenttrust_tb->aphoneno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $investmenttrust_tb->maritalstatus->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $investmenttrust_tb->gender->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $investmenttrust_tb->dob->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $investmenttrust_tb->state->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->nationality->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->nationality->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->lga->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->lga->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->employer->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->employer->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->employerphone->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->employerphone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->employeraddr->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->employeraddr->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->idnumber->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->idnumber->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->issuedate->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->issuedate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->expirydate->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->expirydate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $investmenttrust_tb->datecreated->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->willtype->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->willtype->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->identificationtype->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->identificationtype->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->issueplace->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->issueplace->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $investmenttrust_tb->employmentstatus->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->spousename->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->spousename->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->spouseemail->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->spouseemail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->spousephone->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->spousephone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->spousedob->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->spousedob->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->spouseaddr->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->spouseaddr->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->spousecity->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->spousecity->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->spousestate->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->spousestate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->marriagetype->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->marriagetype->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->marriageyear->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->marriageyear->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->marriagecert->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->marriagecert->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->cityofmarriage->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->cityofmarriage->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->countryofmarriage->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->countryofmarriage->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->divorce->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->divorce->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->divorceyear->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->divorceyear->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->nextofkinfullname->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->nextofkinfullname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->nextofkintelephone->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->nextofkintelephone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->nextofkinemail->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->nextofkinemail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->nextofkinaddress->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->nextofkinaddress->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->nameofcompany->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->nameofcompany->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->humanresourcescontacttelephone->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->humanresourcescontacttelephone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $investmenttrust_tb->humanresourcescontactemailaddress->ViewAttributes() ?>>
<?php echo $investmenttrust_tb->humanresourcescontactemailaddress->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<table class="ewPager">
<tr><td>
<?php if (!isset($investmenttrust_tb_view->Pager)) $investmenttrust_tb_view->Pager = new cNumericPager($investmenttrust_tb_view->StartRec, $investmenttrust_tb_view->DisplayRecs, $investmenttrust_tb_view->TotalRecs, $investmenttrust_tb_view->RecRange) ?>
<?php if ($investmenttrust_tb_view->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($investmenttrust_tb_view->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $investmenttrust_tb_view->PageUrl() ?>start=<?php echo $investmenttrust_tb_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($investmenttrust_tb_view->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $investmenttrust_tb_view->PageUrl() ?>start=<?php echo $investmenttrust_tb_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($investmenttrust_tb_view->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $investmenttrust_tb_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($investmenttrust_tb_view->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $investmenttrust_tb_view->PageUrl() ?>start=<?php echo $investmenttrust_tb_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($investmenttrust_tb_view->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $investmenttrust_tb_view->PageUrl() ?>start=<?php echo $investmenttrust_tb_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
...
<script type="text/javascript">
finvestmenttrust_tbview.Init();
</script>
<?php
$investmenttrust_tb_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($investmenttrust_tb->Export == "") { ?>
...
<?php
$investmenttrust_tb_view->Page_Terminate();
?>
