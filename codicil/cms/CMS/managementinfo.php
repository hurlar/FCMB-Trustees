...
class cmanagement extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('management', 'management', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name
		$this->name = new cField('management', 'management', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] = &$this->name;

		// position
		$this->position = new cField('management', 'management', 'x_position', 'position', '`position`', '`position`', 200, -1, FALSE, '`position`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['position'] = &$this->position;

		// image
		$this->image = new cField('management', 'management', 'x_image', 'image', '`image`', '`image`', 200, -1, TRUE, '`image`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['image'] = &$this->image;

		// descrp
		$this->descrp = new cField('management', 'management', 'x_descrp', 'descrp', '`descrp`', '`descrp`', 201, -1, FALSE, '`descrp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['descrp'] = &$this->descrp;

		// slug
		$this->slug = new cField('management', 'management', 'x_slug', 'slug', '`slug`', '`slug`', 200, -1, FALSE, '`slug`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['slug'] = &$this->slug;

		// category
		$this->category = new cField('management', 'management', 'x_category', 'category', '`category`', '`category`', 200, -1, FALSE, '`category`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['category'] = &$this->category;

		// rate_ord
		$this->rate_ord = new cField('management', 'management', 'x_rate_ord', 'rate_ord', '`rate_ord`', '`rate_ord`', 202, -1, FALSE, '`rate_ord`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['rate_ord'] = &$this->rate_ord;

		// datecreated
		$this->datecreated = new cField('management', 'management', 'x_datecreated', 'datecreated', '`datecreated`', 'DATE_FORMAT(`datecreated`, \'%d/%m/%y\')', 135, -1, FALSE, '`datecreated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("managementview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("managementview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "managementadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("managementedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("managementadd.php", $this->UrlParm($parm));
	}
