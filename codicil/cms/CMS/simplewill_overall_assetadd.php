...
$simplewill_overall_asset_add = NULL; // Initialize page object first

class csimplewill_overall_asset_add extends csimplewill_overall_asset {
	...
	// Page object name
	var $PageObjName = 'simplewill_overall_asset_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("simplewill_overall_assetlist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($simplewill_overall_asset_add)) $simplewill_overall_asset_add = new csimplewill_overall_asset_add();

// Page init
$simplewill_overall_asset_add->Page_Init();

// Page main
$simplewill_overall_asset_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$simplewill_overall_asset_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var simplewill_overall_asset_add = new ew_Page("simplewill_overall_asset_add");
simplewill_overall_asset_add.PageID = "add"; // Page ID
var EW_PAGE_ID = simplewill_overall_asset_add.PageID; // For backward compatibility

// Form object
var fsimplewill_overall_assetadd = new ew_Form("fsimplewill_overall_assetadd");

// Validate form
fsimplewill_overall_assetadd.Validate = function() {
...
fsimplewill_overall_assetadd.Form_CustomValidate = 
...
fsimplewill_overall_assetadd.ValidateRequired = true;
<?php } else { ?>
fsimplewill_overall_assetadd.ValidateRequired = false; 
<?php } ?>
...
<?php $simplewill_overall_asset_add->ShowPageHeader(); ?>
<?php
$simplewill_overall_asset_add->ShowMessage();
?>
<form name="fsimplewill_overall_assetadd" id="fsimplewill_overall_assetadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="simplewill_overall_asset">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_simplewill_overall_assetadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fsimplewill_overall_assetadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$simplewill_overall_asset_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$simplewill_overall_asset_add->Page_Terminate();
?>
