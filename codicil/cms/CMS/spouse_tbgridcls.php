...
$spouse_tb_grid = NULL; // Initialize page object first

class cspouse_tb_grid extends cspouse_tb {
	...
	// Page object name
	var $PageObjName = 'spouse_tb_grid';

	// Grid form hidden field names
	var $FormName = 'fspouse_tbgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["spouse_tb"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x__email") && $objForm->HasValue("o__email") && $this->_email->CurrentValue <> $this->_email->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_phoneno") && $objForm->HasValue("o_phoneno") && $this->phoneno->CurrentValue <> $this->phoneno->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->phoneno->setOldValue($objForm->GetValue("o_phoneno"));
