...
$directors_add = NULL; // Initialize page object first

class cdirectors_add extends cdirectors {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("directorslist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($directors_add)) $directors_add = new cdirectors_add();

// Page init
$directors_add->Page_Init();

// Page main
$directors_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$directors_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var directors_add = new ew_Page("directors_add");
directors_add.PageID = "add"; // Page ID
var EW_PAGE_ID = directors_add.PageID; // For backward compatibility

// Form object
var fdirectorsadd = new ew_Form("fdirectorsadd");

// Validate form
fdirectorsadd.Validate = function() {
...
fdirectorsadd.Form_CustomValidate = 
...
fdirectorsadd.ValidateRequired = true;
<?php } else { ?>
fdirectorsadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdirectorsadd.Lists["x_category"] = {"LinkField":"x_category","Ajax":null,"AutoFill":false,"DisplayFields":["x_category","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $directors_add->ShowPageHeader(); ?>
<?php
$directors_add->ShowMessage();
?>
<form name="fdirectorsadd" id="fdirectorsadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="directors">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_directorsadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
ew_CreateEditor("fdirectorsadd", "x_descrp", 35, 4, <?php echo ($directors->descrp->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<script type="text/javascript">
fdirectorsadd.Lists["x_category"].Options = <?php echo (is_array($directors->category->EditValue)) ? ew_ArrayToJson($directors->category->EditValue, 1) : "[]" ?>;
</script>
</span>
