...
//
// Table class for directors
//
class cdirectors extends cTable {
	var $id;
	var $name;
	var $position;
	var $image;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('directors', 'directors', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name
		$this->name = new cField('directors', 'directors', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] = &$this->name;

		// position
		$this->position = new cField('directors', 'directors', 'x_position', 'position', '`position`', '`position`', 200, -1, FALSE, '`position`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['position'] = &$this->position;

		// image
		$this->image = new cField('directors', 'directors', 'x_image', 'image', '`image`', '`image`', 200, -1, TRUE, '`image`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['image'] = &$this->image;

		// descrp
		$this->descrp = new cField('directors', 'directors', 'x_descrp', 'descrp', '`descrp`', '`descrp`', 201, -1, FALSE, '`descrp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['descrp'] = &$this->descrp;

		// category
		$this->category = new cField('directors', 'directors', 'x_category', 'category', '`category`', '`category`', 200, -1, FALSE, '`category`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['category'] = &$this->category;

		// slug
		$this->slug = new cField('directors', 'directors', 'x_slug', 'slug', '`slug`', '`slug`', 200, -1, FALSE, '`slug`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['slug'] = &$this->slug;

		// rate_ord
		$this->rate_ord = new cField('directors', 'directors', 'x_rate_ord', 'rate_ord', '`rate_ord`', '`rate_ord`', 202, -1, FALSE, '`rate_ord`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['rate_ord'] = &$this->rate_ord;

		// datecreated
		$this->datecreated = new cField('directors', 'directors', 'x_datecreated', 'datecreated', '`datecreated`', 'DATE_FORMAT(`datecreated`, \'%d/%m/%y\')', 135, -1, FALSE, '`datecreated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("directorsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("directorsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "directorsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("directorsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("directorsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("directorsdelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->descrp->Exportable) $Doc->ExportCaption($this->descrp);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->descrp->Exportable) $Doc->ExportField($this->descrp);
