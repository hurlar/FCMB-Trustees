...
$privatetrust_tb_delete = NULL; // Initialize page object first

class cprivatetrust_tb_delete extends cprivatetrust_tb {
	...
	// Page object name
	var $PageObjName = 'privatetrust_tb_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("privatetrust_tblist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in privatetrust_tb class, privatetrust_tbinfo.php
...
// Create page object
if (!isset($privatetrust_tb_delete)) $privatetrust_tb_delete = new cprivatetrust_tb_delete();

// Page init
$privatetrust_tb_delete->Page_Init();

// Page main
$privatetrust_tb_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$privatetrust_tb_delete->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var privatetrust_tb_delete = new ew_Page("privatetrust_tb_delete");
privatetrust_tb_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = privatetrust_tb_delete.PageID; // For backward compatibility

// Form object
var fprivatetrust_tbdelete = new ew_Form("fprivatetrust_tbdelete");

// Form_CustomValidate event
fprivatetrust_tbdelete.Form_CustomValidate = 
...
fprivatetrust_tbdelete.ValidateRequired = true;
<?php } else { ?>
fprivatetrust_tbdelete.ValidateRequired = false; 
<?php } ?>
...
if ($privatetrust_tb_delete->Recordset = $privatetrust_tb_delete->LoadRecordset())
	$privatetrust_tb_deleteTotalRecs = $privatetrust_tb_delete->Recordset->RecordCount(); // Get record count
if ($privatetrust_tb_deleteTotalRecs <= 0) { // No record found, exit
	if ($privatetrust_tb_delete->Recordset)
		$privatetrust_tb_delete->Recordset->Close();
	$privatetrust_tb_delete->Page_Terminate("privatetrust_tblist.php"); // Return to list
}
?>
<?php $Breadcrumb->Render(); ?>
<?php $privatetrust_tb_delete->ShowPageHeader(); ?>
<?php
$privatetrust_tb_delete->ShowMessage();
?>
<form name="fprivatetrust_tbdelete" id="fprivatetrust_tbdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="privatetrust_tb">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($privatetrust_tb_delete->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_privatetrust_tbdelete" class="ewTable ewTableSeparate">
<?php echo $privatetrust_tb->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($privatetrust_tb->willtype->Visible) { // willtype ?>
		<td><span id="elh_privatetrust_tb_willtype" class="privatetrust_tb_willtype"><?php echo $privatetrust_tb->willtype->FldCaption() ?></span></td>
<?php } ?>
<?php if ($privatetrust_tb->fullname->Visible) { // fullname ?>
		<td><span id="elh_privatetrust_tb_fullname" class="privatetrust_tb_fullname"><?php echo $privatetrust_tb->fullname->FldCaption() ?></span></td>
<?php } ?>
<?php if ($privatetrust_tb->_email->Visible) { // email ?>
		<td><span id="elh_privatetrust_tb__email" class="privatetrust_tb__email"><?php echo $privatetrust_tb->_email->FldCaption() ?></span></td>
<?php } ?>
<?php if ($privatetrust_tb->phoneno->Visible) { // phoneno ?>
		<td><span id="elh_privatetrust_tb_phoneno" class="privatetrust_tb_phoneno"><?php echo $privatetrust_tb->phoneno->FldCaption() ?></span></td>
<?php } ?>
<?php if ($privatetrust_tb->aphoneno->Visible) { // aphoneno ?>
		<td><span id="elh_privatetrust_tb_aphoneno" class="privatetrust_tb_aphoneno"><?php echo $privatetrust_tb->aphoneno->FldCaption() ?></span></td>
<?php } ?>
<?php if ($privatetrust_tb->gender->Visible) { // gender ?>
		<td><span id="elh_privatetrust_tb_gender" class="privatetrust_tb_gender"><?php echo $privatetrust_tb->gender->FldCaption() ?></span></td>
<?php } ?>
<?php if ($privatetrust_tb->dob->Visible) { // dob ?>
		<td><span id="elh_privatetrust_tb_dob" class="privatetrust_tb_dob"><?php echo $privatetrust_tb->dob->FldCaption() ?></span></td>
<?php } ?>
<?php if ($privatetrust_tb->state->Visible) { // state ?>
		<td><span id="elh_privatetrust_tb_state" class="privatetrust_tb_state"><?php echo $privatetrust_tb->state->FldCaption() ?></span></td>
<?php } ?>
<?php if ($privatetrust_tb->nationality->Visible) { // nationality ?>
		<td><span id="elh_privatetrust_tb_nationality" class="privatetrust_tb_nationality"><?php echo $privatetrust_tb->nationality->FldCaption() ?></span></td>
<?php } ?>
<?php if ($privatetrust_tb->employmentstatus->Visible) { // employmentstatus ?>
		<td><span id="elh_privatetrust_tb_employmentstatus" class="privatetrust_tb_employmentstatus"><?php echo $privatetrust_tb->employmentstatus->FldCaption() ?></span></td>
<?php } ?>
<?php if ($privatetrust_tb->maritalstatus->Visible) { // maritalstatus ?>
		<td><span id="elh_privatetrust_tb_maritalstatus" class="privatetrust_tb_maritalstatus"><?php echo $privatetrust_tb->maritalstatus->FldCaption() ?></span></td>
<?php } ?>
<?php if ($privatetrust_tb->datecreated->Visible) { // datecreated ?>
		<td><span id="elh_privatetrust_tb_datecreated" class="privatetrust_tb_datecreated"><?php echo $privatetrust_tb->datecreated->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$privatetrust_tb_delete->RecCnt = 0;
$i = 0;
while (!$privatetrust_tb_delete->Recordset->EOF) {
	$privatetrust_tb_delete->RecCnt++;
	$privatetrust_tb_delete->RowCnt++;

	// Set row properties
	$privatetrust_tb->ResetAttrs();
	$privatetrust_tb->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$privatetrust_tb_delete->LoadRowValues($privatetrust_tb_delete->Recordset);

	// Render row
	$privatetrust_tb_delete->RenderRow();
?>
	<tr<?php echo $privatetrust_tb->RowAttributes() ?>>
<?php if ($privatetrust_tb->willtype->Visible) { // willtype ?>
		<td<?php echo $privatetrust_tb->willtype->CellAttributes() ?>>
<span id="el<?php echo $privatetrust_tb_delete->RowCnt ?>_privatetrust_tb_willtype" class="control-group privatetrust_tb_willtype">
...
<span id="el<?php echo $privatetrust_tb_delete->RowCnt ?>_privatetrust_tb_fullname" class="control-group privatetrust_tb_fullname">
...
<span id="el<?php echo $privatetrust_tb_delete->RowCnt ?>_privatetrust_tb__email" class="control-group privatetrust_tb__email">
...
<span id="el<?php echo $privatetrust_tb_delete->RowCnt ?>_privatetrust_tb_phoneno" class="control-group privatetrust_tb_phoneno">
...
<span id="el<?php echo $privatetrust_tb_delete->RowCnt ?>_privatetrust_tb_aphoneno" class="control-group privatetrust_tb_aphoneno">
...
<span id="el<?php echo $privatetrust_tb_delete->RowCnt ?>_privatetrust_tb_gender" class="control-group privatetrust_tb_gender">
...
<span id="el<?php echo $privatetrust_tb_delete->RowCnt ?>_privatetrust_tb_dob" class="control-group privatetrust_tb_dob">
...
<span id="el<?php echo $privatetrust_tb_delete->RowCnt ?>_privatetrust_tb_state" class="control-group privatetrust_tb_state">
...
<span id="el<?php echo $privatetrust_tb_delete->RowCnt ?>_privatetrust_tb_nationality" class="control-group privatetrust_tb_nationality">
...
<span id="el<?php echo $privatetrust_tb_delete->RowCnt ?>_privatetrust_tb_employmentstatus" class="control-group privatetrust_tb_employmentstatus">
...
<span id="el<?php echo $privatetrust_tb_delete->RowCnt ?>_privatetrust_tb_maritalstatus" class="control-group privatetrust_tb_maritalstatus">
...
<span id="el<?php echo $privatetrust_tb_delete->RowCnt ?>_privatetrust_tb_datecreated" class="control-group privatetrust_tb_datecreated">
...
<?php
	$privatetrust_tb_delete->Recordset->MoveNext();
}
$privatetrust_tb_delete->Recordset->Close();
?>
</tbody>
...
<script type="text/javascript">
fprivatetrust_tbdelete.Init();
</script>
<?php
$privatetrust_tb_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$privatetrust_tb_delete->Page_Terminate();
?>
