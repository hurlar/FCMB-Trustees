...
$reservetrust_tb_view = NULL; // Initialize page object first

class creservetrust_tb_view extends creservetrust_tb {
	...
	// Page object name
	var $PageObjName = 'reservetrust_tb_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "reservetrust_tblist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "reservetrust_tblist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_reservetrust_tb\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_reservetrust_tb',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.freservetrust_tbview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($reservetrust_tb_view)) $reservetrust_tb_view = new creservetrust_tb_view();

// Page init
$reservetrust_tb_view->Page_Init();

// Page main
$reservetrust_tb_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$reservetrust_tb_view->Page_Render();
?>
<?php include_once "header.php" ?>
<?php if ($reservetrust_tb->Export == "") { ?>
<script type="text/javascript">

// Page object
var reservetrust_tb_view = new ew_Page("reservetrust_tb_view");
reservetrust_tb_view.PageID = "view"; // Page ID
var EW_PAGE_ID = reservetrust_tb_view.PageID; // For backward compatibility

// Form object
var freservetrust_tbview = new ew_Form("freservetrust_tbview");

// Form_CustomValidate event
freservetrust_tbview.Form_CustomValidate = 
...
freservetrust_tbview.ValidateRequired = true;
<?php } else { ?>
freservetrust_tbview.ValidateRequired = false; 
<?php } ?>
...
<?php $reservetrust_tb_view->ExportOptions->Render("body") ?>
<?php if (!$reservetrust_tb_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($reservetrust_tb_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $reservetrust_tb_view->ShowPageHeader(); ?>
<?php
$reservetrust_tb_view->ShowMessage();
?>
<form name="freservetrust_tbview" id="freservetrust_tbview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="reservetrust_tb">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_reservetrust_tbview" class="table table-bordered table-striped">
...
<?php echo $reservetrust_tb->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->uid->ViewAttributes() ?>>
<?php echo $reservetrust_tb->uid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->willtype->ViewAttributes() ?>>
<?php echo $reservetrust_tb->willtype->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->fullname->ViewAttributes() ?>>
<?php echo $reservetrust_tb->fullname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->address->ViewAttributes() ?>>
<?php echo $reservetrust_tb->address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->_email->ViewAttributes() ?>>
<?php echo $reservetrust_tb->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->phoneno->ViewAttributes() ?>>
<?php echo $reservetrust_tb->phoneno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->aphoneno->ViewAttributes() ?>>
<?php echo $reservetrust_tb->aphoneno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->gender->ViewAttributes() ?>>
<?php echo $reservetrust_tb->gender->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->dob->ViewAttributes() ?>>
<?php echo $reservetrust_tb->dob->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->state->ViewAttributes() ?>>
<?php echo $reservetrust_tb->state->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->nationality->ViewAttributes() ?>>
<?php echo $reservetrust_tb->nationality->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->lga->ViewAttributes() ?>>
<?php echo $reservetrust_tb->lga->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->employmentstatus->ViewAttributes() ?>>
<?php echo $reservetrust_tb->employmentstatus->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->employer->ViewAttributes() ?>>
<?php echo $reservetrust_tb->employer->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->employerphone->ViewAttributes() ?>>
<?php echo $reservetrust_tb->employerphone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->employeraddr->ViewAttributes() ?>>
<?php echo $reservetrust_tb->employeraddr->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->maritalstatus->ViewAttributes() ?>>
<?php echo $reservetrust_tb->maritalstatus->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->marriagetype->ViewAttributes() ?>>
<?php echo $reservetrust_tb->marriagetype->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->marriageyear->ViewAttributes() ?>>
<?php echo $reservetrust_tb->marriageyear->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->marriagecert->ViewAttributes() ?>>
<?php echo $reservetrust_tb->marriagecert->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->divorce->ViewAttributes() ?>>
<?php echo $reservetrust_tb->divorce->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->divorceyear->ViewAttributes() ?>>
<?php echo $reservetrust_tb->divorceyear->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->datecreated->ViewAttributes() ?>>
<?php echo $reservetrust_tb->datecreated->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->maidenname->ViewAttributes() ?>>
<?php echo $reservetrust_tb->maidenname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->identificationtype->ViewAttributes() ?>>
<?php echo $reservetrust_tb->identificationtype->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->idnumber->ViewAttributes() ?>>
<?php echo $reservetrust_tb->idnumber->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->issuedate->ViewAttributes() ?>>
<?php echo $reservetrust_tb->issuedate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->expirydate->ViewAttributes() ?>>
<?php echo $reservetrust_tb->expirydate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->issueplace->ViewAttributes() ?>>
<?php echo $reservetrust_tb->issueplace->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->spousename->ViewAttributes() ?>>
<?php echo $reservetrust_tb->spousename->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->spouseemail->ViewAttributes() ?>>
<?php echo $reservetrust_tb->spouseemail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->spousephone->ViewAttributes() ?>>
<?php echo $reservetrust_tb->spousephone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->spousedob->ViewAttributes() ?>>
<?php echo $reservetrust_tb->spousedob->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->spouseaddr->ViewAttributes() ?>>
<?php echo $reservetrust_tb->spouseaddr->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->spousecity->ViewAttributes() ?>>
<?php echo $reservetrust_tb->spousecity->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->spousestate->ViewAttributes() ?>>
<?php echo $reservetrust_tb->spousestate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->cityofmarriage->ViewAttributes() ?>>
<?php echo $reservetrust_tb->cityofmarriage->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->countryofmarriage->ViewAttributes() ?>>
<?php echo $reservetrust_tb->countryofmarriage->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->nextofkinfullname->ViewAttributes() ?>>
<?php echo $reservetrust_tb->nextofkinfullname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->nextofkintelephone->ViewAttributes() ?>>
<?php echo $reservetrust_tb->nextofkintelephone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->nextofkinemail->ViewAttributes() ?>>
<?php echo $reservetrust_tb->nextofkinemail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->nextofkinaddress->ViewAttributes() ?>>
<?php echo $reservetrust_tb->nextofkinaddress->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->nameofcompany->ViewAttributes() ?>>
<?php echo $reservetrust_tb->nameofcompany->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->humanresourcescontacttelephone->ViewAttributes() ?>>
<?php echo $reservetrust_tb->humanresourcescontacttelephone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $reservetrust_tb->humanresourcescontactemailaddress->ViewAttributes() ?>>
<?php echo $reservetrust_tb->humanresourcescontactemailaddress->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<table class="ewPager">
<tr><td>
<?php if (!isset($reservetrust_tb_view->Pager)) $reservetrust_tb_view->Pager = new cNumericPager($reservetrust_tb_view->StartRec, $reservetrust_tb_view->DisplayRecs, $reservetrust_tb_view->TotalRecs, $reservetrust_tb_view->RecRange) ?>
<?php if ($reservetrust_tb_view->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($reservetrust_tb_view->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $reservetrust_tb_view->PageUrl() ?>start=<?php echo $reservetrust_tb_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($reservetrust_tb_view->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $reservetrust_tb_view->PageUrl() ?>start=<?php echo $reservetrust_tb_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($reservetrust_tb_view->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $reservetrust_tb_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($reservetrust_tb_view->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $reservetrust_tb_view->PageUrl() ?>start=<?php echo $reservetrust_tb_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($reservetrust_tb_view->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $reservetrust_tb_view->PageUrl() ?>start=<?php echo $reservetrust_tb_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
...
<script type="text/javascript">
freservetrust_tbview.Init();
</script>
<?php
$reservetrust_tb_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($reservetrust_tb->Export == "") { ?>
...
<?php
$reservetrust_tb_view->Page_Terminate();
?>
