...
$simplewill_assets_tb_grid = NULL; // Initialize page object first

class csimplewill_assets_tb_grid extends csimplewill_assets_tb {
	...
	// Page object name
	var $PageObjName = 'simplewill_assets_tb_grid';

	// Grid form hidden field names
	var $FormName = 'fsimplewill_assets_tbgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["simplewill_assets_tb"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_bankname") && $objForm->HasValue("o_bankname") && $this->bankname->CurrentValue <> $this->bankname->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_pension_admin") && $objForm->HasValue("o_pension_admin") && $this->pension_admin->CurrentValue <> $this->pension_admin->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->pension_admin->setOldValue($objForm->GetValue("o_pension_admin"));
