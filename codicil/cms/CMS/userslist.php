...
class cusers_list extends cusers {
	...
	function BasicSearchSQL($Keyword) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->locale, $Keyword);
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->created, $bCtrl); // created
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" href=\"\" onclick=\"ew_SubmitSelected(document.fuserslist, '" . $this->MultiDeleteUrl . "', ewLanguage.Phrase('DeleteMultiConfirmMsg'));return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->IsLoggedIn());
...
<?php if ($users->fname->Visible) { // fname ?>
	<?php if ($users->SortUrl($users->fname) == "") { ?>
		<td><div id="elh_users_fname" class="users_fname"><div class="ewTableHeaderCaption"><?php echo $users->fname->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->fname) ?>',2);"><div id="elh_users_fname" class="users_fname">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->fname->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($users->fname->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->fname->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($users->lname->Visible) { // lname ?>
	<?php if ($users->SortUrl($users->lname) == "") { ?>
		<td><div id="elh_users_lname" class="users_lname"><div class="ewTableHeaderCaption"><?php echo $users->lname->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->lname) ?>',2);"><div id="elh_users_lname" class="users_lname">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->lname->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($users->lname->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->lname->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($users->_email->Visible) { // email ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->_email) ?>',2);"><div id="elh_users__email" class="users__email">
...
<?php if ($users->phone->Visible) { // phone ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->phone) ?>',2);"><div id="elh_users_phone" class="users_phone">
...
<?php if ($users->gender->Visible) { // gender ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->gender) ?>',2);"><div id="elh_users_gender" class="users_gender">
...
<?php if ($users->created->Visible) { // created ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->created) ?>',2);"><div id="elh_users_created" class="users_created">
...
<span<?php echo $users->fname->ViewAttributes() ?>>
<?php echo $users->fname->ListViewValue() ?></span>
<a id="<?php echo $users_list->PageObjName . "_row_" . $users_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($users->lname->Visible) { // lname ?>
		<td<?php echo $users->lname->CellAttributes() ?>>
<span<?php echo $users->lname->ViewAttributes() ?>>
<?php echo $users->lname->ListViewValue() ?></span>
<a id="<?php echo $users_list->PageObjName . "_row_" . $users_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($users->_email->Visible) { // email ?>
...
<option value="25"<?php if ($users_list->DisplayRecs == 25) { ?> selected="selected"<?php } ?>>25</option>
...
<option value="200"<?php if ($users_list->DisplayRecs == 200) { ?> selected="selected"<?php } ?>>200</option>
<option value="500"<?php if ($users_list->DisplayRecs == 500) { ?> selected="selected"<?php } ?>>500</option>
