...
$addinfo_tb_grid = NULL; // Initialize page object first

class caddinfo_tb_grid extends caddinfo_tb {
	...
	// Page object name
	var $PageObjName = 'addinfo_tb_grid';

	// Grid form hidden field names
	var $FormName = 'faddinfo_tbgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["addinfo_tb"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_uid") && $objForm->HasValue("o_uid") && $this->uid->CurrentValue <> $this->uid->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_addinfo") && $objForm->HasValue("o_addinfo") && $this->addinfo->CurrentValue <> $this->addinfo->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->addinfo->setOldValue($objForm->GetValue("o_addinfo"));
