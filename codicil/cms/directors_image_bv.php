...
$directors_image_blobview = NULL; // Initialize page object first

class cdirectors_image_blobview extends cdirectors {
	...
	// Page object name
	var $PageObjName = 'directors_image_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('directors', 'x_image');
...
// Create page object
if (!isset($directors_image_blobview)) $directors_image_blobview = new cdirectors_image_blobview();

// Page init
$directors_image_blobview->Page_Init();

// Page main
$directors_image_blobview->Page_Main();
?>
<?php
$directors_image_blobview->Page_Terminate();
?>
