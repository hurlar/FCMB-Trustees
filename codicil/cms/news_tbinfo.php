...
//
// Table class for news_tb
//
class cnews_tb extends cTable {
	var $id;
	var $title;
	var $content;
	var $postdate;
	...
	function __construct() {
		...
		$this->TableVar = 'news_tb';
		$this->TableName = 'news_tb';
		...
		// id
		$this->id = new cField('news_tb', 'news_tb', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// title
		$this->title = new cField('news_tb', 'news_tb', 'x_title', 'title', '`title`', '`title`', 200, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['title'] = &$this->title;

		// content
		$this->content = new cField('news_tb', 'news_tb', 'x_content', 'content', '`content`', '`content`', 201, -1, FALSE, '`content`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['content'] = &$this->content;

		// postdate
		$this->postdate = new cField('news_tb', 'news_tb', 'x_postdate', 'postdate', '`postdate`', 'DATE_FORMAT(`postdate`, \'%d/%m/%y\')', 133, -1, FALSE, '`postdate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->postdate->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['postdate'] = &$this->postdate;

		// img
		$this->img = new cField('news_tb', 'news_tb', 'x_img', 'img', '`img`', '`img`', 200, -1, TRUE, '`img`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['img'] = &$this->img;

		// pg_url
		$this->pg_url = new cField('news_tb', 'news_tb', 'x_pg_url', 'pg_url', '`pg_url`', '`pg_url`', 200, -1, FALSE, '`pg_url`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pg_url'] = &$this->pg_url;

		// rate_ord
		$this->rate_ord = new cField('news_tb', 'news_tb', 'x_rate_ord', 'rate_ord', '`rate_ord`', '`rate_ord`', 202, -1, FALSE, '`rate_ord`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['rate_ord'] = &$this->rate_ord;

		// datep
		$this->datep = new cField('news_tb', 'news_tb', 'x_datep', 'datep', '`datep`', 'DATE_FORMAT(`datep`, \'%d/%m/%y\')', 135, -1, FALSE, '`datep`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['datep'] = &$this->datep;

		// venue
		$this->venue = new cField('news_tb', 'news_tb', 'x_venue', 'venue', '`venue`', '`venue`', 200, -1, FALSE, '`venue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['venue'] = &$this->venue;

		// time
		$this->time = new cField('news_tb', 'news_tb', 'x_time', 'time', '`time`', '`time`', 200, -1, FALSE, '`time`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("news_tbview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("news_tbview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "news_tbadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("news_tbedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("news_tbadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("news_tbdelete.php", $this->UrlParm());
	}
