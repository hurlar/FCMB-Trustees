...
class cproducts_add extends cproducts {
	...
	function LoadDefaultValues() {
		...
		$this->sized->CurrentValue = NULL;
		$this->sized->OldValue = $this->sized->CurrentValue;
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->img2);
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->img3);
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->img4);
	...
	function AddRow($rsold = NULL) {
		...
		// rate_ord
		$this->rate_ord->SetDbValueDef($rsnew, $this->rate_ord->CurrentValue, "", strval($this->rate_ord->CurrentValue) == "");
		...
		// sized
		$this->sized->SetDbValueDef($rsnew, $this->sized->CurrentValue, NULL, FALSE);
...
// Form object
var fproductsadd = new ew_Form("fproductsadd");
...
fproductsadd.MultiPage = new ew_MultiPage("fproductsadd",
	[["x_price",1],["x_img2",2],["x_img3",2],["x_img4",2],["x_rate_ord",1],["x_oldprice",1],["x_product_code",1],["x_product_name",1],["x_product_desc",1],["x_product_img_name",1],["x_img1",1],["x_cat",1],["x_sized",1],["x_subcat",1],["x_sales_status",1]]
);
...
?>
<form name="fproductsadd" id="fproductsadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="products">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewStdTable"><tbody><tr><td>
<div class="tabbable" id="products_add">
...
<table id="tbl_productsadd1" class="table table-bordered table-striped">
...
<table cellspacing="0" class="ewGrid" style="width: 100%"><tr><td>
<table id="tbl_productsadd2" class="table table-bordered table-striped">
