...
$premiumwill_tb_view = NULL; // Initialize page object first

class cpremiumwill_tb_view extends cpremiumwill_tb {
	...
	// Page object name
	var $PageObjName = 'premiumwill_tb_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "premiumwill_tblist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "premiumwill_tblist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupOtherOptions() {
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("personal_infolist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("spouse_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("divorce_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("children_detailslist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("beneficiary_dumplist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("alt_beneficiarylist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("assets_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("overall_assetlist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("executor_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("trustee_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("witness_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("addinfo_tblist.php?" . EW_TABLE_SHOW_MASTER . "=premiumwill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_premiumwill_tb\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_premiumwill_tb',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fpremiumwill_tbview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($premiumwill_tb_view)) $premiumwill_tb_view = new cpremiumwill_tb_view();

// Page init
$premiumwill_tb_view->Page_Init();

// Page main
$premiumwill_tb_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$premiumwill_tb_view->Page_Render();
?>
...
// Page object
var premiumwill_tb_view = new ew_Page("premiumwill_tb_view");
premiumwill_tb_view.PageID = "view"; // Page ID
var EW_PAGE_ID = premiumwill_tb_view.PageID; // For backward compatibility

// Form object
var fpremiumwill_tbview = new ew_Form("fpremiumwill_tbview");

// Form_CustomValidate event
fpremiumwill_tbview.Form_CustomValidate = 
...
fpremiumwill_tbview.ValidateRequired = true;
<?php } else { ?>
fpremiumwill_tbview.ValidateRequired = false; 
<?php } ?>
...
<?php $premiumwill_tb_view->ExportOptions->Render("body") ?>
<?php if (!$premiumwill_tb_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($premiumwill_tb_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $premiumwill_tb_view->ShowPageHeader(); ?>
<?php
$premiumwill_tb_view->ShowMessage();
?>
<form name="fpremiumwill_tbview" id="fpremiumwill_tbview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="premiumwill_tb">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_premiumwill_tbview" class="table table-bordered table-striped">
...
<?php echo $premiumwill_tb->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->uid->ViewAttributes() ?>>
<?php echo $premiumwill_tb->uid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $premiumwill_tb->willtype->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if (!ew_EmptyStr($premiumwill_tb->fullname->ViewValue) && $premiumwill_tb->fullname->LinkAttributes() <> "") { ?>
<a<?php echo $premiumwill_tb->fullname->LinkAttributes() ?>><?php echo $premiumwill_tb->fullname->ViewValue ?></a>
<?php } else { ?>
<?php echo $premiumwill_tb->fullname->ViewValue ?>
<?php } ?>
</span>
</span>
</td>
...
<span<?php echo $premiumwill_tb->address->ViewAttributes() ?>>
<?php echo $premiumwill_tb->address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $premiumwill_tb->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $premiumwill_tb->phoneno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $premiumwill_tb->aphoneno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $premiumwill_tb->gender->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $premiumwill_tb->dob->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $premiumwill_tb->state->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->nationality->ViewAttributes() ?>>
<?php echo $premiumwill_tb->nationality->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->lga->ViewAttributes() ?>>
<?php echo $premiumwill_tb->lga->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $premiumwill_tb->employmentstatus->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->employer->ViewAttributes() ?>>
<?php echo $premiumwill_tb->employer->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->employerphone->ViewAttributes() ?>>
<?php echo $premiumwill_tb->employerphone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->employeraddr->ViewAttributes() ?>>
<?php echo $premiumwill_tb->employeraddr->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $premiumwill_tb->maritalstatus->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->spname->ViewAttributes() ?>>
<?php echo $premiumwill_tb->spname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->spemail->ViewAttributes() ?>>
<?php echo $premiumwill_tb->spemail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->spphone->ViewAttributes() ?>>
<?php echo $premiumwill_tb->spphone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->sdob->ViewAttributes() ?>>
<?php echo $premiumwill_tb->sdob->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->spaddr->ViewAttributes() ?>>
<?php echo $premiumwill_tb->spaddr->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->spcity->ViewAttributes() ?>>
<?php echo $premiumwill_tb->spcity->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->spstate->ViewAttributes() ?>>
<?php echo $premiumwill_tb->spstate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->marriagetype->ViewAttributes() ?>>
<?php echo $premiumwill_tb->marriagetype->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->marriageyear->ViewAttributes() ?>>
<?php echo $premiumwill_tb->marriageyear->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->marriagecert->ViewAttributes() ?>>
<?php echo $premiumwill_tb->marriagecert->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->marriagecity->ViewAttributes() ?>>
<?php echo $premiumwill_tb->marriagecity->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->marriagecountry->ViewAttributes() ?>>
<?php echo $premiumwill_tb->marriagecountry->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->divorce->ViewAttributes() ?>>
<?php echo $premiumwill_tb->divorce->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->divorceyear->ViewAttributes() ?>>
<?php echo $premiumwill_tb->divorceyear->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $premiumwill_tb->addinfo->ViewAttributes() ?>>
<?php echo $premiumwill_tb->addinfo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $premiumwill_tb->datecreated->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<table class="ewPager">
<tr><td>
<?php if (!isset($premiumwill_tb_view->Pager)) $premiumwill_tb_view->Pager = new cNumericPager($premiumwill_tb_view->StartRec, $premiumwill_tb_view->DisplayRecs, $premiumwill_tb_view->TotalRecs, $premiumwill_tb_view->RecRange) ?>
<?php if ($premiumwill_tb_view->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($premiumwill_tb_view->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $premiumwill_tb_view->PageUrl() ?>start=<?php echo $premiumwill_tb_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($premiumwill_tb_view->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $premiumwill_tb_view->PageUrl() ?>start=<?php echo $premiumwill_tb_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($premiumwill_tb_view->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $premiumwill_tb_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($premiumwill_tb_view->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $premiumwill_tb_view->PageUrl() ?>start=<?php echo $premiumwill_tb_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($premiumwill_tb_view->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $premiumwill_tb_view->PageUrl() ?>start=<?php echo $premiumwill_tb_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
...
<?php } ?>
<?php
	if (in_array("personal_info", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $personal_info->DetailView) {
?>
<?php include_once "personal_infogrid.php" ?>
<?php } ?>
<?php
	if (in_array("spouse_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $spouse_tb->DetailView) {
?>
<?php include_once "spouse_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("divorce_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $divorce_tb->DetailView) {
?>
<?php include_once "divorce_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("children_details", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $children_details->DetailView) {
?>
<?php include_once "children_detailsgrid.php" ?>
<?php } ?>
<?php
	if (in_array("beneficiary_dump", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $beneficiary_dump->DetailView) {
?>
<?php include_once "beneficiary_dumpgrid.php" ?>
<?php } ?>
<?php
	if (in_array("alt_beneficiary", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $alt_beneficiary->DetailView) {
?>
<?php include_once "alt_beneficiarygrid.php" ?>
<?php } ?>
<?php
	if (in_array("assets_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $assets_tb->DetailView) {
?>
<?php include_once "assets_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("overall_asset", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $overall_asset->DetailView) {
?>
<?php include_once "overall_assetgrid.php" ?>
<?php } ?>
<?php
	if (in_array("executor_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $executor_tb->DetailView) {
?>
<?php include_once "executor_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("trustee_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $trustee_tb->DetailView) {
?>
<?php include_once "trustee_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("witness_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $witness_tb->DetailView) {
?>
<?php include_once "witness_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("addinfo_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $addinfo_tb->DetailView) {
?>
<?php include_once "addinfo_tbgrid.php" ?>
<?php } ?>
</form>
<script type="text/javascript">
fpremiumwill_tbview.Init();
</script>
<?php
$premiumwill_tb_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($premiumwill_tb->Export == "") { ?>
...
<?php
$premiumwill_tb_view->Page_Terminate();
?>
