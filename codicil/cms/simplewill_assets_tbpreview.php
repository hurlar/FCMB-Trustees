...
$simplewill_assets_tb_preview = NULL; // Initialize page object first

class csimplewill_assets_tb_preview extends csimplewill_assets_tb {
	...
	// Page object name
	var $PageObjName = 'simplewill_assets_tb_preview';
...
// Create page object
if (!isset($simplewill_assets_tb_preview)) $simplewill_assets_tb_preview = new csimplewill_assets_tb_preview();

// Page init
$simplewill_assets_tb_preview->Page_Init();

// Page main
$simplewill_assets_tb_preview->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$simplewill_assets_tb_preview->Page_Render();
?>
<?php $simplewill_assets_tb_preview->ShowPageHeader(); ?>
<?php if ($simplewill_assets_tb_preview->TotalRecs > 0) { ?>
...
<?php } ?>
	...
	<tbody><!-- Table body -->
<?php
$simplewill_assets_tb_preview->RecCount = 0;
$simplewill_assets_tb_preview->RowCnt = 0;
while ($simplewill_assets_tb_preview->Recordset && !$simplewill_assets_tb_preview->Recordset->EOF) {

	// Init row class and style
	$simplewill_assets_tb_preview->RecCount++;
	$simplewill_assets_tb_preview->RowCnt++;
	$simplewill_assets_tb->CssClass = "";
	$simplewill_assets_tb->CssStyle = "";
	$simplewill_assets_tb->LoadListRowValues($simplewill_assets_tb_preview->Recordset);

	// Render row
	$simplewill_assets_tb->RowType = EW_ROWTYPE_PREVIEW; // Preview record
...
<?php
	$simplewill_assets_tb_preview->Recordset->MoveNext();
}
?>
	</tbody>
</table>
...
<?php if ($simplewill_assets_tb_preview->TotalRecs > 0) { ?>
<div class="ewDetailCount">(<?php echo $simplewill_assets_tb_preview->TotalRecs ?>&nbsp;<?php echo $Language->Phrase("Record") ?>)</div>
<?php } ?>
<?php
$simplewill_assets_tb_preview->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php
	if ($simplewill_assets_tb_preview->Recordset)
		$simplewill_assets_tb_preview->Recordset->Close();
} else { ?>
...
?>
<?php
$simplewill_assets_tb_preview->Page_Terminate();
?>
