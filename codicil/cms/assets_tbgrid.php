...
<?php if ($assets_tb->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<td><div><div id="elh_assets_tb_id" class="assets_tb_id">
...
<span id="el<?php echo $assets_tb_grid->RowCnt ?>_assets_tb_id" class="control-group assets_tb_id">
...
<input type="hidden" data-field="x_id" name="x<?php echo $assets_tb_grid->RowIndex ?>_id" id="x<?php echo $assets_tb_grid->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($assets_tb->id->FormValue) ?>">
<input type="hidden" data-field="x_id" name="o<?php echo $assets_tb_grid->RowIndex ?>_id" id="o<?php echo $assets_tb_grid->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($assets_tb->id->OldValue) ?>">
<?php } ?>
...
<?php } else { ?>
<span id="el$rowindex$_assets_tb_id" class="control-group assets_tb_id">
<span<?php echo $assets_tb->id->ViewAttributes() ?>>
