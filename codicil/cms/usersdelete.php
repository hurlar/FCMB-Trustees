...
<?php if ($users->fname->Visible) { // fname ?>
		<td><span id="elh_users_fname" class="users_fname"><?php echo $users->fname->FldCaption() ?></span></td>
<?php } ?>
<?php if ($users->lname->Visible) { // lname ?>
		<td><span id="elh_users_lname" class="users_lname"><?php echo $users->lname->FldCaption() ?></span></td>
<?php } ?>
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_fname" class="control-group users_fname">
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_lname" class="control-group users_lname">
