...
// Page object
var management_delete = new ew_Page("management_delete");
management_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = management_delete.PageID; // For backward compatibility

// Form object
var fmanagementdelete = new ew_Form("fmanagementdelete");
...
fmanagementdelete.ValidateRequired = true;
<?php } else { ?>
fmanagementdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmanagementdelete.Lists["x_category"] = {"LinkField":"x_category","Ajax":null,"AutoFill":false,"DisplayFields":["x_category","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
if ($management_delete->Recordset = $management_delete->LoadRecordset())
	$management_deleteTotalRecs = $management_delete->Recordset->RecordCount(); // Get record count
if ($management_deleteTotalRecs <= 0) { // No record found, exit
	if ($management_delete->Recordset)
		$management_delete->Recordset->Close();
	$management_delete->Page_Terminate("managementlist.php"); // Return to list
}
?>
...
?>
<form name="fmanagementdelete" id="fmanagementdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_managementdelete" class="ewTable ewTableSeparate">
<?php echo $management->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($management->name->Visible) { // name ?>
		<td><span id="elh_management_name" class="management_name"><?php echo $management->name->FldCaption() ?></span></td>
<?php } ?>
<?php if ($management->position->Visible) { // position ?>
		<td><span id="elh_management_position" class="management_position"><?php echo $management->position->FldCaption() ?></span></td>
<?php } ?>
<?php if ($management->slug->Visible) { // slug ?>
		<td><span id="elh_management_slug" class="management_slug"><?php echo $management->slug->FldCaption() ?></span></td>
<?php } ?>
<?php if ($management->category->Visible) { // category ?>
		<td><span id="elh_management_category" class="management_category"><?php echo $management->category->FldCaption() ?></span></td>
<?php } ?>
<?php if ($management->rate_ord->Visible) { // rate_ord ?>
		<td><span id="elh_management_rate_ord" class="management_rate_ord"><?php echo $management->rate_ord->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $management_delete->RowCnt ?>_management_name" class="control-group management_name">
...
<span id="el<?php echo $management_delete->RowCnt ?>_management_position" class="control-group management_position">
...
<span id="el<?php echo $management_delete->RowCnt ?>_management_slug" class="control-group management_slug">
...
<span id="el<?php echo $management_delete->RowCnt ?>_management_category" class="control-group management_category">
...
<span id="el<?php echo $management_delete->RowCnt ?>_management_rate_ord" class="control-group management_rate_ord">
