...
class ccomprehensivewill_tb_view extends ccomprehensivewill_tb {
	...
	function SetupOtherOptions() {
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("personal_infolist.php?" . EW_TABLE_SHOW_MASTER . "=comprehensivewill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("spouse_tblist.php?" . EW_TABLE_SHOW_MASTER . "=comprehensivewill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("divorce_tblist.php?" . EW_TABLE_SHOW_MASTER . "=comprehensivewill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("children_detailslist.php?" . EW_TABLE_SHOW_MASTER . "=comprehensivewill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("beneficiary_dumplist.php?" . EW_TABLE_SHOW_MASTER . "=comprehensivewill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("alt_beneficiarylist.php?" . EW_TABLE_SHOW_MASTER . "=comprehensivewill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("assets_tblist.php?" . EW_TABLE_SHOW_MASTER . "=comprehensivewill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("overall_assetlist.php?" . EW_TABLE_SHOW_MASTER . "=comprehensivewill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("executor_tblist.php?" . EW_TABLE_SHOW_MASTER . "=comprehensivewill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("trustee_tblist.php?" . EW_TABLE_SHOW_MASTER . "=comprehensivewill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("witness_tblist.php?" . EW_TABLE_SHOW_MASTER . "=comprehensivewill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
		...
		$body = "<a class=\"ewAction ewDetailList\" href=\"" . ew_HtmlEncode("addinfo_tblist.php?" . EW_TABLE_SHOW_MASTER . "=comprehensivewill_tb&uid=" . strval($this->uid->CurrentValue) . "") . "\">" . $body . "</a>";
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			if (!ew_Empty($this->uid->CurrentValue)) {
				$this->fullname->HrefValue = "../portal/admincomprehensivewill-preview.php?a=" . ((!empty($this->uid->ViewValue)) ? $this->uid->ViewValue : $this->uid->CurrentValue); // Add prefix/suffix
...
<?php if (!ew_EmptyStr($comprehensivewill_tb->fullname->ViewValue) && $comprehensivewill_tb->fullname->LinkAttributes() <> "") { ?>
<a<?php echo $comprehensivewill_tb->fullname->LinkAttributes() ?>><?php echo $comprehensivewill_tb->fullname->ViewValue ?></a>
<?php } else { ?>
<?php echo $comprehensivewill_tb->fullname->ViewValue ?>
<?php } ?>
</span>
</span>
</td>
...
<?php } ?>
<?php
	if (in_array("personal_info", explode(",", $comprehensivewill_tb->getCurrentDetailTable())) && $personal_info->DetailView) {
?>
<?php include_once "personal_infogrid.php" ?>
<?php } ?>
<?php
	if (in_array("spouse_tb", explode(",", $comprehensivewill_tb->getCurrentDetailTable())) && $spouse_tb->DetailView) {
?>
<?php include_once "spouse_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("divorce_tb", explode(",", $comprehensivewill_tb->getCurrentDetailTable())) && $divorce_tb->DetailView) {
?>
<?php include_once "divorce_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("children_details", explode(",", $comprehensivewill_tb->getCurrentDetailTable())) && $children_details->DetailView) {
?>
<?php include_once "children_detailsgrid.php" ?>
<?php } ?>
<?php
	if (in_array("beneficiary_dump", explode(",", $comprehensivewill_tb->getCurrentDetailTable())) && $beneficiary_dump->DetailView) {
?>
<?php include_once "beneficiary_dumpgrid.php" ?>
<?php } ?>
<?php
	if (in_array("alt_beneficiary", explode(",", $comprehensivewill_tb->getCurrentDetailTable())) && $alt_beneficiary->DetailView) {
?>
<?php include_once "alt_beneficiarygrid.php" ?>
<?php } ?>
<?php
	if (in_array("assets_tb", explode(",", $comprehensivewill_tb->getCurrentDetailTable())) && $assets_tb->DetailView) {
?>
<?php include_once "assets_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("overall_asset", explode(",", $comprehensivewill_tb->getCurrentDetailTable())) && $overall_asset->DetailView) {
?>
<?php include_once "overall_assetgrid.php" ?>
<?php } ?>
<?php
	if (in_array("executor_tb", explode(",", $comprehensivewill_tb->getCurrentDetailTable())) && $executor_tb->DetailView) {
?>
<?php include_once "executor_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("trustee_tb", explode(",", $comprehensivewill_tb->getCurrentDetailTable())) && $trustee_tb->DetailView) {
?>
<?php include_once "trustee_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("witness_tb", explode(",", $comprehensivewill_tb->getCurrentDetailTable())) && $witness_tb->DetailView) {
?>
<?php include_once "witness_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("addinfo_tb", explode(",", $comprehensivewill_tb->getCurrentDetailTable())) && $addinfo_tb->DetailView) {
?>
