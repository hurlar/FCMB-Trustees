...
class cfaq_view extends cfaq {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_faq\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_faq',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.ffaqview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
ffaqview.Lists["x_category"] = {"LinkField":"x_category","Ajax":null,"AutoFill":false,"DisplayFields":["x_category","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if (!$faq_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="ffaqview" id="ffaqview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="faq">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_faqview" class="table table-bordered table-striped">
<?php if ($faq->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_faq_id"><?php echo $faq->id->FldCaption() ?></span></td>
		<td<?php echo $faq->id->CellAttributes() ?>>
<span id="el_faq_id" class="control-group">
...
<span<?php echo $faq->content->ViewAttributes() ?>>
<?php echo $faq->content->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $faq->category->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($faq->rate_ord->Visible) { // rate_ord ?>
	<tr id="r_rate_ord">
		<td><span id="elh_faq_rate_ord"><?php echo $faq->rate_ord->FldCaption() ?></span></td>
...
<?php echo $faq->rate_ord->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
