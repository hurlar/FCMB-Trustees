...
//
// Table class for premiumwill_tb
//
class cpremiumwill_tb extends cTable {
	var $id;
	var $uid;
	var $willtype;
	var $fullname;
	...
	function __construct() {
		...
		$this->TableVar = 'premiumwill_tb';
		$this->TableName = 'premiumwill_tb';
		...
		// id
		$this->id = new cField('premiumwill_tb', 'premiumwill_tb', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// uid
		$this->uid = new cField('premiumwill_tb', 'premiumwill_tb', 'x_uid', 'uid', '`uid`', '`uid`', 3, -1, FALSE, '`uid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->uid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['uid'] = &$this->uid;

		// willtype
		$this->willtype = new cField('premiumwill_tb', 'premiumwill_tb', 'x_willtype', 'willtype', '`willtype`', '`willtype`', 200, -1, FALSE, '`willtype`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['willtype'] = &$this->willtype;

		// fullname
		$this->fullname = new cField('premiumwill_tb', 'premiumwill_tb', 'x_fullname', 'fullname', '`fullname`', '`fullname`', 200, -1, FALSE, '`fullname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['fullname'] = &$this->fullname;

		// address
		$this->address = new cField('premiumwill_tb', 'premiumwill_tb', 'x_address', 'address', '`address`', '`address`', 201, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['address'] = &$this->address;

		// email
		$this->_email = new cField('premiumwill_tb', 'premiumwill_tb', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['email'] = &$this->_email;

		// phoneno
		$this->phoneno = new cField('premiumwill_tb', 'premiumwill_tb', 'x_phoneno', 'phoneno', '`phoneno`', '`phoneno`', 200, -1, FALSE, '`phoneno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['phoneno'] = &$this->phoneno;

		// aphoneno
		$this->aphoneno = new cField('premiumwill_tb', 'premiumwill_tb', 'x_aphoneno', 'aphoneno', '`aphoneno`', '`aphoneno`', 200, -1, FALSE, '`aphoneno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['aphoneno'] = &$this->aphoneno;

		// gender
		$this->gender = new cField('premiumwill_tb', 'premiumwill_tb', 'x_gender', 'gender', '`gender`', '`gender`', 200, -1, FALSE, '`gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['gender'] = &$this->gender;

		// dob
		$this->dob = new cField('premiumwill_tb', 'premiumwill_tb', 'x_dob', 'dob', '`dob`', '`dob`', 200, -1, FALSE, '`dob`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['dob'] = &$this->dob;

		// state
		$this->state = new cField('premiumwill_tb', 'premiumwill_tb', 'x_state', 'state', '`state`', '`state`', 200, -1, FALSE, '`state`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['state'] = &$this->state;

		// nationality
		$this->nationality = new cField('premiumwill_tb', 'premiumwill_tb', 'x_nationality', 'nationality', '`nationality`', '`nationality`', 200, -1, FALSE, '`nationality`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nationality'] = &$this->nationality;

		// lga
		$this->lga = new cField('premiumwill_tb', 'premiumwill_tb', 'x_lga', 'lga', '`lga`', '`lga`', 200, -1, FALSE, '`lga`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['lga'] = &$this->lga;

		// employmentstatus
		$this->employmentstatus = new cField('premiumwill_tb', 'premiumwill_tb', 'x_employmentstatus', 'employmentstatus', '`employmentstatus`', '`employmentstatus`', 200, -1, FALSE, '`employmentstatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['employmentstatus'] = &$this->employmentstatus;

		// employer
		$this->employer = new cField('premiumwill_tb', 'premiumwill_tb', 'x_employer', 'employer', '`employer`', '`employer`', 201, -1, FALSE, '`employer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['employer'] = &$this->employer;

		// employerphone
		$this->employerphone = new cField('premiumwill_tb', 'premiumwill_tb', 'x_employerphone', 'employerphone', '`employerphone`', '`employerphone`', 200, -1, FALSE, '`employerphone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['employerphone'] = &$this->employerphone;

		// employeraddr
		$this->employeraddr = new cField('premiumwill_tb', 'premiumwill_tb', 'x_employeraddr', 'employeraddr', '`employeraddr`', '`employeraddr`', 201, -1, FALSE, '`employeraddr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['employeraddr'] = &$this->employeraddr;

		// maritalstatus
		$this->maritalstatus = new cField('premiumwill_tb', 'premiumwill_tb', 'x_maritalstatus', 'maritalstatus', '`maritalstatus`', '`maritalstatus`', 200, -1, FALSE, '`maritalstatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['maritalstatus'] = &$this->maritalstatus;

		// spname
		$this->spname = new cField('premiumwill_tb', 'premiumwill_tb', 'x_spname', 'spname', '`spname`', '`spname`', 200, -1, FALSE, '`spname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spname'] = &$this->spname;

		// spemail
		$this->spemail = new cField('premiumwill_tb', 'premiumwill_tb', 'x_spemail', 'spemail', '`spemail`', '`spemail`', 200, -1, FALSE, '`spemail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spemail'] = &$this->spemail;

		// spphone
		$this->spphone = new cField('premiumwill_tb', 'premiumwill_tb', 'x_spphone', 'spphone', '`spphone`', '`spphone`', 200, -1, FALSE, '`spphone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spphone'] = &$this->spphone;

		// sdob
		$this->sdob = new cField('premiumwill_tb', 'premiumwill_tb', 'x_sdob', 'sdob', '`sdob`', '`sdob`', 200, -1, FALSE, '`sdob`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['sdob'] = &$this->sdob;

		// spaddr
		$this->spaddr = new cField('premiumwill_tb', 'premiumwill_tb', 'x_spaddr', 'spaddr', '`spaddr`', '`spaddr`', 201, -1, FALSE, '`spaddr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spaddr'] = &$this->spaddr;

		// spcity
		$this->spcity = new cField('premiumwill_tb', 'premiumwill_tb', 'x_spcity', 'spcity', '`spcity`', '`spcity`', 200, -1, FALSE, '`spcity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spcity'] = &$this->spcity;

		// spstate
		$this->spstate = new cField('premiumwill_tb', 'premiumwill_tb', 'x_spstate', 'spstate', '`spstate`', '`spstate`', 200, -1, FALSE, '`spstate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['spstate'] = &$this->spstate;

		// marriagetype
		$this->marriagetype = new cField('premiumwill_tb', 'premiumwill_tb', 'x_marriagetype', 'marriagetype', '`marriagetype`', '`marriagetype`', 200, -1, FALSE, '`marriagetype`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['marriagetype'] = &$this->marriagetype;

		// marriageyear
		$this->marriageyear = new cField('premiumwill_tb', 'premiumwill_tb', 'x_marriageyear', 'marriageyear', '`marriageyear`', '`marriageyear`', 200, -1, FALSE, '`marriageyear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['marriageyear'] = &$this->marriageyear;

		// marriagecert
		$this->marriagecert = new cField('premiumwill_tb', 'premiumwill_tb', 'x_marriagecert', 'marriagecert', '`marriagecert`', '`marriagecert`', 200, -1, FALSE, '`marriagecert`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['marriagecert'] = &$this->marriagecert;

		// marriagecity
		$this->marriagecity = new cField('premiumwill_tb', 'premiumwill_tb', 'x_marriagecity', 'marriagecity', '`marriagecity`', '`marriagecity`', 200, -1, FALSE, '`marriagecity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['marriagecity'] = &$this->marriagecity;

		// marriagecountry
		$this->marriagecountry = new cField('premiumwill_tb', 'premiumwill_tb', 'x_marriagecountry', 'marriagecountry', '`marriagecountry`', '`marriagecountry`', 200, -1, FALSE, '`marriagecountry`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['marriagecountry'] = &$this->marriagecountry;

		// divorce
		$this->divorce = new cField('premiumwill_tb', 'premiumwill_tb', 'x_divorce', 'divorce', '`divorce`', '`divorce`', 200, -1, FALSE, '`divorce`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['divorce'] = &$this->divorce;

		// divorceyear
		$this->divorceyear = new cField('premiumwill_tb', 'premiumwill_tb', 'x_divorceyear', 'divorceyear', '`divorceyear`', '`divorceyear`', 200, -1, FALSE, '`divorceyear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['divorceyear'] = &$this->divorceyear;

		// addinfo
		$this->addinfo = new cField('premiumwill_tb', 'premiumwill_tb', 'x_addinfo', 'addinfo', '`addinfo`', '`addinfo`', 201, -1, FALSE, '`addinfo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['addinfo'] = &$this->addinfo;

		// datecreated
		$this->datecreated = new cField('premiumwill_tb', 'premiumwill_tb', 'x_datecreated', 'datecreated', '`datecreated`', 'DATE_FORMAT(`datecreated`, \'%d/%m/%y\')', 135, -1, FALSE, '`datecreated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetDetailUrl() {
		...
		if ($sDetailUrl == "") {
			$sDetailUrl = "premiumwill_tblist.php";
		}
		return $sDetailUrl;
	}
	...
	// Update Table
	var $UpdateTable = "`premiumwill_tb`";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("premiumwill_tbview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("premiumwill_tbview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "premiumwill_tbadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("premiumwill_tbedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("premiumwill_tbedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("premiumwill_tbadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("premiumwill_tbadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("premiumwill_tbdelete.php", $this->UrlParm());
	}
