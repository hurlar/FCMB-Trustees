...
<?php if ($beneficiary_dump->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<td><div><div id="elh_beneficiary_dump_id" class="beneficiary_dump_id">
...
<?php if ($beneficiary_dump->childid->Visible) { // childid ?>
	...
	<?php } else { ?>
		<td><div><div id="elh_beneficiary_dump_childid" class="beneficiary_dump_childid">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $beneficiary_dump->childid->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($beneficiary_dump->childid->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($beneficiary_dump->childid->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
...
<span id="el<?php echo $beneficiary_dump_grid->RowCnt ?>_beneficiary_dump_id" class="control-group beneficiary_dump_id">
...
<input type="hidden" data-field="x_id" name="x<?php echo $beneficiary_dump_grid->RowIndex ?>_id" id="x<?php echo $beneficiary_dump_grid->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($beneficiary_dump->id->FormValue) ?>">
<input type="hidden" data-field="x_id" name="o<?php echo $beneficiary_dump_grid->RowIndex ?>_id" id="o<?php echo $beneficiary_dump_grid->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($beneficiary_dump->id->OldValue) ?>">
<?php } ?>
...
<?php if ($beneficiary_dump->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $beneficiary_dump_grid->RowCnt ?>_beneficiary_dump_childid" class="control-group beneficiary_dump_childid">
<input type="text" data-field="x_childid" name="x<?php echo $beneficiary_dump_grid->RowIndex ?>_childid" id="x<?php echo $beneficiary_dump_grid->RowIndex ?>_childid" size="30" maxlength="10" placeholder="<?php echo $beneficiary_dump->childid->PlaceHolder ?>" value="<?php echo $beneficiary_dump->childid->EditValue ?>"<?php echo $beneficiary_dump->childid->EditAttributes() ?>>
</span>
<input type="hidden" data-field="x_childid" name="o<?php echo $beneficiary_dump_grid->RowIndex ?>_childid" id="o<?php echo $beneficiary_dump_grid->RowIndex ?>_childid" value="<?php echo ew_HtmlEncode($beneficiary_dump->childid->OldValue) ?>">
<?php } ?>
<?php if ($beneficiary_dump->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $beneficiary_dump_grid->RowCnt ?>_beneficiary_dump_childid" class="control-group beneficiary_dump_childid">
<input type="text" data-field="x_childid" name="x<?php echo $beneficiary_dump_grid->RowIndex ?>_childid" id="x<?php echo $beneficiary_dump_grid->RowIndex ?>_childid" size="30" maxlength="10" placeholder="<?php echo $beneficiary_dump->childid->PlaceHolder ?>" value="<?php echo $beneficiary_dump->childid->EditValue ?>"<?php echo $beneficiary_dump->childid->EditAttributes() ?>>
...
<input type="hidden" data-field="x_childid" name="x<?php echo $beneficiary_dump_grid->RowIndex ?>_childid" id="x<?php echo $beneficiary_dump_grid->RowIndex ?>_childid" value="<?php echo ew_HtmlEncode($beneficiary_dump->childid->FormValue) ?>">
<input type="hidden" data-field="x_childid" name="o<?php echo $beneficiary_dump_grid->RowIndex ?>_childid" id="o<?php echo $beneficiary_dump_grid->RowIndex ?>_childid" value="<?php echo ew_HtmlEncode($beneficiary_dump->childid->OldValue) ?>">
<?php } ?>
<a id="<?php echo $beneficiary_dump_grid->PageObjName . "_row_" . $beneficiary_dump_grid->RowCnt ?>"></a></td>
	<?php } ?>
...
<?php } else { ?>
<span id="el$rowindex$_beneficiary_dump_id" class="control-group beneficiary_dump_id">
<span<?php echo $beneficiary_dump->id->ViewAttributes() ?>>
...
<input type="hidden" data-field="x_id" name="o<?php echo $beneficiary_dump_grid->RowIndex ?>_id" id="o<?php echo $beneficiary_dump_grid->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($beneficiary_dump->id->OldValue) ?>">
	...
	<?php if ($beneficiary_dump->childid->Visible) { // childid ?>
		<td>
<?php if ($beneficiary_dump->CurrentAction <> "F") { ?>
<span id="el$rowindex$_beneficiary_dump_childid" class="control-group beneficiary_dump_childid">
<input type="text" data-field="x_childid" name="x<?php echo $beneficiary_dump_grid->RowIndex ?>_childid" id="x<?php echo $beneficiary_dump_grid->RowIndex ?>_childid" size="30" maxlength="10" placeholder="<?php echo $beneficiary_dump->childid->PlaceHolder ?>" value="<?php echo $beneficiary_dump->childid->EditValue ?>"<?php echo $beneficiary_dump->childid->EditAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_beneficiary_dump_childid" class="control-group beneficiary_dump_childid">
