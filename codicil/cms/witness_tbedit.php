...
$witness_tb_edit = NULL; // Initialize page object first

class cwitness_tb_edit extends cwitness_tb {
	...
	// Page object name
	var $PageObjName = 'witness_tb_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// addr
			$this->addr->SetDbValueDef($rsnew, $this->addr->CurrentValue, "", $this->addr->ReadOnly);
...
// Create page object
if (!isset($witness_tb_edit)) $witness_tb_edit = new cwitness_tb_edit();

// Page init
$witness_tb_edit->Page_Init();

// Page main
$witness_tb_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$witness_tb_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var witness_tb_edit = new ew_Page("witness_tb_edit");
witness_tb_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = witness_tb_edit.PageID; // For backward compatibility

// Form object
var fwitness_tbedit = new ew_Form("fwitness_tbedit");

// Validate form
fwitness_tbedit.Validate = function() {
...
fwitness_tbedit.Form_CustomValidate = 
...
fwitness_tbedit.ValidateRequired = true;
<?php } else { ?>
fwitness_tbedit.ValidateRequired = false; 
<?php } ?>
...
<?php $witness_tb_edit->ShowPageHeader(); ?>
<?php
$witness_tb_edit->ShowMessage();
?>
<form name="fwitness_tbedit" id="fwitness_tbedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="witness_tb">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_witness_tbedit" class="table table-bordered table-striped">
...
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($witness_tb->id->CurrentValue) ?>">
<?php echo $witness_tb->id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<table class="ewPager">
<tr><td>
<?php if (!isset($witness_tb_edit->Pager)) $witness_tb_edit->Pager = new cNumericPager($witness_tb_edit->StartRec, $witness_tb_edit->DisplayRecs, $witness_tb_edit->TotalRecs, $witness_tb_edit->RecRange) ?>
<?php if ($witness_tb_edit->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($witness_tb_edit->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $witness_tb_edit->PageUrl() ?>start=<?php echo $witness_tb_edit->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($witness_tb_edit->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $witness_tb_edit->PageUrl() ?>start=<?php echo $witness_tb_edit->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($witness_tb_edit->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $witness_tb_edit->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($witness_tb_edit->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $witness_tb_edit->PageUrl() ?>start=<?php echo $witness_tb_edit->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($witness_tb_edit->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $witness_tb_edit->PageUrl() ?>start=<?php echo $witness_tb_edit->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
...
<script type="text/javascript">
fwitness_tbedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$witness_tb_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$witness_tb_edit->Page_Terminate();
?>
