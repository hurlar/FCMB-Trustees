...
$trustee_tb_edit = NULL; // Initialize page object first

class ctrustee_tb_edit extends ctrustee_tb {
	...
	// Page object name
	var $PageObjName = 'trustee_tb_edit';
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("trustee_tblist.php"); // Return to list page
		...
		switch ($this->CurrentAction) {
			...
			Case "U": // Update
				...
				if ($this->EditRow()) { // Update record based on key
					...
					if (ew_GetPageName($sReturnUrl) == "trustee_tbview.php")
...
// Create page object
if (!isset($trustee_tb_edit)) $trustee_tb_edit = new ctrustee_tb_edit();

// Page init
$trustee_tb_edit->Page_Init();

// Page main
$trustee_tb_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$trustee_tb_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var trustee_tb_edit = new ew_Page("trustee_tb_edit");
trustee_tb_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = trustee_tb_edit.PageID; // For backward compatibility

// Form object
var ftrustee_tbedit = new ew_Form("ftrustee_tbedit");

// Validate form
ftrustee_tbedit.Validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($trustee_tb->uid->FldErrMsg()) ?>");
...
ftrustee_tbedit.Form_CustomValidate = 
...
ftrustee_tbedit.ValidateRequired = true;
<?php } else { ?>
ftrustee_tbedit.ValidateRequired = false; 
<?php } ?>
...
<?php $trustee_tb_edit->ShowPageHeader(); ?>
<?php
$trustee_tb_edit->ShowMessage();
?>
<form name="ftrustee_tbedit" id="ftrustee_tbedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="trustee_tb">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_trustee_tbedit" class="table table-bordered table-striped">
<?php if ($trustee_tb->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_trustee_tb_id"><?php echo $trustee_tb->id->FldCaption() ?></span></td>
		<td<?php echo $trustee_tb->id->CellAttributes() ?>>
<span id="el_trustee_tb_id" class="control-group">
<span<?php echo $trustee_tb->id->ViewAttributes() ?>>
<?php echo $trustee_tb->id->EditValue ?></span>
</span>
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($trustee_tb->id->CurrentValue) ?>">
<?php echo $trustee_tb->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($trustee_tb->uid->Visible) { // uid ?>
	<tr id="r_uid">
		<td><span id="elh_trustee_tb_uid"><?php echo $trustee_tb->uid->FldCaption() ?></span></td>
		<td<?php echo $trustee_tb->uid->CellAttributes() ?>>
<?php if ($trustee_tb->uid->getSessionValue() <> "") { ?>
<span<?php echo $trustee_tb->uid->ViewAttributes() ?>>
<?php echo $trustee_tb->uid->ViewValue ?></span>
<input type="hidden" id="x_uid" name="x_uid" value="<?php echo ew_HtmlEncode($trustee_tb->uid->CurrentValue) ?>">
<?php } else { ?>
<input type="text" data-field="x_uid" name="x_uid" id="x_uid" size="30" placeholder="<?php echo $trustee_tb->uid->PlaceHolder ?>" value="<?php echo $trustee_tb->uid->EditValue ?>"<?php echo $trustee_tb->uid->EditAttributes() ?>>
<?php } ?>
<?php echo $trustee_tb->uid->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($trustee_tb->title->Visible) { // title ?>
	<tr id="r_title">
		<td><span id="elh_trustee_tb_title"><?php echo $trustee_tb->title->FldCaption() ?></span></td>
		<td<?php echo $trustee_tb->title->CellAttributes() ?>>
<span id="el_trustee_tb_title" class="control-group">
<input type="text" data-field="x_title" name="x_title" id="x_title" size="30" maxlength="20" placeholder="<?php echo $trustee_tb->title->PlaceHolder ?>" value="<?php echo $trustee_tb->title->EditValue ?>"<?php echo $trustee_tb->title->EditAttributes() ?>>
</span>
<?php echo $trustee_tb->title->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($trustee_tb->fullname->Visible) { // fullname ?>
	<tr id="r_fullname">
		<td><span id="elh_trustee_tb_fullname"><?php echo $trustee_tb->fullname->FldCaption() ?></span></td>
		<td<?php echo $trustee_tb->fullname->CellAttributes() ?>>
<span id="el_trustee_tb_fullname" class="control-group">
<input type="text" data-field="x_fullname" name="x_fullname" id="x_fullname" size="30" maxlength="50" placeholder="<?php echo $trustee_tb->fullname->PlaceHolder ?>" value="<?php echo $trustee_tb->fullname->EditValue ?>"<?php echo $trustee_tb->fullname->EditAttributes() ?>>
</span>
<?php echo $trustee_tb->fullname->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($trustee_tb->rtionship->Visible) { // rtionship ?>
	<tr id="r_rtionship">
		<td><span id="elh_trustee_tb_rtionship"><?php echo $trustee_tb->rtionship->FldCaption() ?></span></td>
		<td<?php echo $trustee_tb->rtionship->CellAttributes() ?>>
<span id="el_trustee_tb_rtionship" class="control-group">
<input type="text" data-field="x_rtionship" name="x_rtionship" id="x_rtionship" size="30" maxlength="20" placeholder="<?php echo $trustee_tb->rtionship->PlaceHolder ?>" value="<?php echo $trustee_tb->rtionship->EditValue ?>"<?php echo $trustee_tb->rtionship->EditAttributes() ?>>
</span>
<?php echo $trustee_tb->rtionship->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($trustee_tb->_email->Visible) { // email ?>
	<tr id="r__email">
		<td><span id="elh_trustee_tb__email"><?php echo $trustee_tb->_email->FldCaption() ?></span></td>
		<td<?php echo $trustee_tb->_email->CellAttributes() ?>>
<span id="el_trustee_tb__email" class="control-group">
<input type="text" data-field="x__email" name="x__email" id="x__email" size="30" maxlength="50" placeholder="<?php echo $trustee_tb->_email->PlaceHolder ?>" value="<?php echo $trustee_tb->_email->EditValue ?>"<?php echo $trustee_tb->_email->EditAttributes() ?>>
</span>
<?php echo $trustee_tb->_email->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($trustee_tb->phone->Visible) { // phone ?>
	<tr id="r_phone">
		<td><span id="elh_trustee_tb_phone"><?php echo $trustee_tb->phone->FldCaption() ?></span></td>
		<td<?php echo $trustee_tb->phone->CellAttributes() ?>>
<span id="el_trustee_tb_phone" class="control-group">
<input type="text" data-field="x_phone" name="x_phone" id="x_phone" size="30" maxlength="20" placeholder="<?php echo $trustee_tb->phone->PlaceHolder ?>" value="<?php echo $trustee_tb->phone->EditValue ?>"<?php echo $trustee_tb->phone->EditAttributes() ?>>
</span>
<?php echo $trustee_tb->phone->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($trustee_tb->addr->Visible) { // addr ?>
	<tr id="r_addr">
		<td><span id="elh_trustee_tb_addr"><?php echo $trustee_tb->addr->FldCaption() ?></span></td>
		<td<?php echo $trustee_tb->addr->CellAttributes() ?>>
<span id="el_trustee_tb_addr" class="control-group">
<textarea data-field="x_addr" name="x_addr" id="x_addr" cols="35" rows="4" placeholder="<?php echo $trustee_tb->addr->PlaceHolder ?>"<?php echo $trustee_tb->addr->EditAttributes() ?>><?php echo $trustee_tb->addr->EditValue ?></textarea>
</span>
<?php echo $trustee_tb->addr->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($trustee_tb->city->Visible) { // city ?>
	<tr id="r_city">
		<td><span id="elh_trustee_tb_city"><?php echo $trustee_tb->city->FldCaption() ?></span></td>
		<td<?php echo $trustee_tb->city->CellAttributes() ?>>
<span id="el_trustee_tb_city" class="control-group">
<input type="text" data-field="x_city" name="x_city" id="x_city" size="30" maxlength="20" placeholder="<?php echo $trustee_tb->city->PlaceHolder ?>" value="<?php echo $trustee_tb->city->EditValue ?>"<?php echo $trustee_tb->city->EditAttributes() ?>>
</span>
<?php echo $trustee_tb->city->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($trustee_tb->state->Visible) { // state ?>
	<tr id="r_state">
		<td><span id="elh_trustee_tb_state"><?php echo $trustee_tb->state->FldCaption() ?></span></td>
		<td<?php echo $trustee_tb->state->CellAttributes() ?>>
<span id="el_trustee_tb_state" class="control-group">
<input type="text" data-field="x_state" name="x_state" id="x_state" size="30" maxlength="20" placeholder="<?php echo $trustee_tb->state->PlaceHolder ?>" value="<?php echo $trustee_tb->state->EditValue ?>"<?php echo $trustee_tb->state->EditAttributes() ?>>
</span>
<?php echo $trustee_tb->state->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($trustee_tb->datecreated->Visible) { // datecreated ?>
	<tr id="r_datecreated">
		<td><span id="elh_trustee_tb_datecreated"><?php echo $trustee_tb->datecreated->FldCaption() ?></span></td>
		<td<?php echo $trustee_tb->datecreated->CellAttributes() ?>>
<span id="el_trustee_tb_datecreated" class="control-group">
<input type="text" data-field="x_datecreated" name="x_datecreated" id="x_datecreated" placeholder="<?php echo $trustee_tb->datecreated->PlaceHolder ?>" value="<?php echo $trustee_tb->datecreated->EditValue ?>"<?php echo $trustee_tb->datecreated->EditAttributes() ?>>
</span>
<?php echo $trustee_tb->datecreated->CustomMsg ?></td>
	</tr>
<?php } ?>
</table>
</td></tr></table>
<table class="ewPager">
<tr><td>
<?php if (!isset($trustee_tb_edit->Pager)) $trustee_tb_edit->Pager = new cNumericPager($trustee_tb_edit->StartRec, $trustee_tb_edit->DisplayRecs, $trustee_tb_edit->TotalRecs, $trustee_tb_edit->RecRange) ?>
<?php if ($trustee_tb_edit->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($trustee_tb_edit->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $trustee_tb_edit->PageUrl() ?>start=<?php echo $trustee_tb_edit->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($trustee_tb_edit->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $trustee_tb_edit->PageUrl() ?>start=<?php echo $trustee_tb_edit->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($trustee_tb_edit->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $trustee_tb_edit->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($trustee_tb_edit->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $trustee_tb_edit->PageUrl() ?>start=<?php echo $trustee_tb_edit->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($trustee_tb_edit->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $trustee_tb_edit->PageUrl() ?>start=<?php echo $trustee_tb_edit->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
...
<script type="text/javascript">
ftrustee_tbedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$trustee_tb_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$trustee_tb_edit->Page_Terminate();
?>
