...
$addinfo_tb_add = NULL; // Initialize page object first

class caddinfo_tb_add extends caddinfo_tb {
	...
	// Page object name
	var $PageObjName = 'addinfo_tb_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("addinfo_tblist.php"); // No matching record, return to list
				}
				break;
	...
	function LoadDefaultValues() {
		...
		$this->spinstruct->CurrentValue = NULL;
		$this->spinstruct->OldValue = $this->spinstruct->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// spinstruct
		$this->spinstruct->SetDbValueDef($rsnew, $this->spinstruct->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($addinfo_tb_add)) $addinfo_tb_add = new caddinfo_tb_add();

// Page init
$addinfo_tb_add->Page_Init();

// Page main
$addinfo_tb_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$addinfo_tb_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var addinfo_tb_add = new ew_Page("addinfo_tb_add");
addinfo_tb_add.PageID = "add"; // Page ID
var EW_PAGE_ID = addinfo_tb_add.PageID; // For backward compatibility

// Form object
var faddinfo_tbadd = new ew_Form("faddinfo_tbadd");

// Validate form
faddinfo_tbadd.Validate = function() {
...
faddinfo_tbadd.Form_CustomValidate = 
...
faddinfo_tbadd.ValidateRequired = true;
<?php } else { ?>
faddinfo_tbadd.ValidateRequired = false; 
<?php } ?>
...
<?php $addinfo_tb_add->ShowPageHeader(); ?>
<?php
$addinfo_tb_add->ShowMessage();
?>
<form name="faddinfo_tbadd" id="faddinfo_tbadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="addinfo_tb">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_addinfo_tbadd" class="table table-bordered table-striped">
