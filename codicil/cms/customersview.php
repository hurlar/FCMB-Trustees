...
<?php echo $customers->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($customers->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_customers_name"><?php echo $customers->name->FldCaption() ?></span></td>
...
<?php echo $customers->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $customers->lname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($customers->_email->Visible) { // email ?>
	<tr id="r__email">
		<td><span id="elh_customers__email"><?php echo $customers->_email->FldCaption() ?></span></td>
...
<?php echo $customers->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($customers->address->Visible) { // address ?>
	<tr id="r_address">
		<td><span id="elh_customers_address"><?php echo $customers->address->FldCaption() ?></span></td>
...
<?php echo $customers->address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($customers->phone->Visible) { // phone ?>
	<tr id="r_phone">
		<td><span id="elh_customers_phone"><?php echo $customers->phone->FldCaption() ?></span></td>
...
<?php echo $customers->city->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span<?php echo $customers->state->ViewAttributes() ?>>
<?php echo $customers->state->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $customers->country->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($customers->datereg->Visible) { // datereg ?>
	<tr id="r_datereg">
		<td><span id="elh_customers_datereg"><?php echo $customers->datereg->FldCaption() ?></span></td>
		<td<?php echo $customers->datereg->CellAttributes() ?>>
<span id="el_customers_datereg" class="control-group">
<span<?php echo $customers->datereg->ViewAttributes() ?>>
<?php echo $customers->datereg->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($customers->deliveryopt->Visible) { // deliveryopt ?>
	<tr id="r_deliveryopt">
		<td><span id="elh_customers_deliveryopt"><?php echo $customers->deliveryopt->FldCaption() ?></span></td>
...
<?php echo $customers->deliveryopt->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $customers->paymentopt->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<table class="ewPager">
<tr><td>
<?php if (!isset($customers_view->Pager)) $customers_view->Pager = new cNumericPager($customers_view->StartRec, $customers_view->DisplayRecs, $customers_view->TotalRecs, $customers_view->RecRange) ?>
<?php if ($customers_view->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($customers_view->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $customers_view->PageUrl() ?>start=<?php echo $customers_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($customers_view->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $customers_view->PageUrl() ?>start=<?php echo $customers_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($customers_view->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $customers_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($customers_view->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $customers_view->PageUrl() ?>start=<?php echo $customers_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($customers_view->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $customers_view->PageUrl() ?>start=<?php echo $customers_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
