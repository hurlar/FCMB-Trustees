...
class cfaq extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('faq', 'faq', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// title
		$this->title = new cField('faq', 'faq', 'x_title', 'title', '`title`', '`title`', 201, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['title'] = &$this->title;

		// content
		$this->content = new cField('faq', 'faq', 'x_content', 'content', '`content`', '`content`', 201, -1, FALSE, '`content`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['content'] = &$this->content;

		// category
		$this->category = new cField('faq', 'faq', 'x_category', 'category', '`category`', '`category`', 200, -1, FALSE, '`category`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['category'] = &$this->category;

		// rate_ord
		$this->rate_ord = new cField('faq', 'faq', 'x_rate_ord', 'rate_ord', '`rate_ord`', '`rate_ord`', 202, -1, FALSE, '`rate_ord`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['rate_ord'] = &$this->rate_ord;

		// datep
		$this->datep = new cField('faq', 'faq', 'x_datep', 'datep', '`datep`', 'DATE_FORMAT(`datep`, \'%d/%m/%y\')', 135, -1, FALSE, '`datep`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
