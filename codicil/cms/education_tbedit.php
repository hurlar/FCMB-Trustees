...
$education_tb_edit = NULL; // Initialize page object first

class ceducation_tb_edit extends ceducation_tb {
	...
	// Page object name
	var $PageObjName = 'education_tb_edit';
...
// Create page object
if (!isset($education_tb_edit)) $education_tb_edit = new ceducation_tb_edit();

// Page init
$education_tb_edit->Page_Init();

// Page main
$education_tb_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$education_tb_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var education_tb_edit = new ew_Page("education_tb_edit");
education_tb_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = education_tb_edit.PageID; // For backward compatibility

// Form object
var feducation_tbedit = new ew_Form("feducation_tbedit");

// Validate form
feducation_tbedit.Validate = function() {
...
feducation_tbedit.Form_CustomValidate = 
...
feducation_tbedit.ValidateRequired = true;
<?php } else { ?>
feducation_tbedit.ValidateRequired = false; 
<?php } ?>
...
<?php $education_tb_edit->ShowPageHeader(); ?>
<?php
$education_tb_edit->ShowMessage();
?>
<form name="feducation_tbedit" id="feducation_tbedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="education_tb">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_education_tbedit" class="table table-bordered table-striped">
...
<?php echo $education_tb->id->EditValue ?></span>
</span>
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($education_tb->id->CurrentValue) ?>">
<?php echo $education_tb->id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<table class="ewPager">
<tr><td>
<?php if (!isset($education_tb_edit->Pager)) $education_tb_edit->Pager = new cNumericPager($education_tb_edit->StartRec, $education_tb_edit->DisplayRecs, $education_tb_edit->TotalRecs, $education_tb_edit->RecRange) ?>
<?php if ($education_tb_edit->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($education_tb_edit->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $education_tb_edit->PageUrl() ?>start=<?php echo $education_tb_edit->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($education_tb_edit->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $education_tb_edit->PageUrl() ?>start=<?php echo $education_tb_edit->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($education_tb_edit->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $education_tb_edit->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($education_tb_edit->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $education_tb_edit->PageUrl() ?>start=<?php echo $education_tb_edit->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($education_tb_edit->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $education_tb_edit->PageUrl() ?>start=<?php echo $education_tb_edit->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
...
<script type="text/javascript">
feducation_tbedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$education_tb_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$education_tb_edit->Page_Terminate();
?>
