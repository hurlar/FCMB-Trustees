...
$photos_img_blobview = NULL; // Initialize page object first

class cphotos_img_blobview extends cphotos {
	...
	// Page object name
	var $PageObjName = 'photos_img_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('photos', 'x_img');
...
// Create page object
if (!isset($photos_img_blobview)) $photos_img_blobview = new cphotos_img_blobview();

// Page init
$photos_img_blobview->Page_Init();

// Page main
$photos_img_blobview->Page_Main();
?>
<?php
$photos_img_blobview->Page_Terminate();
?>
