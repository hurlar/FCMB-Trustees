...
<?php if ($assets_tb->id->Visible) { // id ?>
		<td><span id="elh_assets_tb_id" class="assets_tb_id"><?php echo $assets_tb->id->FldCaption() ?></span></td>
<?php } ?>
...
<span id="el<?php echo $assets_tb_delete->RowCnt ?>_assets_tb_id" class="control-group assets_tb_id">
