...
$divorce_tb_grid = NULL; // Initialize page object first

class cdivorce_tb_grid extends cdivorce_tb {
	...
	// Page object name
	var $PageObjName = 'divorce_tb_grid';

	// Grid form hidden field names
	var $FormName = 'fdivorce_tbgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["divorce_tb"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_uid") && $objForm->HasValue("o_uid") && $this->uid->CurrentValue <> $this->uid->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_divorce") && $objForm->HasValue("o_divorce") && $this->divorce->CurrentValue <> $this->divorce->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_divorceyear") && $objForm->HasValue("o_divorceyear") && $this->divorceyear->CurrentValue <> $this->divorceyear->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->divorce->setOldValue($objForm->GetValue("o_divorce"));
		if (!$this->divorceyear->FldIsDetailKey) {
			$this->divorceyear->setFormValue($objForm->GetValue("x_divorceyear"));
		}
		$this->divorceyear->setOldValue($objForm->GetValue("o_divorceyear"));
