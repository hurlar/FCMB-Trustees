...
<?php if ($executor_tb->id->Visible) { // id ?>
		<td><span id="elh_executor_tb_id" class="executor_tb_id"><?php echo $executor_tb->id->FldCaption() ?></span></td>
<?php } ?>
...
<span id="el<?php echo $executor_tb_delete->RowCnt ?>_executor_tb_id" class="control-group executor_tb_id">
