...
$alt_beneficiary = NULL;

//
// Table class for alt_beneficiary
//
class calt_beneficiary extends cTable {
	var $id;
	var $uid;
	var $childid;
	var $title;
	...
	function __construct() {
		...
		$this->TableVar = 'alt_beneficiary';
		$this->TableName = 'alt_beneficiary';
		...
		// id
		$this->id = new cField('alt_beneficiary', 'alt_beneficiary', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// uid
		$this->uid = new cField('alt_beneficiary', 'alt_beneficiary', 'x_uid', 'uid', '`uid`', '`uid`', 3, -1, FALSE, '`uid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->uid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['uid'] = &$this->uid;

		// childid
		$this->childid = new cField('alt_beneficiary', 'alt_beneficiary', 'x_childid', 'childid', '`childid`', '`childid`', 200, -1, FALSE, '`childid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['childid'] = &$this->childid;

		// title
		$this->title = new cField('alt_beneficiary', 'alt_beneficiary', 'x_title', 'title', '`title`', '`title`', 200, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['title'] = &$this->title;

		// fullname
		$this->fullname = new cField('alt_beneficiary', 'alt_beneficiary', 'x_fullname', 'fullname', '`fullname`', '`fullname`', 200, -1, FALSE, '`fullname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['fullname'] = &$this->fullname;

		// status
		$this->status = new cField('alt_beneficiary', 'alt_beneficiary', 'x_status', 'status', '`status`', '`status`', 200, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['status'] = &$this->status;

		// email
		$this->_email = new cField('alt_beneficiary', 'alt_beneficiary', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['email'] = &$this->_email;

		// phone
		$this->phone = new cField('alt_beneficiary', 'alt_beneficiary', 'x_phone', 'phone', '`phone`', '`phone`', 200, -1, FALSE, '`phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['phone'] = &$this->phone;

		// addr
		$this->addr = new cField('alt_beneficiary', 'alt_beneficiary', 'x_addr', 'addr', '`addr`', '`addr`', 201, -1, FALSE, '`addr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['addr'] = &$this->addr;

		// city
		$this->city = new cField('alt_beneficiary', 'alt_beneficiary', 'x_city', 'city', '`city`', '`city`', 200, -1, FALSE, '`city`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['city'] = &$this->city;

		// state
		$this->state = new cField('alt_beneficiary', 'alt_beneficiary', 'x_state', 'state', '`state`', '`state`', 200, -1, FALSE, '`state`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['state'] = &$this->state;

		// datecreated
		$this->datecreated = new cField('alt_beneficiary', 'alt_beneficiary', 'x_datecreated', 'datecreated', '`datecreated`', 'DATE_FORMAT(`datecreated`, \'%d/%m/%y\')', 135, -1, FALSE, '`datecreated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetMasterFilter() {
		...
		if ($this->getCurrentMasterTable() == "beneficiary_dump") {
			if ($this->childid->getSessionValue() <> "")
				$sMasterFilter .= "`childid`=" . ew_QuotedValue($this->childid->getSessionValue(), EW_DATATYPE_STRING);
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "beneficiary_dump") {
			if ($this->childid->getSessionValue() <> "")
				$sDetailFilter .= "`childid`=" . ew_QuotedValue($this->childid->getSessionValue(), EW_DATATYPE_STRING);
			else
				return "";
		}
		if ($this->getCurrentMasterTable() == "privatetrust_tb") {
	...
	// Update Table
	var $UpdateTable = "`alt_beneficiary`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "alt_beneficiarylist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("alt_beneficiaryview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("alt_beneficiaryview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "alt_beneficiaryadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("alt_beneficiaryedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("alt_beneficiaryadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("alt_beneficiarydelete.php", $this->UrlParm());
	}
