...
$alt_beneficiary_view = NULL; // Initialize page object first

class calt_beneficiary_view extends calt_beneficiary {
	...
	// Page object name
	var $PageObjName = 'alt_beneficiary_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "alt_beneficiarylist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "alt_beneficiarylist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_alt_beneficiary\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_alt_beneficiary',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.falt_beneficiaryview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($alt_beneficiary_view)) $alt_beneficiary_view = new calt_beneficiary_view();

// Page init
$alt_beneficiary_view->Page_Init();

// Page main
$alt_beneficiary_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$alt_beneficiary_view->Page_Render();
?>
...
// Page object
var alt_beneficiary_view = new ew_Page("alt_beneficiary_view");
alt_beneficiary_view.PageID = "view"; // Page ID
var EW_PAGE_ID = alt_beneficiary_view.PageID; // For backward compatibility

// Form object
var falt_beneficiaryview = new ew_Form("falt_beneficiaryview");

// Form_CustomValidate event
falt_beneficiaryview.Form_CustomValidate = 
...
falt_beneficiaryview.ValidateRequired = true;
<?php } else { ?>
falt_beneficiaryview.ValidateRequired = false; 
<?php } ?>
...
<?php $alt_beneficiary_view->ExportOptions->Render("body") ?>
<?php if (!$alt_beneficiary_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($alt_beneficiary_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $alt_beneficiary_view->ShowPageHeader(); ?>
<?php
$alt_beneficiary_view->ShowMessage();
?>
<form name="falt_beneficiaryview" id="falt_beneficiaryview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="alt_beneficiary">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_alt_beneficiaryview" class="table table-bordered table-striped">
...
<span id="el_alt_beneficiary_uid" class="control-group">
...
<span id="el_alt_beneficiary_childid" class="control-group">
...
<span<?php echo $alt_beneficiary->addr->ViewAttributes() ?>>
<?php echo $alt_beneficiary->addr->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<table class="ewPager">
<tr><td>
<?php if (!isset($alt_beneficiary_view->Pager)) $alt_beneficiary_view->Pager = new cNumericPager($alt_beneficiary_view->StartRec, $alt_beneficiary_view->DisplayRecs, $alt_beneficiary_view->TotalRecs, $alt_beneficiary_view->RecRange) ?>
<?php if ($alt_beneficiary_view->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($alt_beneficiary_view->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $alt_beneficiary_view->PageUrl() ?>start=<?php echo $alt_beneficiary_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($alt_beneficiary_view->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $alt_beneficiary_view->PageUrl() ?>start=<?php echo $alt_beneficiary_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($alt_beneficiary_view->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $alt_beneficiary_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($alt_beneficiary_view->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $alt_beneficiary_view->PageUrl() ?>start=<?php echo $alt_beneficiary_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($alt_beneficiary_view->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $alt_beneficiary_view->PageUrl() ?>start=<?php echo $alt_beneficiary_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
</tr></tbody></table>
...
<script type="text/javascript">
falt_beneficiaryview.Init();
</script>
<?php
$alt_beneficiary_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($alt_beneficiary->Export == "") { ?>
...
<?php
$alt_beneficiary_view->Page_Terminate();
?>
