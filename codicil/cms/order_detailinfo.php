...
//
class corder_detail extends cTable {
	var $orderid;
	var $productid;
	var $quantity;
	var $price;
	...
	function __construct() {
		...
		// orderid
		$this->orderid = new cField('order_detail', 'order_detail', 'x_orderid', 'orderid', '`orderid`', '`orderid`', 3, -1, FALSE, '`orderid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->orderid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['orderid'] = &$this->orderid;

		// productid
		$this->productid = new cField('order_detail', 'order_detail', 'x_productid', 'productid', '`productid`', '`productid`', 200, -1, FALSE, '`productid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->productid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['productid'] = &$this->productid;

		// quantity
		$this->quantity = new cField('order_detail', 'order_detail', 'x_quantity', 'quantity', '`quantity`', '`quantity`', 3, -1, FALSE, '`quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->quantity->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['quantity'] = &$this->quantity;

		// price
		$this->price = new cField('order_detail', 'order_detail', 'x_price', 'price', '`price`', '`price`', 4, -1, FALSE, '`price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->price->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['price'] = &$this->price;

		// id
		$this->id = new cField('order_detail', 'order_detail', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// details
		$this->details = new cField('order_detail', 'order_detail', 'x_details', 'details', '`details`', '`details`', 200, -1, FALSE, '`details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("order_detailview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("order_detailview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "order_detailadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("order_detailedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("order_detailadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("order_detaildelete.php", $this->UrlParm());
	}
