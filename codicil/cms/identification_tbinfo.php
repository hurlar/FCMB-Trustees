...
$identification_tb = NULL;

//
// Table class for identification_tb
//
class cidentification_tb extends cTable {
	var $id;
	var $uid;
	var $type;
	var $idnumber;
	...
	function __construct() {
		...
		$this->TableVar = 'identification_tb';
		$this->TableName = 'identification_tb';
		...
		// id
		$this->id = new cField('identification_tb', 'identification_tb', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// uid
		$this->uid = new cField('identification_tb', 'identification_tb', 'x_uid', 'uid', '`uid`', '`uid`', 3, -1, FALSE, '`uid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->uid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['uid'] = &$this->uid;

		// type
		$this->type = new cField('identification_tb', 'identification_tb', 'x_type', 'type', '`type`', '`type`', 200, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['type'] = &$this->type;

		// idnumber
		$this->idnumber = new cField('identification_tb', 'identification_tb', 'x_idnumber', 'idnumber', '`idnumber`', '`idnumber`', 200, -1, FALSE, '`idnumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['idnumber'] = &$this->idnumber;

		// issuedate
		$this->issuedate = new cField('identification_tb', 'identification_tb', 'x_issuedate', 'issuedate', '`issuedate`', '`issuedate`', 200, -1, FALSE, '`issuedate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['issuedate'] = &$this->issuedate;

		// expirydate
		$this->expirydate = new cField('identification_tb', 'identification_tb', 'x_expirydate', 'expirydate', '`expirydate`', '`expirydate`', 200, -1, FALSE, '`expirydate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['expirydate'] = &$this->expirydate;

		// issueplace
		$this->issueplace = new cField('identification_tb', 'identification_tb', 'x_issueplace', 'issueplace', '`issueplace`', '`issueplace`', 200, -1, FALSE, '`issueplace`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`identification_tb`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "identification_tblist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("identification_tbview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("identification_tbview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "identification_tbadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("identification_tbedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("identification_tbadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("identification_tbdelete.php", $this->UrlParm());
	}
