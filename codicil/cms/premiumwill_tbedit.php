...
<?php
	if (in_array("personal_info", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $personal_info->DetailEdit) {
?>
<?php include_once "personal_infogrid.php" ?>
<?php } ?>
<?php
	if (in_array("spouse_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $spouse_tb->DetailEdit) {
?>
<?php include_once "spouse_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("divorce_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $divorce_tb->DetailEdit) {
?>
<?php include_once "divorce_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("children_details", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $children_details->DetailEdit) {
?>
<?php include_once "children_detailsgrid.php" ?>
<?php } ?>
<?php
	if (in_array("beneficiary_dump", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $beneficiary_dump->DetailEdit) {
?>
<?php include_once "beneficiary_dumpgrid.php" ?>
<?php } ?>
<?php
	if (in_array("alt_beneficiary", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $alt_beneficiary->DetailEdit) {
?>
<?php include_once "alt_beneficiarygrid.php" ?>
<?php } ?>
<?php
	if (in_array("assets_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $assets_tb->DetailEdit) {
?>
<?php include_once "assets_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("overall_asset", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $overall_asset->DetailEdit) {
?>
<?php include_once "overall_assetgrid.php" ?>
<?php } ?>
<?php
	if (in_array("executor_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $executor_tb->DetailEdit) {
?>
<?php include_once "executor_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("trustee_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $trustee_tb->DetailEdit) {
?>
<?php include_once "trustee_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("witness_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $witness_tb->DetailEdit) {
?>
<?php include_once "witness_tbgrid.php" ?>
<?php } ?>
<?php
	if (in_array("addinfo_tb", explode(",", $premiumwill_tb->getCurrentDetailTable())) && $addinfo_tb->DetailEdit) {
?>
