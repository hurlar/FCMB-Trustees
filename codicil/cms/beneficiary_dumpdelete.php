...
<?php if ($beneficiary_dump->id->Visible) { // id ?>
		<td><span id="elh_beneficiary_dump_id" class="beneficiary_dump_id"><?php echo $beneficiary_dump->id->FldCaption() ?></span></td>
<?php } ?>
<?php if ($beneficiary_dump->childid->Visible) { // childid ?>
		<td><span id="elh_beneficiary_dump_childid" class="beneficiary_dump_childid"><?php echo $beneficiary_dump->childid->FldCaption() ?></span></td>
<?php } ?>
...
<span id="el<?php echo $beneficiary_dump_delete->RowCnt ?>_beneficiary_dump_id" class="control-group beneficiary_dump_id">
...
<span id="el<?php echo $beneficiary_dump_delete->RowCnt ?>_beneficiary_dump_childid" class="control-group beneficiary_dump_childid">
