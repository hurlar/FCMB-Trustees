...
$executor_tb_grid = NULL; // Initialize page object first

class cexecutor_tb_grid extends cexecutor_tb {
	...
	// Page object name
	var $PageObjName = 'executor_tb_grid';

	// Grid form hidden field names
	var $FormName = 'fexecutor_tbgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["executor_tb"];
