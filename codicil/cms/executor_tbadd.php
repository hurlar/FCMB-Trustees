...
$executor_tb_add = NULL; // Initialize page object first

class cexecutor_tb_add extends cexecutor_tb {
	...
	// Page object name
	var $PageObjName = 'executor_tb_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("executor_tblist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($executor_tb_add)) $executor_tb_add = new cexecutor_tb_add();

// Page init
$executor_tb_add->Page_Init();

// Page main
$executor_tb_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$executor_tb_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var executor_tb_add = new ew_Page("executor_tb_add");
executor_tb_add.PageID = "add"; // Page ID
var EW_PAGE_ID = executor_tb_add.PageID; // For backward compatibility

// Form object
var fexecutor_tbadd = new ew_Form("fexecutor_tbadd");

// Validate form
fexecutor_tbadd.Validate = function() {
...
fexecutor_tbadd.Form_CustomValidate = 
...
fexecutor_tbadd.ValidateRequired = true;
<?php } else { ?>
fexecutor_tbadd.ValidateRequired = false; 
<?php } ?>
...
<?php $executor_tb_add->ShowPageHeader(); ?>
<?php
$executor_tb_add->ShowMessage();
?>
<form name="fexecutor_tbadd" id="fexecutor_tbadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="executor_tb">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_executor_tbadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fexecutor_tbadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$executor_tb_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$executor_tb_add->Page_Terminate();
?>
