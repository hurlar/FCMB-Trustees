...
$alt_beneficiary_grid = NULL; // Initialize page object first

class calt_beneficiary_grid extends calt_beneficiary {
	...
	// Page object name
	var $PageObjName = 'alt_beneficiary_grid';

	// Grid form hidden field names
	var $FormName = 'falt_beneficiarygrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["alt_beneficiary"];
