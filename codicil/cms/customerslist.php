...
class ccustomers_list extends ccustomers {
	...
	function BasicSearchSQL($Keyword) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->paymentopt, $Keyword);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->datereg, $bCtrl); // datereg
			$this->UpdateSort($this->deliveryopt, $bCtrl); // deliveryopt
			$this->UpdateSort($this->paymentopt, $bCtrl); // paymentopt
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->_email->setSort("");
				$this->phone->setSort("");
				$this->datereg->setSort("");
				$this->deliveryopt->setSort("");
				$this->paymentopt->setSort("");
			}
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" href=\"\" onclick=\"ew_SubmitSelected(document.fcustomerslist, '" . $this->MultiDeleteUrl . "', ewLanguage.Phrase('DeleteMultiConfirmMsg'));return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->IsLoggedIn());
...
<div class="accordion" id="fcustomerslistsrch_SearchGroup">
...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="input-large" value="<?php echo ew_HtmlEncode($customers_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo $Language->Phrase("Search") ?>">
...
<?php if ($customers->name->Visible) { // name ?>
	<?php if ($customers->SortUrl($customers->name) == "") { ?>
		<td><div id="elh_customers_name" class="customers_name"><div class="ewTableHeaderCaption"><?php echo $customers->name->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $customers->SortUrl($customers->name) ?>',2);"><div id="elh_customers_name" class="customers_name">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $customers->name->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($customers->name->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($customers->name->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($customers->lname->Visible) { // lname ?>
	<?php if ($customers->SortUrl($customers->lname) == "") { ?>
		<td><div id="elh_customers_lname" class="customers_lname"><div class="ewTableHeaderCaption"><?php echo $customers->lname->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $customers->SortUrl($customers->lname) ?>',2);"><div id="elh_customers_lname" class="customers_lname">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $customers->lname->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($customers->lname->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($customers->lname->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($customers->_email->Visible) { // email ?>
	<?php if ($customers->SortUrl($customers->_email) == "") { ?>
		<td><div id="elh_customers__email" class="customers__email"><div class="ewTableHeaderCaption"><?php echo $customers->_email->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $customers->SortUrl($customers->_email) ?>',2);"><div id="elh_customers__email" class="customers__email">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $customers->_email->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($customers->_email->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($customers->_email->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($customers->phone->Visible) { // phone ?>
	<?php if ($customers->SortUrl($customers->phone) == "") { ?>
		<td><div id="elh_customers_phone" class="customers_phone"><div class="ewTableHeaderCaption"><?php echo $customers->phone->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $customers->SortUrl($customers->phone) ?>',2);"><div id="elh_customers_phone" class="customers_phone">
...
<?php if ($customers->datereg->Visible) { // datereg ?>
	<?php if ($customers->SortUrl($customers->datereg) == "") { ?>
		<td><div id="elh_customers_datereg" class="customers_datereg"><div class="ewTableHeaderCaption"><?php echo $customers->datereg->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $customers->SortUrl($customers->datereg) ?>',2);"><div id="elh_customers_datereg" class="customers_datereg">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $customers->datereg->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($customers->datereg->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($customers->datereg->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($customers->deliveryopt->Visible) { // deliveryopt ?>
	<?php if ($customers->SortUrl($customers->deliveryopt) == "") { ?>
		<td><div id="elh_customers_deliveryopt" class="customers_deliveryopt"><div class="ewTableHeaderCaption"><?php echo $customers->deliveryopt->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $customers->SortUrl($customers->deliveryopt) ?>',2);"><div id="elh_customers_deliveryopt" class="customers_deliveryopt">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $customers->deliveryopt->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($customers->deliveryopt->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($customers->deliveryopt->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($customers->paymentopt->Visible) { // paymentopt ?>
	<?php if ($customers->SortUrl($customers->paymentopt) == "") { ?>
		<td><div id="elh_customers_paymentopt" class="customers_paymentopt"><div class="ewTableHeaderCaption"><?php echo $customers->paymentopt->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $customers->SortUrl($customers->paymentopt) ?>',2);"><div id="elh_customers_paymentopt" class="customers_paymentopt">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $customers->paymentopt->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($customers->paymentopt->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($customers->paymentopt->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
<table class="ewPager">
<tr><td>
<?php if (!isset($customers_list->Pager)) $customers_list->Pager = new cNumericPager($customers_list->StartRec, $customers_list->DisplayRecs, $customers_list->TotalRecs, $customers_list->RecRange) ?>
<?php if ($customers_list->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="ewStdTable"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($customers_list->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $customers_list->PageUrl() ?>start=<?php echo $customers_list->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($customers_list->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $customers_list->PageUrl() ?>start=<?php echo $customers_list->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($customers_list->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $customers_list->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($customers_list->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $customers_list->PageUrl() ?>start=<?php echo $customers_list->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($customers_list->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $customers_list->PageUrl() ?>start=<?php echo $customers_list->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
<td>
	<?php if ($customers_list->Pager->ButtonCount > 0) { ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
...
<option value="25"<?php if ($customers_list->DisplayRecs == 25) { ?> selected="selected"<?php } ?>>25</option>
<option value="50"<?php if ($customers_list->DisplayRecs == 50) { ?> selected="selected"<?php } ?>>50</option>
<option value="100"<?php if ($customers_list->DisplayRecs == 100) { ?> selected="selected"<?php } ?>>100</option>
<option value="200"<?php if ($customers_list->DisplayRecs == 200) { ?> selected="selected"<?php } ?>>200</option>
<option value="500"<?php if ($customers_list->DisplayRecs == 500) { ?> selected="selected"<?php } ?>>500</option>
