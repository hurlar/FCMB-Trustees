...
$nextofkin_grid = NULL; // Initialize page object first

class cnextofkin_grid extends cnextofkin {
	...
	// Page object name
	var $PageObjName = 'nextofkin_grid';

	// Grid form hidden field names
	var $FormName = 'fnextofkingrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["nextofkin"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_fullname") && $objForm->HasValue("o_fullname") && $this->fullname->CurrentValue <> $this->fullname->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_telephone") && $objForm->HasValue("o_telephone") && $this->telephone->CurrentValue <> $this->telephone->OldValue)
			return FALSE;
		if ($objForm->HasValue("x__email") && $objForm->HasValue("o__email") && $this->_email->CurrentValue <> $this->_email->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_dateposted") && $objForm->HasValue("o_dateposted") && $this->dateposted->CurrentValue <> $this->dateposted->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadFormValues() {
		...
		$this->telephone->setOldValue($objForm->GetValue("o_telephone"));
		...
		$this->dateposted->setOldValue($objForm->GetValue("o_dateposted"));
