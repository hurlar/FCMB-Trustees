...
$news_tb_img_blobview = NULL; // Initialize page object first

class cnews_tb_img_blobview extends cnews_tb {
	...
	// Page object name
	var $PageObjName = 'news_tb_img_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('news_tb', 'x_img');
...
// Create page object
if (!isset($news_tb_img_blobview)) $news_tb_img_blobview = new cnews_tb_img_blobview();

// Page init
$news_tb_img_blobview->Page_Init();

// Page main
$news_tb_img_blobview->Page_Main();
?>
<?php
$news_tb_img_blobview->Page_Terminate();
?>
